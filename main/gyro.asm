...
DW$61	.dwtag  DW_TAG_variable, DW_AT_name("v$1"), DW_AT_symbol_name("v$1")
	...
	.dwpsn	"gyro.c",398,5
        ...
        BF        L1,EQ                 ; |398| 
        ; branchcc occurs ; |398| 
;*** 400	-----------------------    if ( (*p_mark).q7turn_dis > (*p_mark).q7dist_limit ) goto g17;
	.dwpsn	"gyro.c",400,9
        MOVL      ACC,*+XAR4[4]         ; |400| 
        CMPL      ACC,*+XAR4[0]         ; |400| 
        BF        L6,LT                 ; |400| 
...
L1:    
;***	-----------------------g3:
;*** 434	-----------------------    if ( !((*p_mark).u16mark_enable&g_pos.u16state) ) goto g16;
	.dwpsn	"gyro.c",434,5
        MOVW      DP,#_g_pos
        MOV       AL,@_g_pos            ; |434| 
        AND       AL,*+XAR4[6]          ; |434| 
...
;*** 441	-----------------------    C$2 = g_ptr;
;*** 441	-----------------------    if ( p_mark == (*C$2).g_lmark ) goto g8;
	.dwpsn	"gyro.c",439,13
        MOV       *+XAR4[AR0],#1        ; |439| 
	.dwpsn	"gyro.c",441,4
        MOVW      DP,#_g_ptr
        ...
        BF        L2,EQ                 ; |441| 
        ; branchcc occurs ; |441| 
;*** 448	-----------------------    if ( p_mark != (*C$2).g_rmark ) goto g22;
	.dwpsn	"gyro.c",448,9
        MOVL      ACC,*+XAR5[2]         ; |448| 
        CMPL      ACC,XAR4              ; |448| 
        BF        L8,NEQ                ; |448| 
...
L3:    
;***	-----------------------g10:
;*** 455	-----------------------    if ( (*p_mark).q7turn_dis < (*p_mark).q7dist_limit ) goto g22;
	.dwpsn	"gyro.c",455,8
        MOVL      ACC,*+XAR4[4]         ; |455| 
        CMPL      ACC,*+XAR4[0]         ; |455| 
        BF        L8,GT                 ; |455| 
        ; branchcc occurs ; |455| 
;*** 458	-----------------------    (*p_mark).q7dist_limit = (*p_mark).q7turn_dis+(g_q17turnmark_dist>>10);
;*** 459	-----------------------    (*p_mark).u16single_flag = 1u;
;*** 461	-----------------------    v$1 = g_ptr;
;*** 461	-----------------------    if ( p_mark == (*v$1).g_lmark ) goto g14;
	.dwpsn	"gyro.c",458,4
        MOVW      DP,#_g_q17turnmark_dist
        SETC      SXM
	...
	.dwpsn	"gyro.c",461,4
        ...
        BF        L4,EQ                 ; |461| 
        ; branchcc occurs ; |461| 
;*** 468	-----------------------    if ( p_mark != (*v$1).g_rmark ) goto g22;
	.dwpsn	"gyro.c",468,9
        MOVL      ACC,*+XAR5[2]         ; |468| 
        CMPL      ACC,XAR4              ; |468| 
        BF        L8,NEQ                ; |468| 
...
;*** 466	-----------------------    if ( !(*&g_Flag&0x800u) ) goto g22;
	...
	.dwpsn	"gyro.c",466,17
        ...
        BF        L8,NTC                ; |466| 
        ; branchcc occurs ; |466| 
;*** 466	-----------------------    second_infor((*v$1).pfastinfo, (*v$1).perr);
;*** 466	-----------------------    goto g22;
	.dwpsn	"gyro.c",466,38
        MOVL      XAR4,*+XAR5[4]        ; |466| 
        MOVL      XAR5,*+XAR5[6]        ; |466| 
        LCR       #_second_infor        ; |466| 
        ; call occurs [#_second_infor] ; |466| 
        BF        L8,UNC                ; |466| 
        ; branch occurs ; |466| 
L5:    
;***	-----------------------g16:
;*** 479	-----------------------    (*p_mark).u16turn_flag = 0u;
;*** 480	-----------------------    (*p_mark).q7turn_dis = 0L;
;*** 480	-----------------------    goto g22;
	.dwpsn	"gyro.c",479,9
        MOVB      XAR0,#9               ; |479| 
        MOV       *+XAR4[AR0],#0        ; |479| 
...
;*** 409	-----------------------    if ( !(*&g_Flag&4u) ) goto g22;
	...
	.dwpsn	"gyro.c",409,13
        ...
        ; branchcc occurs ; |409| 
;*** 411	-----------------------    C$1 = g_ptr;
;*** 411	-----------------------    if ( p_mark == (*C$1).g_lmark ) goto g21;
	.dwpsn	"gyro.c",411,4
        MOVW      DP,#_g_ptr
        ...
        BF        L7,EQ                 ; |411| 
        ; branchcc occurs ; |411| 
;*** 419	-----------------------    if ( p_mark != (*C$1).g_rmark ) goto g22;
	.dwpsn	"gyro.c",419,9
        MOVL      ACC,*+XAR5[2]         ; |419| 
        CMPL      ACC,XAR4              ; |419| 
        BF        L8,NEQ                ; |419| 
...
DW$62	.dwtag  DW_TAG_subprogram, DW_AT_name("gyro_IIR"), DW_AT_symbol_name("_gyro_IIR")
	...
	.dwattr DW$62, DW_AT_begin_line(0x165)
...
DW$65	.dwtag  DW_TAG_variable, DW_AT_name("y$2"), DW_AT_symbol_name("y$2")
	...
	.dwattr DW$62, DW_AT_end_line(0x170)
...
DW$75	.dwtag  DW_TAG_loop
	.dwattr DW$75, DW_AT_name("C:\project\JP_Robotrace\main\gyro.asm:L9:1:1768986149")
...
DW$77	.dwtag  DW_TAG_subprogram, DW_AT_name("calculate_average_offset"), DW_AT_symbol_name("_calculate_average_offset")
	...
	.dwattr DW$77, DW_AT_begin_line(0x173)
...
DW$83	.dwtag  DW_TAG_loop
	.dwattr DW$83, DW_AT_name("C:\project\JP_Robotrace\main\gyro.asm:L11:1:1768986149")
	.dwattr DW$83, DW_AT_begin_file("gyro.c")
	.dwattr DW$83, DW_AT_begin_line(0x177)
	.dwattr DW$83, DW_AT_end_line(0x180)
DW$84	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$77, DW_AT_end_line(0x187)
...
DW$89	.dwtag  DW_TAG_loop
	.dwattr DW$89, DW_AT_name("C:\project\JP_Robotrace\main\gyro.asm:L12:1:1768986149")
...
;*** 335	-----------------------    if ( C$1 > 3932160L ) goto g8;
	...
	.dwpsn	"gyro.c",335,5
        MOVL      XAR4,#3932160         ; |335| 
        MOVL      ACC,XAR4              ; |335| 
        CMPL      ACC,XAR6              ; |335| 
        BF        L17,LT                ; |335| 
        ; branchcc occurs ; |335| 
;*** 336	-----------------------    if ( C$1 < (-3932160L) ) goto g7;
	.dwpsn	"gyro.c",336,10
        MOV       ACC,#-120 << 15
        CMPL      ACC,XAR6              ; |336| 
        BF        L16,GT                ; |336| 
...
DW$112	.dwtag  DW_TAG_loop
	.dwattr DW$112, DW_AT_name("C:\project\JP_Robotrace\main\gyro.asm:L23:1:1768986149")
...
DW$114	.dwtag  DW_TAG_loop
	.dwattr DW$114, DW_AT_name("C:\project\JP_Robotrace\main\gyro.asm:L21:1:1768986149")
...
DW$267	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$267, DW_AT_name("SPI_Gyro_flag"), DW_AT_symbol_name("_SPI_Gyro_flag")
...
DW$268	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$268, DW_AT_name("SPI_Rom_flag"), DW_AT_symbol_name("_SPI_Rom_flag")
...
DW$269	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$269, DW_AT_name("u16state"), DW_AT_symbol_name("_u16state")
...
DW$292	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$70)
	.dwattr DW$292, DW_AT_name("g_lmark"), DW_AT_symbol_name("_g_lmark")
	.dwattr DW$292, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$292, DW_AT_accessibility(DW_ACCESS_public)
DW$293	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$70)
	.dwattr DW$293, DW_AT_name("g_rmark"), DW_AT_symbol_name("_g_rmark")
	.dwattr DW$293, DW_AT_data_member_location[DW_OP_plus_uconst 0x2]
	.dwattr DW$293, DW_AT_accessibility(DW_ACCESS_public)
DW$294	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$73)
	.dwattr DW$294, DW_AT_name("pfastinfo"), DW_AT_symbol_name("_pfastinfo")
	.dwattr DW$294, DW_AT_data_member_location[DW_OP_plus_uconst 0x4]
	.dwattr DW$294, DW_AT_accessibility(DW_ACCESS_public)
DW$295	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$76)
	.dwattr DW$295, DW_AT_name("perr"), DW_AT_symbol_name("_perr")
	.dwattr DW$295, DW_AT_data_member_location[DW_OP_plus_uconst 0x6]
	.dwattr DW$295, DW_AT_accessibility(DW_ACCESS_public)
DW$296	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$79)
	.dwattr DW$296, DW_AT_name("ppos"), DW_AT_symbol_name("_ppos")
	.dwattr DW$296, DW_AT_data_member_location[DW_OP_plus_uconst 0x8]
	.dwattr DW$296, DW_AT_accessibility(DW_ACCESS_public)
DW$297	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$82)
	.dwattr DW$297, DW_AT_name("psen"), DW_AT_symbol_name("_psen")
...
DW$299	.dwtag  DW_TAG_subrange_type
	.dwattr DW$299, DW_AT_upper_bound(0x03)
	.dwendtag DW$T$64
...
DW$315	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$315, DW_AT_name("s44s_flag"), DW_AT_symbol_name("_s44s_flag")
...
DW$316	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$316, DW_AT_name("down_flag"), DW_AT_symbol_name("_down_flag")
...
DW$317	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$317, DW_AT_name("escape_flag"), DW_AT_symbol_name("_escape_flag")
...
DW$318	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$318, DW_AT_name("same_dir"), DW_AT_symbol_name("_same_dir")
...
DW$319	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$319, DW_AT_name("cross_out"), DW_AT_symbol_name("_cross_out")
...
DW$335	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$335, DW_AT_name("q17over_dist"), DW_AT_symbol_name("_q17over_dist")
	.dwattr DW$335, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$335, DW_AT_accessibility(DW_ACCESS_public)
DW$336	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$24)
	.dwattr DW$336, DW_AT_name("q17under_dist"), DW_AT_symbol_name("_q17under_dist")
	.dwattr DW$336, DW_AT_data_member_location[DW_OP_plus_uconst 0x2]
	.dwattr DW$336, DW_AT_accessibility(DW_ACCESS_public)
DW$337	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$24)
	.dwattr DW$337, DW_AT_name("q17err_dist"), DW_AT_symbol_name("_q17err_dist")
	.dwattr DW$337, DW_AT_data_member_location[DW_OP_plus_uconst 0x202]
	.dwattr DW$337, DW_AT_accessibility(DW_ACCESS_public)
DW$338	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$26)
	.dwattr DW$338, DW_AT_name("in32mark_val"), DW_AT_symbol_name("_in32mark_val")
	.dwattr DW$338, DW_AT_data_member_location[DW_OP_plus_uconst 0x402]
...
DW$362	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$362, DW_AT_name("SPICHAR"), DW_AT_symbol_name("_SPICHAR")
...
DW$363	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$363, DW_AT_name("SPILBK"), DW_AT_symbol_name("_SPILBK")
...
DW$365	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$365, DW_AT_name("CLKPOLARITY"), DW_AT_symbol_name("_CLKPOLARITY")
...
DW$366	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$366, DW_AT_name("SPISWRESET"), DW_AT_symbol_name("_SPISWRESET")
...
DW$368	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$368, DW_AT_name("SPIINTENA"), DW_AT_symbol_name("_SPIINTENA")
...
DW$369	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$369, DW_AT_name("TALK"), DW_AT_symbol_name("_TALK")
...
DW$370	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$370, DW_AT_name("MASTER_SLAVE"), DW_AT_symbol_name("_MASTER_SLAVE")
...
DW$371	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$371, DW_AT_name("CLK_PHASE"), DW_AT_symbol_name("_CLK_PHASE")
...
DW$372	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$372, DW_AT_name("OVERRUNINTENA"), DW_AT_symbol_name("_OVERRUNINTENA")
...
DW$373	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$373, DW_AT_name("rsvd"), DW_AT_symbol_name("_rsvd")
	.dwattr DW$373, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x0b)
...
DW$374	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$374, DW_AT_bit_offset(0x0b), DW_AT_bit_size(0x05)
	.dwattr DW$374, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$374, DW_AT_accessibility(DW_ACCESS_public)
DW$375	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$375, DW_AT_name("BUFFULL_FLAG"), DW_AT_symbol_name("_BUFFULL_FLAG")
...
DW$376	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$376, DW_AT_name("INT_FLAG"), DW_AT_symbol_name("_INT_FLAG")
...
DW$377	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$377, DW_AT_name("OVERRUN_FLAG"), DW_AT_symbol_name("_OVERRUN_FLAG")
...
DW$378	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$378, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x08)
...
DW$379	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$379, DW_AT_name("TXFFIL"), DW_AT_symbol_name("_TXFFIL")
	.dwattr DW$379, DW_AT_bit_offset(0x0b), DW_AT_bit_size(0x05)
	.dwattr DW$379, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$379, DW_AT_accessibility(DW_ACCESS_public)
DW$380	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$380, DW_AT_name("TXFFIENA"), DW_AT_symbol_name("_TXFFIENA")
...
DW$381	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$381, DW_AT_name("TXFFINTCLR"), DW_AT_symbol_name("_TXFFINTCLR")
...
DW$382	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$382, DW_AT_name("TXFFINT"), DW_AT_symbol_name("_TXFFINT")
...
DW$383	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$383, DW_AT_name("TXFFST"), DW_AT_symbol_name("_TXFFST")
	.dwattr DW$383, DW_AT_bit_offset(0x03), DW_AT_bit_size(0x05)
	.dwattr DW$383, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$383, DW_AT_accessibility(DW_ACCESS_public)
DW$384	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$384, DW_AT_name("TXFIFO"), DW_AT_symbol_name("_TXFIFO")
...
DW$385	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$385, DW_AT_name("SPIFFENA"), DW_AT_symbol_name("_SPIFFENA")
...
DW$386	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$386, DW_AT_name("SPIRST"), DW_AT_symbol_name("_SPIRST")
...
DW$387	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$387, DW_AT_name("RXFFIL"), DW_AT_symbol_name("_RXFFIL")
...
DW$388	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$388, DW_AT_name("RXFFIENA"), DW_AT_symbol_name("_RXFFIENA")
...
DW$389	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$389, DW_AT_name("RXFFINTCLR"), DW_AT_symbol_name("_RXFFINTCLR")
...
DW$390	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$390, DW_AT_name("RXFFINT"), DW_AT_symbol_name("_RXFFINT")
...
DW$391	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$391, DW_AT_name("RXFFST"), DW_AT_symbol_name("_RXFFST")
	.dwattr DW$391, DW_AT_bit_offset(0x03), DW_AT_bit_size(0x05)
	.dwattr DW$391, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$391, DW_AT_accessibility(DW_ACCESS_public)
DW$392	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$392, DW_AT_name("RXFIFORESET"), DW_AT_symbol_name("_RXFIFORESET")
...
DW$393	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$393, DW_AT_name("RXFFOVFCLR"), DW_AT_symbol_name("_RXFFOVFCLR")
...
DW$394	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$394, DW_AT_name("RXFFOVF"), DW_AT_symbol_name("_RXFFOVF")
...
DW$395	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$395, DW_AT_name("TXDLY"), DW_AT_symbol_name("_TXDLY")
...
DW$398	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$398, DW_AT_name("FREE"), DW_AT_symbol_name("_FREE")
...
DW$399	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$399, DW_AT_name("SOFT"), DW_AT_symbol_name("_SOFT")
...
DW$400	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$400, DW_AT_name("PRIORITY"), DW_AT_symbol_name("_PRIORITY")
...
DW$401	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$401, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x09)
...
DW$402	.dwtag  DW_TAG_subrange_type
	.dwattr DW$402, DW_AT_upper_bound(0xff)
	.dwendtag DW$T$24
...
DW$404	.dwtag  DW_TAG_far_type
	.dwattr DW$404, DW_AT_type(*DW$T$67)
...
DW$411	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$411, DW_AT_data_member_location[DW_OP_plus_uconst 0xc]
...
DW$412	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$412, DW_AT_data_member_location[DW_OP_plus_uconst 0xe]
...
DW$413	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$413, DW_AT_data_member_location[DW_OP_plus_uconst 0xf]
	.dwattr DW$413, DW_AT_accessibility(DW_ACCESS_public)
DW$414	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$414, DW_AT_name("u16sensor"), DW_AT_symbol_name("_u16sensor")
	.dwattr DW$414, DW_AT_data_member_location[DW_OP_plus_uconst 0x10]
...
DW$415	.dwtag  DW_TAG_assign_register, DW_AT_name("AL")
	.dwattr DW$415, DW_AT_location[DW_OP_reg0]
DW$416	.dwtag  DW_TAG_assign_register, DW_AT_name("AH")
	.dwattr DW$416, DW_AT_location[DW_OP_reg1]
DW$417	.dwtag  DW_TAG_assign_register, DW_AT_name("PL")
	.dwattr DW$417, DW_AT_location[DW_OP_reg2]
DW$418	.dwtag  DW_TAG_assign_register, DW_AT_name("PH")
	.dwattr DW$418, DW_AT_location[DW_OP_reg3]
DW$419	.dwtag  DW_TAG_assign_register, DW_AT_name("AR0")
	.dwattr DW$419, DW_AT_location[DW_OP_reg4]
DW$420	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR0")
	.dwattr DW$420, DW_AT_location[DW_OP_reg5]
DW$421	.dwtag  DW_TAG_assign_register, DW_AT_name("AR1")
	.dwattr DW$421, DW_AT_location[DW_OP_reg6]
DW$422	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR1")
	.dwattr DW$422, DW_AT_location[DW_OP_reg7]
DW$423	.dwtag  DW_TAG_assign_register, DW_AT_name("AR2")
	.dwattr DW$423, DW_AT_location[DW_OP_reg8]
DW$424	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR2")
	.dwattr DW$424, DW_AT_location[DW_OP_reg9]
DW$425	.dwtag  DW_TAG_assign_register, DW_AT_name("AR3")
	.dwattr DW$425, DW_AT_location[DW_OP_reg10]
DW$426	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR3")
	.dwattr DW$426, DW_AT_location[DW_OP_reg11]
DW$427	.dwtag  DW_TAG_assign_register, DW_AT_name("AR4")
	.dwattr DW$427, DW_AT_location[DW_OP_reg12]
DW$428	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR4")
	.dwattr DW$428, DW_AT_location[DW_OP_reg13]
DW$429	.dwtag  DW_TAG_assign_register, DW_AT_name("AR5")
	.dwattr DW$429, DW_AT_location[DW_OP_reg14]
DW$430	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR5")
	.dwattr DW$430, DW_AT_location[DW_OP_reg15]
DW$431	.dwtag  DW_TAG_assign_register, DW_AT_name("AR6")
	.dwattr DW$431, DW_AT_location[DW_OP_reg16]
DW$432	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR6")
	.dwattr DW$432, DW_AT_location[DW_OP_reg17]
DW$433	.dwtag  DW_TAG_assign_register, DW_AT_name("AR7")
	.dwattr DW$433, DW_AT_location[DW_OP_reg18]
DW$434	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR7")
	.dwattr DW$434, DW_AT_location[DW_OP_reg19]
DW$435	.dwtag  DW_TAG_assign_register, DW_AT_name("SP")
	.dwattr DW$435, DW_AT_location[DW_OP_reg20]
DW$436	.dwtag  DW_TAG_assign_register, DW_AT_name("XT")
	.dwattr DW$436, DW_AT_location[DW_OP_reg21]
DW$437	.dwtag  DW_TAG_assign_register, DW_AT_name("T")
	.dwattr DW$437, DW_AT_location[DW_OP_reg22]
DW$438	.dwtag  DW_TAG_assign_register, DW_AT_name("ST0")
	.dwattr DW$438, DW_AT_location[DW_OP_reg23]
DW$439	.dwtag  DW_TAG_assign_register, DW_AT_name("ST1")
	.dwattr DW$439, DW_AT_location[DW_OP_reg24]
DW$440	.dwtag  DW_TAG_assign_register, DW_AT_name("PC")
	.dwattr DW$440, DW_AT_location[DW_OP_reg25]
DW$441	.dwtag  DW_TAG_assign_register, DW_AT_name("RPC")
	.dwattr DW$441, DW_AT_location[DW_OP_reg26]
DW$442	.dwtag  DW_TAG_assign_register, DW_AT_name("FP")
	.dwattr DW$442, DW_AT_location[DW_OP_reg27]
DW$443	.dwtag  DW_TAG_assign_register, DW_AT_name("DP")
	.dwattr DW$443, DW_AT_location[DW_OP_reg28]
DW$444	.dwtag  DW_TAG_assign_register, DW_AT_name("SXM")
	.dwattr DW$444, DW_AT_location[DW_OP_reg29]
DW$445	.dwtag  DW_TAG_assign_register, DW_AT_name("PM")
	.dwattr DW$445, DW_AT_location[DW_OP_reg30]
DW$446	.dwtag  DW_TAG_assign_register, DW_AT_name("OVM")
	.dwattr DW$446, DW_AT_location[DW_OP_reg31]
DW$447	.dwtag  DW_TAG_assign_register, DW_AT_name("PAGE0")
	.dwattr DW$447, DW_AT_location[DW_OP_regx 0x20]
DW$448	.dwtag  DW_TAG_assign_register, DW_AT_name("AMODE")
	.dwattr DW$448, DW_AT_location[DW_OP_regx 0x21]
DW$449	.dwtag  DW_TAG_assign_register, DW_AT_name("IFR")
	.dwattr DW$449, DW_AT_location[DW_OP_regx 0x22]
DW$450	.dwtag  DW_TAG_assign_register, DW_AT_name("IER")
...
DW$452	.dwtag  DW_TAG_assign_register, DW_AT_name("PSEUDO")
	.dwattr DW$452, DW_AT_location[DW_OP_regx 0x25]
DW$453	.dwtag  DW_TAG_assign_register, DW_AT_name("PSEUDOH")
	.dwattr DW$453, DW_AT_location[DW_OP_regx 0x26]
DW$454	.dwtag  DW_TAG_assign_register, DW_AT_name("VOL")
	.dwattr DW$454, DW_AT_location[DW_OP_regx 0x27]
DW$455	.dwtag  DW_TAG_assign_register, DW_AT_name("CIE_RETA")
