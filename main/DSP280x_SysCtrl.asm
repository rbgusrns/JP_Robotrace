...
;	..\Compiler\bin\opt2000.exe C:\Users\rbgus\AppData\Local\Temp\TI46410 C:\Users\rbgus\AppData\Local\Temp\TI4644 
;	..\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -I..\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\rbgus\AppData\Local\Temp\TI4642 --template_info_file C:\Users\rbgus\AppData\Local\Temp\TI4646 --object_file DSP280x_SysCtrl.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
	.global	_ServiceDog
...
DW$9	.dwtag  DW_TAG_loop
	.dwattr DW$9, DW_AT_name("C:\project\JP_Robotrace\main\DSP280x_SysCtrl.asm:L3:1:1767842081")
...
;*** 214	-----------------------    C$1 = &SysCtrlRegs;
;*** 214	-----------------------    *C$1 = *C$1&0xfffeu|2u;
;*** 223	-----------------------    SysCtrlRegs.PCLKCR0.all = 0u;
;*** 224	-----------------------    SysCtrlRegs.PCLKCR1.all = 0u;
;*** 245	-----------------------    *((volatile struct _PCLKCR0_BITS *)C$1+12L) |= 0x8u;
;*** 246	-----------------------    *(&SysCtrlRegs+12L) |= 0x400u;
;*** 247	-----------------------    *(&SysCtrlRegs+12L) |= 0x100u;
;*** 268	-----------------------    *((volatile struct _PCLKCR1_BITS *)C$1+13L) |= 0x4000u;
;*** 269	-----------------------    *(&SysCtrlRegs+13L) |= 0x8000u;
;*** 271	-----------------------    *(&SysCtrlRegs+13L) |= 1u;
;*** 272	-----------------------    *(&SysCtrlRegs+13L) |= 2u;
;*** 273	-----------------------    *(&SysCtrlRegs+12L) |= 4u;
;*** 275	-----------------------    asm(" EDIS");
;*** 275	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
...
DW$12	.dwtag  DW_TAG_variable, DW_AT_name("C$1"), DW_AT_symbol_name("C$1")
 ...
 EALLOW
	...
	.dwpsn	"DSP280x_SysCtrl.c",214,4
        MOVL      XAR5,#_SysCtrlRegs    ; |214| 
        AND       AL,*+XAR5[0],#0xfffe  ; |214| 
        ORB       AL,#0x02              ; |214| 
        MOV       *+XAR5[0],AL          ; |214| 
	.dwpsn	"DSP280x_SysCtrl.c",223,2
        MOV       @_SysCtrlRegs+12,#0   ; |223| 
	.dwpsn	"DSP280x_SysCtrl.c",224,2
        MOV       @_SysCtrlRegs+13,#0   ; |224| 
	.dwpsn	"DSP280x_SysCtrl.c",245,2
        MOVB      ACC,#12
        ADDL      ACC,XAR5
        MOVL      XAR4,ACC              ; |245| 
        OR        *+XAR4[0],#0x0008     ; |245| 
	.dwpsn	"DSP280x_SysCtrl.c",246,2
        OR        @_SysCtrlRegs+12,#0x0400 ; |246| 
	.dwpsn	"DSP280x_SysCtrl.c",247,2
        OR        @_SysCtrlRegs+12,#0x0100 ; |247| 
	.dwpsn	"DSP280x_SysCtrl.c",268,2
        MOVB      ACC,#13
        ADDL      ACC,XAR5
        MOVL      XAR4,ACC              ; |268| 
        OR        *+XAR4[0],#0x4000     ; |268| 
	.dwpsn	"DSP280x_SysCtrl.c",269,2
        OR        @_SysCtrlRegs+13,#0x8000 ; |269| 
	.dwpsn	"DSP280x_SysCtrl.c",271,2
        OR        @_SysCtrlRegs+13,#0x0001 ; |271| 
	.dwpsn	"DSP280x_SysCtrl.c",272,2
        OR        @_SysCtrlRegs+13,#0x0002 ; |272| 
	.dwpsn	"DSP280x_SysCtrl.c",273,2
        OR        @_SysCtrlRegs+12,#0x0004 ; |273| 
	.dwpsn	"DSP280x_SysCtrl.c",275,5
 EDIS
	.dwpsn	"DSP280x_SysCtrl.c",276,1
        SPM       #0
        LRETR
        ; return occurs
	.dwattr DW$11, DW_AT_end_file("DSP280x_SysCtrl.c")
	.dwattr DW$11, DW_AT_end_line(0x114)
