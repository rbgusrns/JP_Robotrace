...
DW$72	.dwtag  DW_TAG_variable, DW_AT_name("K$15"), DW_AT_symbol_name("K$15")
	...
	.dwpsn	"fastrun.c",191,2
        ...
        BF        L1,NTC                ; |191| 
        ; branchcc occurs ; |191| 
;*** 191	-----------------------    if ( !(*((volatile unsigned * const)pinfo+82L)&0x30u) ) goto g4;
        MOVB      XAR0,#82              ; |191| 
        MOV       AL,*+XAR1[AR0]        ; |191| 
        ANDB      AL,#0x30              ; |191| 
        BF        L1,EQ                 ; |191| 
...
;*** 112	-----------------------    (mark_cnt > 0L) ? (S$3 = *((volatile long * const)pinfo-16L)) : (S$3 = 0L);
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
        MOVL      *SP++,XAR1
...
;*** 115	-----------------------    if ( (*pinfo).u16turn_dir&0x8 ) goto g3;
	...
	.dwpsn	"fastrun.c",115,2
        ...
        BF        L4,TC                 ; |115| 
        ; branchcc occurs ; |115| 
;*** 117	-----------------------    turn_division_compute(pinfo+42L, mark_cnt+1L, perr);
;*** 118	-----------------------    (*pinfo).q17out_vel = *((volatile long * const)pinfo+64L);
...
L4:    
;***	-----------------------g3:
;*** 123	-----------------------    *((volatile long * const)pinfo+64L) = (*pinfo).q17out_vel = g_q17end_vel;
...
;***	-----------------------g3:
;*** 286	-----------------------    turn_division_compute(i*42+K$8, i, K$5);
...
DW$96	.dwtag  DW_TAG_loop
	.dwattr DW$96, DW_AT_name("C:\project\JP_Robotrace\main\fastrun.asm:L21:1:1768050238")
...
;*** 300	-----------------------    if ( *&g_Flag&0x80u ) goto g5;
        ...
        BF        L24,TC                ; |300| 
        ; branchcc occurs ; |300| 
;*** 313	-----------------------    if ( g_q17straight_dist < (long)((long double)((volatile unsigned *)p_info)[42*g_int32mark_cnt-3]*1.31072e5L) && g_int32mark_cnt != 0L ) goto g5;
	.dwpsn	"fastrun.c",313,2
        MOVB      ACC,#42
        MOVW      DP,#_g_int32mark_cnt
        MOVZ      AR6,SP                ; |313| 
        MOVL      XT,ACC                ; |313| 
        IMPYL     ACC,XT,@_g_int32mark_cnt ; |313| 
        ADDL      XAR4,ACC
        SUBB      XAR6,#8               ; |313| 
        SUBB      XAR4,#3               ; |313| 
        MOV       AL,*+XAR4[0]          ; |313| 
...
;*** 348	-----------------------    if ( (*U$18).u16turn_dir&0x109u ) goto g6;
	.dwpsn	"fastrun.c",348,2
        ...
        MOVL      XT,ACC                ; |348| 
        MOVL      ACC,XAR1              ; |348| 
        IMPYL     P,XT,@_g_int32mark_cnt ; |348| 
        ADDL      ACC,P
        MOVL      XAR1,ACC              ; |348| 
        MOVB      XAR0,#40              ; |348| 
...
;*** 83	-----------------------    if ( (g_int32dist -= dist) >= 0L ) goto g8;
	...
	.dwpsn	"fastrun.c",83,3
        ...
        BF        L33,GEQ               ; |83| 
        ; branchcc occurs ; |83| 
;*** 85	-----------------------    *((volatile unsigned *)K$31+83L) = 10u;
...
L37:    
;*** 88	-----------------------    small_vel = S$1;
;*** 90	-----------------------    max_vel_compute((long)((long double)*((volatile unsigned *)K$31+83L)*1.31072e5L), *((volatile long *)K$31+72L), big_vel, *((volatile long *)K$31+62L), (volatile long *)pnext+24L);
;*** 91	-----------------------    decel_dist_compute(*((volatile long *)K$31+66L), *((volatile long *)K$31+68L), *((volatile long *)K$31+62L), (volatile long *)pnext+28L);
;*** 93	-----------------------    *K$11 = (long)((long double)(*((volatile unsigned *)K$31+83L)>>1)*1.31072e5L);
...
DW$131	.dwtag  DW_TAG_loop
	.dwattr DW$131, DW_AT_name("C:\project\JP_Robotrace\main\fastrun.asm:L41:1:1768050238")
...
;*** 213	-----------------------    (*((volatile long * const)pinfo-16L) != 0L) ? (S$3 = *((volatile long * const)pinfo-16L)) : (S$3 = g_q17user_vel);
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
        MOVL      *SP++,XAR1
...
;*** 215	-----------------------    turn_division_compute(pinfo+42L, mark_cnt+1L, perr);
;*** 216	-----------------------    (*pinfo).q17out_vel = *((volatile long * const)pinfo+64L);
...
DW$T$113	.dwtag  DW_TAG_array_type, DW_AT_type(*DW$T$43)
	...
	.dwattr DW$T$113, DW_AT_byte_size(0x2a00)
...
DW$247	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$247, DW_AT_name("q17over_dist"), DW_AT_symbol_name("_q17over_dist")
	.dwattr DW$247, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$247, DW_AT_accessibility(DW_ACCESS_public)
DW$248	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$24)
	.dwattr DW$248, DW_AT_name("q17under_dist"), DW_AT_symbol_name("_q17under_dist")
	.dwattr DW$248, DW_AT_data_member_location[DW_OP_plus_uconst 0x2]
	.dwattr DW$248, DW_AT_accessibility(DW_ACCESS_public)
DW$249	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$24)
	.dwattr DW$249, DW_AT_name("q17err_dist"), DW_AT_symbol_name("_q17err_dist")
	.dwattr DW$249, DW_AT_data_member_location[DW_OP_plus_uconst 0x202]
	.dwattr DW$249, DW_AT_accessibility(DW_ACCESS_public)
DW$250	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$26)
	.dwattr DW$250, DW_AT_name("int32err_cnt"), DW_AT_symbol_name("_int32err_cnt")
	.dwattr DW$250, DW_AT_data_member_location[DW_OP_plus_uconst 0x402]
	.dwattr DW$250, DW_AT_accessibility(DW_ACCESS_public)
DW$251	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$26)
	.dwattr DW$251, DW_AT_name("int32load_err"), DW_AT_symbol_name("_int32load_err")
	.dwattr DW$251, DW_AT_data_member_location[DW_OP_plus_uconst 0x602]
	.dwattr DW$251, DW_AT_accessibility(DW_ACCESS_public)
DW$252	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$252, DW_AT_name("in32mark_val"), DW_AT_symbol_name("_in32mark_val")
	.dwattr DW$252, DW_AT_data_member_location[DW_OP_plus_uconst 0x802]
...
DW$253	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$253, DW_AT_name("motor_start"), DW_AT_symbol_name("_motor_start")
...
DW$254	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$254, DW_AT_name("motor_ISR_flag"), DW_AT_symbol_name("_motor_ISR_flag")
...
DW$255	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$255, DW_AT_name("move_state"), DW_AT_symbol_name("_move_state")
...
DW$256	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$256, DW_AT_name("start_flag"), DW_AT_symbol_name("_start_flag")
...
DW$257	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$257, DW_AT_name("cross_flag"), DW_AT_symbol_name("_cross_flag")
...
DW$258	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$258, DW_AT_name("debug_flag"), DW_AT_symbol_name("_debug_flag")
...
DW$259	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$259, DW_AT_name("lineout_flag"), DW_AT_symbol_name("_lineout_flag")
...
DW$260	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$260, DW_AT_name("err"), DW_AT_symbol_name("_err")
...
DW$261	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$261, DW_AT_name("speed_up_start"), DW_AT_symbol_name("_speed_up_start")
...
DW$262	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$262, DW_AT_name("speed_up"), DW_AT_symbol_name("_speed_up")
...
DW$263	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$263, DW_AT_name("straight_run"), DW_AT_symbol_name("_straight_run")
...
DW$264	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$264, DW_AT_name("fast_flag"), DW_AT_symbol_name("_fast_flag")
...
DW$265	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$265, DW_AT_name("xrun_flag"), DW_AT_symbol_name("_xrun_flag")
...
DW$266	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$266, DW_AT_name("brun_flag"), DW_AT_symbol_name("_brun_flag")
...
DW$267	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$267, DW_AT_name("cross_shift"), DW_AT_symbol_name("_cross_shift")
...
DW$268	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$268, DW_AT_name("lmark_flag"), DW_AT_symbol_name("_lmark_flag")
...
DW$269	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$269, DW_AT_name("rmark_flag"), DW_AT_symbol_name("_rmark_flag")
...
DW$270	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$270, DW_AT_name("B45_flag"), DW_AT_symbol_name("_B45_flag")
...
DW$271	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$271, DW_AT_name("B90_flag"), DW_AT_symbol_name("_B90_flag")
...
DW$272	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$272, DW_AT_name("B180_flag"), DW_AT_symbol_name("_B180_flag")
...
DW$273	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$273, DW_AT_name("BLTURN_flag"), DW_AT_symbol_name("_BLTURN_flag")
...
DW$274	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$274, DW_AT_name("BALL_flag"), DW_AT_symbol_name("_BALL_flag")
...
DW$276	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$276, DW_AT_name("u16enable"), DW_AT_symbol_name("_u16enable")
...
DW$293	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$293, DW_AT_name("u16qep_sample"), DW_AT_symbol_name("_u16qep_sample")
	.dwattr DW$293, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$293, DW_AT_accessibility(DW_ACCESS_public)
DW$294	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$294, DW_AT_name("u16decel_flag"), DW_AT_symbol_name("_u16decel_flag")
	.dwattr DW$294, DW_AT_data_member_location[DW_OP_plus_uconst 0x1]
	.dwattr DW$294, DW_AT_accessibility(DW_ACCESS_public)
DW$295	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$33)
	.dwattr DW$295, DW_AT_name("int16qep_val"), DW_AT_symbol_name("_int16qep_val")
	.dwattr DW$295, DW_AT_data_member_location[DW_OP_plus_uconst 0x2]
	.dwattr DW$295, DW_AT_accessibility(DW_ACCESS_public)
DW$296	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$25)
	.dwattr DW$296, DW_AT_name("int32accel"), DW_AT_symbol_name("_int32accel")
	.dwattr DW$296, DW_AT_data_member_location[DW_OP_plus_uconst 0x4]
	.dwattr DW$296, DW_AT_accessibility(DW_ACCESS_public)
DW$297	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$25)
	.dwattr DW$297, DW_AT_name("int32decel"), DW_AT_symbol_name("_int32decel")
	.dwattr DW$297, DW_AT_data_member_location[DW_OP_plus_uconst 0x6]
	.dwattr DW$297, DW_AT_accessibility(DW_ACCESS_public)
DW$298	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$34)
	.dwattr DW$298, DW_AT_name("q27tick_dist"), DW_AT_symbol_name("_q27tick_dist")
	.dwattr DW$298, DW_AT_data_member_location[DW_OP_plus_uconst 0x8]
	.dwattr DW$298, DW_AT_accessibility(DW_ACCESS_public)
DW$299	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$299, DW_AT_name("q17pid_out"), DW_AT_symbol_name("_q17pid_out")
	.dwattr DW$299, DW_AT_data_member_location[DW_OP_plus_uconst 0xa]
	.dwattr DW$299, DW_AT_accessibility(DW_ACCESS_public)
DW$300	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$300, DW_AT_name("q17user_vel"), DW_AT_symbol_name("_q17user_vel")
	.dwattr DW$300, DW_AT_data_member_location[DW_OP_plus_uconst 0xc]
	.dwattr DW$300, DW_AT_accessibility(DW_ACCESS_public)
DW$301	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$301, DW_AT_name("q17decel_vel"), DW_AT_symbol_name("_q17decel_vel")
	.dwattr DW$301, DW_AT_data_member_location[DW_OP_plus_uconst 0xe]
	.dwattr DW$301, DW_AT_accessibility(DW_ACCESS_public)
DW$302	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$302, DW_AT_name("q17next_vel"), DW_AT_symbol_name("_q17next_vel")
	.dwattr DW$302, DW_AT_data_member_location[DW_OP_plus_uconst 0x10]
	.dwattr DW$302, DW_AT_accessibility(DW_ACCESS_public)
DW$303	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$303, DW_AT_name("q17next_acc"), DW_AT_symbol_name("_q17next_acc")
	.dwattr DW$303, DW_AT_data_member_location[DW_OP_plus_uconst 0x12]
	.dwattr DW$303, DW_AT_accessibility(DW_ACCESS_public)
DW$304	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$35)
	.dwattr DW$304, DW_AT_name("q17cur_vel"), DW_AT_symbol_name("_q17cur_vel")
	.dwattr DW$304, DW_AT_data_member_location[DW_OP_plus_uconst 0x14]
	.dwattr DW$304, DW_AT_accessibility(DW_ACCESS_public)
DW$305	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$305, DW_AT_name("q17cur_vel_avr"), DW_AT_symbol_name("_q17cur_vel_avr")
	.dwattr DW$305, DW_AT_data_member_location[DW_OP_plus_uconst 0x1c]
	.dwattr DW$305, DW_AT_accessibility(DW_ACCESS_public)
DW$306	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$35)
	.dwattr DW$306, DW_AT_name("q17err_vel"), DW_AT_symbol_name("_q17err_vel")
	.dwattr DW$306, DW_AT_data_member_location[DW_OP_plus_uconst 0x1e]
	.dwattr DW$306, DW_AT_accessibility(DW_ACCESS_public)
DW$307	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$307, DW_AT_name("q17err_vel_sum"), DW_AT_symbol_name("_q17err_vel_sum")
	.dwattr DW$307, DW_AT_data_member_location[DW_OP_plus_uconst 0x26]
	.dwattr DW$307, DW_AT_accessibility(DW_ACCESS_public)
DW$308	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$308, DW_AT_name("q17proportional"), DW_AT_symbol_name("_q17proportional")
	.dwattr DW$308, DW_AT_data_member_location[DW_OP_plus_uconst 0x28]
	.dwattr DW$308, DW_AT_accessibility(DW_ACCESS_public)
DW$309	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$309, DW_AT_name("q17integral"), DW_AT_symbol_name("_q17integral")
	.dwattr DW$309, DW_AT_data_member_location[DW_OP_plus_uconst 0x2a]
	.dwattr DW$309, DW_AT_accessibility(DW_ACCESS_public)
DW$310	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$310, DW_AT_name("q17derivative"), DW_AT_symbol_name("_q17derivative")
	.dwattr DW$310, DW_AT_data_member_location[DW_OP_plus_uconst 0x2c]
	.dwattr DW$310, DW_AT_accessibility(DW_ACCESS_public)
DW$311	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$311, DW_AT_name("q17err_dist"), DW_AT_symbol_name("_q17err_dist")
	.dwattr DW$311, DW_AT_data_member_location[DW_OP_plus_uconst 0x2e]
	.dwattr DW$311, DW_AT_accessibility(DW_ACCESS_public)
DW$312	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$312, DW_AT_name("q17total_dist"), DW_AT_symbol_name("_q17total_dist")
	.dwattr DW$312, DW_AT_data_member_location[DW_OP_plus_uconst 0x30]
	.dwattr DW$312, DW_AT_accessibility(DW_ACCESS_public)
DW$313	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$313, DW_AT_name("q17user_dist"), DW_AT_symbol_name("_q17user_dist")
	.dwattr DW$313, DW_AT_data_member_location[DW_OP_plus_uconst 0x32]
	.dwattr DW$313, DW_AT_accessibility(DW_ACCESS_public)
DW$314	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$314, DW_AT_name("q17decel_dist"), DW_AT_symbol_name("_q17decel_dist")
	.dwattr DW$314, DW_AT_data_member_location[DW_OP_plus_uconst 0x34]
	.dwattr DW$314, DW_AT_accessibility(DW_ACCESS_public)
DW$315	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$315, DW_AT_name("q17start_dist"), DW_AT_symbol_name("_q17start_dist")
	.dwattr DW$315, DW_AT_data_member_location[DW_OP_plus_uconst 0x36]
	.dwattr DW$315, DW_AT_accessibility(DW_ACCESS_public)
DW$316	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$316, DW_AT_name("q17start_dist_total"), DW_AT_symbol_name("_q17start_dist_total")
	.dwattr DW$316, DW_AT_data_member_location[DW_OP_plus_uconst 0x38]
	.dwattr DW$316, DW_AT_accessibility(DW_ACCESS_public)
DW$317	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$317, DW_AT_name("q17pid_result"), DW_AT_symbol_name("_q17pid_result")
	.dwattr DW$317, DW_AT_data_member_location[DW_OP_plus_uconst 0x3a]
	.dwattr DW$317, DW_AT_accessibility(DW_ACCESS_public)
DW$318	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$318, DW_AT_name("q17gone_distance"), DW_AT_symbol_name("_q17gone_distance")
	.dwattr DW$318, DW_AT_data_member_location[DW_OP_plus_uconst 0x3c]
	.dwattr DW$318, DW_AT_accessibility(DW_ACCESS_public)
DW$319	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$319, DW_AT_name("q17end_gone_distance"), DW_AT_symbol_name("_q17end_gone_distance")
	.dwattr DW$319, DW_AT_data_member_location[DW_OP_plus_uconst 0x3e]
	.dwattr DW$319, DW_AT_accessibility(DW_ACCESS_public)
DW$320	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$320, DW_AT_name("q17dist_sum"), DW_AT_symbol_name("_q17dist_sum")
	.dwattr DW$320, DW_AT_data_member_location[DW_OP_plus_uconst 0x40]
	.dwattr DW$320, DW_AT_accessibility(DW_ACCESS_public)
DW$321	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$321, DW_AT_name("q17get_dist"), DW_AT_symbol_name("_q17get_dist")
	.dwattr DW$321, DW_AT_data_member_location[DW_OP_plus_uconst 0x42]
	.dwattr DW$321, DW_AT_accessibility(DW_ACCESS_public)
DW$322	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$36)
	.dwattr DW$322, DW_AT_name("q28kp"), DW_AT_symbol_name("_q28kp")
	.dwattr DW$322, DW_AT_data_member_location[DW_OP_plus_uconst 0x44]
	.dwattr DW$322, DW_AT_accessibility(DW_ACCESS_public)
DW$323	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$36)
	.dwattr DW$323, DW_AT_name("q28ki"), DW_AT_symbol_name("_q28ki")
	.dwattr DW$323, DW_AT_data_member_location[DW_OP_plus_uconst 0x46]
	.dwattr DW$323, DW_AT_accessibility(DW_ACCESS_public)
DW$324	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$36)
	.dwattr DW$324, DW_AT_name("q28kd"), DW_AT_symbol_name("_q28kd")
	.dwattr DW$324, DW_AT_data_member_location[DW_OP_plus_uconst 0x48]
...
DW$325	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$41)
	.dwattr DW$325, DW_AT_name("g_lmark"), DW_AT_symbol_name("_g_lmark")
	.dwattr DW$325, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$325, DW_AT_accessibility(DW_ACCESS_public)
DW$326	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$41)
	.dwattr DW$326, DW_AT_name("g_rmark"), DW_AT_symbol_name("_g_rmark")
	.dwattr DW$326, DW_AT_data_member_location[DW_OP_plus_uconst 0x2]
	.dwattr DW$326, DW_AT_accessibility(DW_ACCESS_public)
DW$327	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$44)
	.dwattr DW$327, DW_AT_name("pfastinfo"), DW_AT_symbol_name("_pfastinfo")
	.dwattr DW$327, DW_AT_data_member_location[DW_OP_plus_uconst 0x4]
	.dwattr DW$327, DW_AT_accessibility(DW_ACCESS_public)
DW$328	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$47)
	.dwattr DW$328, DW_AT_name("perr"), DW_AT_symbol_name("_perr")
	.dwattr DW$328, DW_AT_data_member_location[DW_OP_plus_uconst 0x6]
	.dwattr DW$328, DW_AT_accessibility(DW_ACCESS_public)
DW$329	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$50)
	.dwattr DW$329, DW_AT_name("ppos"), DW_AT_symbol_name("_ppos")
	.dwattr DW$329, DW_AT_data_member_location[DW_OP_plus_uconst 0x8]
	.dwattr DW$329, DW_AT_accessibility(DW_ACCESS_public)
DW$330	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$53)
	.dwattr DW$330, DW_AT_name("psen"), DW_AT_symbol_name("_psen")
...
DW$334	.dwtag  DW_TAG_subrange_type
	.dwattr DW$334, DW_AT_upper_bound(0xff)
	.dwendtag DW$T$26
...
DW$335	.dwtag  DW_TAG_subrange_type
	.dwattr DW$335, DW_AT_upper_bound(0x13)
	.dwendtag DW$T$27
...
DW$336	.dwtag  DW_TAG_far_type
	.dwattr DW$336, DW_AT_type(*DW$T$38)
DW$T$51	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$51, DW_AT_type(*DW$336)
...
DW$347	.dwtag  DW_TAG_assign_register, DW_AT_name("AL")
	.dwattr DW$347, DW_AT_location[DW_OP_reg0]
DW$348	.dwtag  DW_TAG_assign_register, DW_AT_name("AH")
	.dwattr DW$348, DW_AT_location[DW_OP_reg1]
DW$349	.dwtag  DW_TAG_assign_register, DW_AT_name("PL")
	.dwattr DW$349, DW_AT_location[DW_OP_reg2]
DW$350	.dwtag  DW_TAG_assign_register, DW_AT_name("PH")
	.dwattr DW$350, DW_AT_location[DW_OP_reg3]
DW$351	.dwtag  DW_TAG_assign_register, DW_AT_name("AR0")
	.dwattr DW$351, DW_AT_location[DW_OP_reg4]
DW$352	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR0")
	.dwattr DW$352, DW_AT_location[DW_OP_reg5]
DW$353	.dwtag  DW_TAG_assign_register, DW_AT_name("AR1")
	.dwattr DW$353, DW_AT_location[DW_OP_reg6]
DW$354	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR1")
	.dwattr DW$354, DW_AT_location[DW_OP_reg7]
DW$355	.dwtag  DW_TAG_assign_register, DW_AT_name("AR2")
	.dwattr DW$355, DW_AT_location[DW_OP_reg8]
DW$356	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR2")
	.dwattr DW$356, DW_AT_location[DW_OP_reg9]
DW$357	.dwtag  DW_TAG_assign_register, DW_AT_name("AR3")
	.dwattr DW$357, DW_AT_location[DW_OP_reg10]
DW$358	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR3")
	.dwattr DW$358, DW_AT_location[DW_OP_reg11]
DW$359	.dwtag  DW_TAG_assign_register, DW_AT_name("AR4")
	.dwattr DW$359, DW_AT_location[DW_OP_reg12]
DW$360	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR4")
	.dwattr DW$360, DW_AT_location[DW_OP_reg13]
DW$361	.dwtag  DW_TAG_assign_register, DW_AT_name("AR5")
	.dwattr DW$361, DW_AT_location[DW_OP_reg14]
DW$362	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR5")
	.dwattr DW$362, DW_AT_location[DW_OP_reg15]
DW$363	.dwtag  DW_TAG_assign_register, DW_AT_name("AR6")
	.dwattr DW$363, DW_AT_location[DW_OP_reg16]
DW$364	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR6")
	.dwattr DW$364, DW_AT_location[DW_OP_reg17]
DW$365	.dwtag  DW_TAG_assign_register, DW_AT_name("AR7")
	.dwattr DW$365, DW_AT_location[DW_OP_reg18]
DW$366	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR7")
	.dwattr DW$366, DW_AT_location[DW_OP_reg19]
DW$367	.dwtag  DW_TAG_assign_register, DW_AT_name("SP")
	.dwattr DW$367, DW_AT_location[DW_OP_reg20]
DW$368	.dwtag  DW_TAG_assign_register, DW_AT_name("XT")
	.dwattr DW$368, DW_AT_location[DW_OP_reg21]
DW$369	.dwtag  DW_TAG_assign_register, DW_AT_name("T")
	.dwattr DW$369, DW_AT_location[DW_OP_reg22]
DW$370	.dwtag  DW_TAG_assign_register, DW_AT_name("ST0")
	.dwattr DW$370, DW_AT_location[DW_OP_reg23]
DW$371	.dwtag  DW_TAG_assign_register, DW_AT_name("ST1")
	.dwattr DW$371, DW_AT_location[DW_OP_reg24]
DW$372	.dwtag  DW_TAG_assign_register, DW_AT_name("PC")
	.dwattr DW$372, DW_AT_location[DW_OP_reg25]
DW$373	.dwtag  DW_TAG_assign_register, DW_AT_name("RPC")
	.dwattr DW$373, DW_AT_location[DW_OP_reg26]
DW$374	.dwtag  DW_TAG_assign_register, DW_AT_name("FP")
	.dwattr DW$374, DW_AT_location[DW_OP_reg27]
DW$375	.dwtag  DW_TAG_assign_register, DW_AT_name("DP")
	.dwattr DW$375, DW_AT_location[DW_OP_reg28]
DW$376	.dwtag  DW_TAG_assign_register, DW_AT_name("SXM")
	.dwattr DW$376, DW_AT_location[DW_OP_reg29]
DW$377	.dwtag  DW_TAG_assign_register, DW_AT_name("PM")
	.dwattr DW$377, DW_AT_location[DW_OP_reg30]
DW$378	.dwtag  DW_TAG_assign_register, DW_AT_name("OVM")
	.dwattr DW$378, DW_AT_location[DW_OP_reg31]
DW$379	.dwtag  DW_TAG_assign_register, DW_AT_name("PAGE0")
	.dwattr DW$379, DW_AT_location[DW_OP_regx 0x20]
DW$380	.dwtag  DW_TAG_assign_register, DW_AT_name("AMODE")
	.dwattr DW$380, DW_AT_location[DW_OP_regx 0x21]
DW$381	.dwtag  DW_TAG_assign_register, DW_AT_name("IFR")
	.dwattr DW$381, DW_AT_location[DW_OP_regx 0x22]
DW$382	.dwtag  DW_TAG_assign_register, DW_AT_name("IER")
	.dwattr DW$382, DW_AT_location[DW_OP_regx 0x23]
DW$383	.dwtag  DW_TAG_assign_register, DW_AT_name("IER")
	.dwattr DW$383, DW_AT_location[DW_OP_regx 0x24]
DW$384	.dwtag  DW_TAG_assign_register, DW_AT_name("PSEUDO")
	.dwattr DW$384, DW_AT_location[DW_OP_regx 0x25]
DW$385	.dwtag  DW_TAG_assign_register, DW_AT_name("PSEUDOH")
	.dwattr DW$385, DW_AT_location[DW_OP_regx 0x26]
DW$386	.dwtag  DW_TAG_assign_register, DW_AT_name("VOL")
	.dwattr DW$386, DW_AT_location[DW_OP_regx 0x27]
DW$387	.dwtag  DW_TAG_assign_register, DW_AT_name("CIE_RETA")
	.dwattr DW$387, DW_AT_location[DW_OP_regx 0x28]
	.dwendtag DW$CU
