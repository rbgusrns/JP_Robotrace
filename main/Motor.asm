...
DW$14	.dwtag  DW_TAG_variable, DW_AT_name("g_Flag"), DW_AT_symbol_name("_g_Flag")
	.dwattr DW$14, DW_AT_type(*DW$T$194)
...
DW$49	.dwtag  DW_TAG_variable, DW_AT_name("CpuTimer1Regs"), DW_AT_symbol_name("_CpuTimer1Regs")
	.dwattr DW$49, DW_AT_type(*DW$T$178)
...
DW$51	.dwtag  DW_TAG_variable, DW_AT_name("g_lmark"), DW_AT_symbol_name("_g_lmark")
	.dwattr DW$51, DW_AT_type(*DW$T$197)
...
DW$57	.dwtag  DW_TAG_variable, DW_AT_name("RightQepRegs"), DW_AT_symbol_name("_RightQepRegs")
	.dwattr DW$57, DW_AT_type(*DW$T$191)
...
;*** 280	-----------------------    if ( C$1[14]&4u ) goto g11;
	.dwpsn	"Motor.c",280,2
        ...
        BF        L4,TC                 ; |280| 
        ; branchcc occurs ; |280| 
;*** 294	-----------------------    if ( !(C$1[14]&2u) ) goto g10;
	.dwpsn	"Motor.c",294,7
        TBIT      *+XAR1[AR0],#1        ; |294| 
        BF        L3,NTC                ; |294| 
        ; branchcc occurs ; |294| 
;*** 297	-----------------------    if ( g_q17straight_dist > (long)((long double)(*(volatile struct _fast_run_struct *)C$1).u16dist*1.31072e5L)-26214400L ) goto g13;
	.dwpsn	"Motor.c",297,3
        MOVZ      AR6,SP                ; |297| 
        MOVB      XAR0,#39              ; |297| 
        MOV       AL,*+XAR1[AR0]        ; |297| 
        ...
        SUB       ACC,#800 << 15        ; |297| 
        CMPL      ACC,@_g_q17straight_dist ; |297| 
        BF        L5,LT                 ; |297| 
        ; branchcc occurs ; |297| 
;*** 304	-----------------------    ext_kval_ctrl_func(5uL, &g_pos, 1L, (*(volatile struct _fast_run_struct *)C$1).q7kp_val);
;*** 304	-----------------------    goto g14;
	.dwpsn	"Motor.c",304,4
        MOVB      ACC,#1
        MOVL      *-SP[2],ACC           ; |304| 
        MOVL      XAR4,#_g_pos          ; |304| 
        MOVL      ACC,*+XAR1[0]         ; |304| 
        MOVL      *-SP[4],ACC           ; |304| 
        MOVB      ACC,#5
        LCR       #_ext_kval_ctrl_func  ; |304| 
        ; call occurs [#_ext_kval_ctrl_func] ; |304| 
        BF        L6,UNC                ; |304| 
        ; branch occurs ; |304| 
L3:    
;***	-----------------------g10:
;*** 311	-----------------------    ext_kval_ctrl_func(5uL, &g_pos, 1L, (*(U$14+K$15)).q7kp_val);
;*** 311	-----------------------    goto g14;
	.dwpsn	"Motor.c",311,3
        MOVL      XAR4,XAR3             ; |311| 
        MOVB      ACC,#1
        ...
        MOVL      ACC,*+XAR4[0]         ; |311| 
        MOVL      *-SP[4],ACC           ; |311| 
        MOVL      XAR4,#_g_pos          ; |311| 
        MOVB      ACC,#5
        LCR       #_ext_kval_ctrl_func  ; |311| 
        ; call occurs [#_ext_kval_ctrl_func] ; |311| 
        BF        L6,UNC                ; |311| 
        ; branch occurs ; |311| 
L4:    
;***	-----------------------g11:
...
L5:    
;***	-----------------------g13:
;*** 291	-----------------------    ext_kval_ctrl_func(6uL, &g_pos, 1L, (*(U$14+K$15)).q7kp_val);
	.dwpsn	"Motor.c",291,3
        MOVL      XAR4,XAR3             ; |291| 
        MOVB      ACC,#1
        MOVL      *-SP[2],ACC           ; |291| 
        ...
        MOVL      ACC,*+XAR4[0]         ; |291| 
        MOVL      *-SP[4],ACC           ; |291| 
        MOVL      XAR4,#_g_pos          ; |291| 
        MOVB      ACC,#6
        LCR       #_ext_kval_ctrl_func  ; |291| 
        ; call occurs [#_ext_kval_ctrl_func] ; |291| 
L6:    
;***	-----------------------g14:
;*** 321	-----------------------    if ( !(*&g_Flag&0x200u) ) goto g16;
	.dwpsn	"Motor.c",321,2
        MOVW      DP,#_g_Flag
        TBIT      @_g_Flag,#9           ; |321| 
        BF        L7,NTC                ; |321| 
        ; branchcc occurs ; |321| 
;*** 325	-----------------------    *&g_Flag |= 0x400u;
;*** 327	-----------------------    g_lm.q17user_vel = (*(volatile struct _fast_run_struct *)(g_int32mark_cnt*40+K$15)).q17vel;
;*** 328	-----------------------    g_rm.q17user_vel = g_lm.q17user_vel;
;***	-----------------------g16:
;***  	-----------------------    return;
	.dwpsn	"Motor.c",325,3
        OR        @_g_Flag,#0x0400      ; |325| 
	.dwpsn	"Motor.c",327,3
        MOVW      DP,#_g_int32mark_cnt
        MOVL      XAR7,@_g_int32mark_cnt ; |327| 
        MOVL      ACC,XAR7              ; |327| 
        LSL       ACC,5                 ; |327| 
        MOVL      XAR6,ACC              ; |327| 
        MOVL      ACC,XAR7              ; |327| 
        ...
        MOVB      XAR0,#24              ; |327| 
        MOVW      DP,#_g_lm+12
        MOVL      ACC,*+XAR3[AR0]       ; |327| 
        MOVL      @_g_lm+12,ACC         ; |327| 
	.dwpsn	"Motor.c",328,3
        MOVL      ACC,@_g_lm+12         ; |328| 
        MOVW      DP,#_g_rm+12
        MOVL      @_g_rm+12,ACC         ; |328| 
L7:    
	.dwpsn	"Motor.c",355,1
        SUBB      SP,#12
	.dwcfa	0x1d, -8
...
DW$110	.dwtag  DW_TAG_subprogram, DW_AT_name("motor_ISR"), DW_AT_symbol_name("_motor_ISR")
	...
	.dwattr DW$110, DW_AT_begin_line(0x165)
...
;*** 361	-----------------------    position_PID();
;*** 362	-----------------------    position_to_vel();
;*** 365	-----------------------    g_rm.u16qep_sample = LeftQepRegs.QPOSCNT;
;*** 366	-----------------------    g_lm.u16qep_sample = RightQepRegs.QPOSCNT;
;*** 370	-----------------------    *(&RightQepRegs+21L) |= 0x80u;
;*** 371	-----------------------    *(&LeftQepRegs+21L) |= 0x80u;
;*** 373	-----------------------    (g_rm.u16qep_sample > 1024u) ? (S$2 = -(int)(g_rm.u16qep_sample-2049u)) : (S$2 = -(int)g_rm.u16qep_sample);
        ASP
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
DW$120	.dwtag  DW_TAG_variable, DW_AT_name("S$1"), DW_AT_symbol_name("S$1")
	...
	.dwpsn	"Motor.c",359,2
        MOVW      DP,#_g_Flag
        OR        @_g_Flag,#0x0002      ; |359| 
	.dwpsn	"Motor.c",361,2
        LCR       #_position_PID        ; |361| 
        ; call occurs [#_position_PID] ; |361| 
	.dwpsn	"Motor.c",362,2
        LCR       #_position_to_vel$0   ; |362| 
        ; call occurs [#_position_to_vel$0] ; |362| 
	.dwpsn	"Motor.c",365,2
        MOVW      DP,#_LeftQepRegs
        MOVL      ACC,@_LeftQepRegs     ; |365| 
        MOVW      DP,#_g_rm
        MOV       @_g_rm,AL             ; |365| 
	.dwpsn	"Motor.c",366,2
        MOVW      DP,#_RightQepRegs
        MOVL      ACC,@_RightQepRegs    ; |366| 
        MOVW      DP,#_g_lm
        MOV       @_g_lm,AL             ; |366| 
	.dwpsn	"Motor.c",370,2
        MOVW      DP,#_RightQepRegs+21
        OR        @_RightQepRegs+21,#0x0080 ; |370| 
	.dwpsn	"Motor.c",371,2
        MOVW      DP,#_LeftQepRegs+21
        OR        @_LeftQepRegs+21,#0x0080 ; |371| 
	.dwpsn	"Motor.c",373,2
        MOVW      DP,#_g_rm
        CMP       @_g_rm,#1024          ; |373| 
        BF        L8,LOS                ; |373| 
...
L8:    
        ...
        NEG       AL                    ; |373| 
L9:    
;*** 373	-----------------------    g_rm.int16qep_val = S$2;
;*** 374	-----------------------    if ( g_lm.u16qep_sample > 1024u ) goto g3;
        MOV       @_g_rm+2,AL           ; |373| 
	.dwpsn	"Motor.c",374,2
        MOVW      DP,#_g_lm
        CMP       @_g_lm,#1024          ; |374| 
        BF        L10,HI                ; |374| 
        ; branchcc occurs ; |374| 
;*** 374	-----------------------    S$1 = -(int)g_lm.u16qep_sample;
;*** 374	-----------------------    goto g4;
        MOV       AL,@_g_lm             ; |374| 
        NEG       AL                    ; |374| 
        BF        L11,UNC               ; |374| 
...
L10:    
;***	-----------------------g3:
;*** 374	-----------------------    S$1 = 2049u-g_lm.u16qep_sample;
        MOV       AL,#2049              ; |374| 
        SUB       AL,@_g_lm             ; |374| 
L11:    
;***	-----------------------g4:
;*** 374	-----------------------    C$13 = &g_lm;
;*** 374	-----------------------    (*C$13).int16qep_val = S$1;
;*** 378	-----------------------    C$14 = &g_rm;
;*** 378	-----------------------    (*C$14).q27tick_dist = __IQxmpy((long)g_rm.int16qep_val<<21, 14929779L, 8);
;*** 379	-----------------------    (*C$14).q17dist_sum += g_rm.q27tick_dist>>10;
;*** 380	-----------------------    (*C$14).q17gone_distance += g_rm.q27tick_dist>>10;
;*** 382	-----------------------    (*C$13).q27tick_dist = __IQxmpy((long)g_lm.int16qep_val<<21, 14929779L, 8);
;*** 383	-----------------------    (*C$13).q17dist_sum += g_lm.q27tick_dist>>10;
;*** 384	-----------------------    (*C$13).q17gone_distance += g_lm.q27tick_dist>>10;
;*** 386	-----------------------    (*C$13).q17total_dist = g_rm.q17dist_sum+g_lm.q17dist_sum>>1;
;*** 387	-----------------------    (*C$14).q17total_dist = g_lm.q17total_dist;
;*** 389	-----------------------    g_q17shift_dist = (g_rm.q27tick_dist>>10)+(g_lm.q27tick_dist>>10)>>1;
;*** 392	-----------------------    g_q17cross_dist += g_rm.q27tick_dist+g_lm.q27tick_dist>>11;
;*** 394	-----------------------    g_rmark.q7check_dis += g_rm.q27tick_dist>>20;
;*** 395	-----------------------    g_lmark.q7check_dis += g_lm.q27tick_dist>>20;
;*** 397	-----------------------    (*C$14).q17err_dist = g_rm.q17user_dist-g_rm.q17total_dist;
;*** 398	-----------------------    (*C$13).q17err_dist = g_lm.q17user_dist-g_lm.q17total_dist;
;*** 402	-----------------------    *((volatile long (*)[4])C$14+22L) = *((volatile long (*)[4])C$14+20L);
;*** 403	-----------------------    *(&g_rm+20L) = __IQxmpy((long)g_rm.int16qep_val<<21, 933111168L, 3);
;*** 404	-----------------------    g_rm.q17cur_vel_avr = *(&g_rm+20L)+*(&g_rm+22L)>>1;
;*** 406	-----------------------    *((volatile long (*)[4])C$13+22L) = *((volatile long (*)[4])C$13+20L);
;*** 407	-----------------------    *(&g_lm+20L) = __IQxmpy((long)g_lm.int16qep_val<<21, 933111168L, 3);
;*** 408	-----------------------    g_lm.q17cur_vel_avr = *(&g_lm+20L)+*(&g_lm+22L)>>1;
;*** 412	-----------------------    if ( g_rm.u16decel_flag != 1u ) goto g7;
        MOVL      XAR5,#_g_lm           ; |374| 
        MOV       *+XAR5[2],AL          ; |374| 
	.dwpsn	"Motor.c",378,2
        SETC      SXM
        ...
        LSL64     ACC:P,#8              ; |378| 
        MOVL      *+XAR6[AR0],ACC       ; |378| 
	.dwpsn	"Motor.c",379,2
        MOVB      ACC,#64
        ADDL      ACC,XAR6
        MOVL      XAR4,ACC              ; |379| 
        MOVL      ACC,@_g_rm+8          ; |379| 
        SFR       ACC,10                ; |379| 
        ADDL      *+XAR4[0],ACC         ; |379| 
	.dwpsn	"Motor.c",380,2
        MOVB      ACC,#60
	...
	.dwpsn	"Motor.c",382,2
        ...
        LSL64     ACC:P,#8              ; |382| 
        MOVL      *+XAR5[AR0],ACC       ; |382| 
	.dwpsn	"Motor.c",383,2
        MOVB      ACC,#64
        ADDL      ACC,XAR5
        MOVL      XAR4,ACC              ; |383| 
        MOVL      ACC,@_g_lm+8          ; |383| 
        SFR       ACC,10                ; |383| 
        ADDL      *+XAR4[0],ACC         ; |383| 
	.dwpsn	"Motor.c",384,2
        MOVB      ACC,#60
        ADDL      ACC,XAR5
        MOVL      XAR4,ACC              ; |384| 
        MOVL      ACC,@_g_lm+8          ; |384| 
        SFR       ACC,10                ; |384| 
        ADDL      *+XAR4[0],ACC         ; |384| 
	.dwpsn	"Motor.c",386,2
        MOVW      DP,#_g_lm+64
        MOVL      ACC,@_g_lm+64         ; |386| 
        MOVW      DP,#_g_rm+64
        ADDL      ACC,@_g_rm+64         ; |386| 
        MOVB      XAR0,#48              ; |386| 
        SFR       ACC,1                 ; |386| 
        MOVL      *+XAR5[AR0],ACC       ; |386| 
	.dwpsn	"Motor.c",387,2
        MOVW      DP,#_g_lm+48
        MOVL      ACC,@_g_lm+48         ; |387| 
        MOVL      *+XAR6[AR0],ACC       ; |387| 
	.dwpsn	"Motor.c",389,2
        MOVW      DP,#_g_rm+8
        ...
        SFR       ACC,1                 ; |389| 
        MOVL      @_g_q17shift_dist,ACC ; |389| 
	.dwpsn	"Motor.c",392,2
        MOVW      DP,#_g_lm+8
        MOVL      ACC,@_g_lm+8          ; |392| 
        MOVW      DP,#_g_rm+8
        ADDL      ACC,@_g_rm+8          ; |392| 
        MOVW      DP,#_g_q17cross_dist
        SFR       ACC,11                ; |392| 
        ADDL      @_g_q17cross_dist,ACC ; |392| 
	.dwpsn	"Motor.c",394,2
        MOVW      DP,#_g_rm+8
        ...
        MOVW      DP,#_g_rmark+2
        ASRL      ACC,T                 ; |394| 
        ADDL      @_g_rmark+2,ACC       ; |394| 
	.dwpsn	"Motor.c",395,2
        MOVW      DP,#_g_lm+8
        MOVL      ACC,@_g_lm+8          ; |395| 
        MOVW      DP,#_g_lmark+2
        ASRL      ACC,T                 ; |395| 
        ADDL      @_g_lmark+2,ACC       ; |395| 
	.dwpsn	"Motor.c",397,2
        MOVW      DP,#_g_rm+50
        MOVL      ACC,@_g_rm+50         ; |397| 
        MOVB      XAR0,#46              ; |397| 
        SUBL      ACC,@_g_rm+48         ; |397| 
        MOVL      *+XAR6[AR0],ACC       ; |397| 
	.dwpsn	"Motor.c",398,2
        MOVW      DP,#_g_lm+50
        MOVL      ACC,@_g_lm+50         ; |398| 
        SUBL      ACC,@_g_lm+48         ; |398| 
        MOVL      *+XAR5[AR0],ACC       ; |398| 
	.dwpsn	"Motor.c",402,2
        MOVB      XAR0,#20              ; |402| 
        MOVL      ACC,*+XAR6[AR0]       ; |402| 
        MOVB      XAR0,#22              ; |402| 
	...
	.dwpsn	"Motor.c",403,2
        ...
        LSL64     ACC:P,#3              ; |403| 
        MOVL      @_g_rm+20,ACC         ; |403| 
	.dwpsn	"Motor.c",404,2
        MOVL      ACC,@_g_rm+22         ; |404| 
        ADDL      ACC,@_g_rm+20         ; |404| 
        SFR       ACC,1                 ; |404| 
        MOVL      @_g_rm+28,ACC         ; |404| 
	.dwpsn	"Motor.c",406,2
        MOVB      XAR0,#20              ; |406| 
        MOVL      ACC,*+XAR5[AR0]       ; |406| 
        MOVB      XAR0,#22              ; |406| 
        MOVL      *+XAR5[AR0],ACC       ; |406| 
	.dwpsn	"Motor.c",407,2
        MOVW      DP,#_g_lm+2
        MOV       T,#21                 ; |407| 
        MOV       ACC,@_g_lm+2          ; |407| 
        ...
        LSL64     ACC:P,#3              ; |407| 
        MOVL      @_g_lm+20,ACC         ; |407| 
	.dwpsn	"Motor.c",408,2
        MOVL      ACC,@_g_lm+22         ; |408| 
        ADDL      ACC,@_g_lm+20         ; |408| 
        SFR       ACC,1                 ; |408| 
        MOVL      @_g_lm+28,ACC         ; |408| 
	.dwpsn	"Motor.c",412,2
        MOVW      DP,#_g_rm+1
        MOV       AL,@_g_rm+1           ; |412| 
        CMPB      AL,#1                 ; |412| 
        BF        L12,NEQ               ; |412| 
        ; branchcc occurs ; |412| 
;*** 414	-----------------------    if ( g_rm.q17decel_dist < ABS(g_rm.q17err_dist) ) goto g7;
	.dwpsn	"Motor.c",414,3
        MOVL      ACC,@_g_rm+46         ; |414| 
        ABS       ACC                   ; |414| 
        CMPL      ACC,@_g_rm+52         ; |414| 
        BF        L12,GT                ; |414| 
        ; branchcc occurs ; |414| 
;*** 416	-----------------------    g_rm.q17user_vel = g_rm.q17decel_vel;
;*** 417	-----------------------    g_lm.q17user_vel = g_lm.q17decel_vel;
;*** 419	-----------------------    g_rm.u16decel_flag = 0u;
;*** 420	-----------------------    g_lm.u16decel_flag = 0u;
;*** 422	-----------------------    *&g_Flag &= 0xfdffu;
;*** 423	-----------------------    *&g_Flag &= 0xfeffu;
;*** 426	-----------------------    g_rm.int32accel = g_lm.int32accel = g_rm.int32decel;
;*** 427	-----------------------    g_err.q17over_dist = 0L;
	.dwpsn	"Motor.c",416,4
        MOVL      ACC,@_g_rm+14         ; |416| 
        MOVL      @_g_rm+12,ACC         ; |416| 
	.dwpsn	"Motor.c",417,4
        MOVW      DP,#_g_lm+14
        MOVL      ACC,@_g_lm+14         ; |417| 
        MOVL      @_g_lm+12,ACC         ; |417| 
	.dwpsn	"Motor.c",419,4
        MOVW      DP,#_g_rm+1
        MOV       @_g_rm+1,#0           ; |419| 
	.dwpsn	"Motor.c",420,4
	...
	.dwpsn	"Motor.c",422,4
        MOVW      DP,#_g_Flag
        AND       @_g_Flag,#0xfdff      ; |422| 
	.dwpsn	"Motor.c",423,4
        AND       @_g_Flag,#0xfeff      ; |423| 
	.dwpsn	"Motor.c",426,13
        MOVW      DP,#_g_rm+6
        MOVL      ACC,@_g_rm+6          ; |426| 
        MOVW      DP,#_g_lm+4
        MOVL      @_g_lm+4,ACC          ; |426| 
        MOVW      DP,#_g_rm+4
        MOVL      @_g_rm+4,ACC          ; |426| 
	.dwpsn	"Motor.c",427,4
        MOVW      DP,#_g_err
        MOVB      ACC,#0
        MOVL      @_g_err,ACC           ; |427| 
L12:    
;***	-----------------------g7:
;*** 433	-----------------------    if ( g_lm.u16decel_flag != 1u ) goto g10;
	.dwpsn	"Motor.c",433,2
        MOVW      DP,#_g_lm+1
        MOV       AL,@_g_lm+1           ; |433| 
        CMPB      AL,#1                 ; |433| 
        BF        L13,NEQ               ; |433| 
        ; branchcc occurs ; |433| 
;*** 435	-----------------------    if ( g_lm.q17decel_dist < ABS(g_lm.q17err_dist) ) goto g10;
	.dwpsn	"Motor.c",435,3
        MOVL      ACC,@_g_lm+46         ; |435| 
        ABS       ACC                   ; |435| 
        CMPL      ACC,@_g_lm+52         ; |435| 
        BF        L13,GT                ; |435| 
        ; branchcc occurs ; |435| 
;*** 437	-----------------------    g_rm.q17user_vel = g_rm.q17decel_vel;
;*** 438	-----------------------    g_lm.q17user_vel = g_lm.q17decel_vel;
;*** 440	-----------------------    g_rm.u16decel_flag = 0u;
;*** 441	-----------------------    g_lm.u16decel_flag = 0u;
;*** 443	-----------------------    *&g_Flag &= 0xfdffu;
;*** 444	-----------------------    *&g_Flag &= 0xfeffu;
;*** 446	-----------------------    g_rm.int32accel = g_lm.int32accel = g_rm.int32decel;
;*** 448	-----------------------    g_err.q17over_dist = 0L;
	.dwpsn	"Motor.c",437,4
        MOVW      DP,#_g_rm+14
        MOVL      ACC,@_g_rm+14         ; |437| 
        MOVL      @_g_rm+12,ACC         ; |437| 
	.dwpsn	"Motor.c",438,4
        MOVW      DP,#_g_lm+14
        MOVL      ACC,@_g_lm+14         ; |438| 
        MOVL      @_g_lm+12,ACC         ; |438| 
	.dwpsn	"Motor.c",440,4
        MOVW      DP,#_g_rm+1
        MOV       @_g_rm+1,#0           ; |440| 
	.dwpsn	"Motor.c",441,4
	...
	.dwpsn	"Motor.c",443,4
        MOVW      DP,#_g_Flag
        AND       @_g_Flag,#0xfdff      ; |443| 
	.dwpsn	"Motor.c",444,4
        AND       @_g_Flag,#0xfeff      ; |444| 
	.dwpsn	"Motor.c",446,13
        MOVW      DP,#_g_rm+6
        MOVL      ACC,@_g_rm+6          ; |446| 
        MOVW      DP,#_g_lm+4
        MOVL      @_g_lm+4,ACC          ; |446| 
        MOVW      DP,#_g_rm+4
        MOVL      @_g_rm+4,ACC          ; |446| 
	.dwpsn	"Motor.c",448,4
        MOVW      DP,#_g_err
        MOVB      ACC,#0
        MOVL      @_g_err,ACC           ; |448| 
L13:    
;***	-----------------------g10:
;*** 475	-----------------------    if ( g_rm.q17user_vel > g_rm.q17next_vel ) goto g13;
	.dwpsn	"Motor.c",475,2
        MOVW      DP,#_g_rm+16
        MOVL      ACC,@_g_rm+16         ; |475| 
        CMPL      ACC,@_g_rm+12         ; |475| 
        BF        L14,LT                ; |475| 
        ; branchcc occurs ; |475| 
;*** 481	-----------------------    if ( g_rm.q17user_vel >= g_rm.q17next_vel ) goto g15;
	.dwpsn	"Motor.c",481,7
        MOVL      ACC,@_g_rm+16         ; |481| 
        CMPL      ACC,@_g_rm+12         ; |481| 
        BF        L16,LEQ               ; |481| 
        ; branchcc occurs ; |481| 
;*** 483	-----------------------    g_rm.q17next_vel -= __IQxmpy(536870L, g_rm.int32accel<<15, 4);
;*** 484	-----------------------    if ( g_rm.q17user_vel > g_rm.q17next_vel ) goto g14;
	.dwpsn	"Motor.c",483,3
        MOVL      ACC,@_g_rm+4          ; |483| 
        MOVL      XAR4,#536870          ; |483| 
        LSL       ACC,15                ; |483| 
        MOVL      XT,XAR4               ; |483| 
        IMPYL     P,XT,ACC              ; |483| 
        QMPYL     ACC,XT,ACC            ; |483| 
        LSL64     ACC:P,#4              ; |483| 
        SUBL      @_g_rm+16,ACC         ; |483| 
	.dwpsn	"Motor.c",484,3
        MOVL      ACC,@_g_rm+16         ; |484| 
        CMPL      ACC,@_g_rm+12         ; |484| 
        BF        L15,LT                ; |484| 
        ; branchcc occurs ; |484| 
;*** 484	-----------------------    goto g15;
        BF        L16,UNC               ; |484| 
...
L14:    
;***	-----------------------g13:
;*** 477	-----------------------    g_rm.q17next_vel += __IQxmpy(536870L, g_rm.int32accel<<15, 4);
;*** 478	-----------------------    if ( g_rm.q17user_vel >= g_rm.q17next_vel ) goto g15;
	.dwpsn	"Motor.c",477,3
        MOVL      ACC,@_g_rm+4          ; |477| 
        MOVL      XAR4,#536870          ; |477| 
        LSL       ACC,15                ; |477| 
        MOVL      XT,XAR4               ; |477| 
        IMPYL     P,XT,ACC              ; |477| 
        QMPYL     ACC,XT,ACC            ; |477| 
        LSL64     ACC:P,#4              ; |477| 
        ADDL      @_g_rm+16,ACC         ; |477| 
	.dwpsn	"Motor.c",478,3
        MOVL      ACC,@_g_rm+16         ; |478| 
        CMPL      ACC,@_g_rm+12         ; |478| 
        BF        L16,LEQ               ; |478| 
        ; branchcc occurs ; |478| 
L15:    
;***	-----------------------g14:
;*** 479	-----------------------    g_rm.q17next_vel = g_rm.q17user_vel;
	.dwpsn	"Motor.c",479,4
        MOVL      ACC,@_g_rm+12         ; |479| 
        MOVL      @_g_rm+16,ACC         ; |479| 
L16:    
;***	-----------------------g15:
;*** 489	-----------------------    if ( g_lm.q17user_vel > g_lm.q17next_vel ) goto g18;
	.dwpsn	"Motor.c",489,2
        MOVW      DP,#_g_lm+16
        MOVL      ACC,@_g_lm+16         ; |489| 
        CMPL      ACC,@_g_lm+12         ; |489| 
        BF        L17,LT                ; |489| 
        ; branchcc occurs ; |489| 
;*** 495	-----------------------    if ( g_lm.q17user_vel >= g_lm.q17next_vel ) goto g20;
	.dwpsn	"Motor.c",495,7
        MOVL      ACC,@_g_lm+16         ; |495| 
        CMPL      ACC,@_g_lm+12         ; |495| 
        BF        L19,LEQ               ; |495| 
        ; branchcc occurs ; |495| 
;*** 497	-----------------------    g_lm.q17next_vel -= __IQxmpy(536870L, g_rm.int32accel<<15, 4);
;*** 498	-----------------------    if ( g_lm.q17user_vel > g_lm.q17next_vel ) goto g19;
	.dwpsn	"Motor.c",497,3
        MOVW      DP,#_g_rm+4
        MOVL      XAR4,#536870          ; |497| 
        MOVL      ACC,@_g_rm+4          ; |497| 
        MOVL      XT,XAR4               ; |497| 
        LSL       ACC,15                ; |497| 
        IMPYL     P,XT,ACC              ; |497| 
        MOVW      DP,#_g_lm+16
        ...
        LSL64     ACC:P,#4              ; |497| 
        SUBL      @_g_lm+16,ACC         ; |497| 
	.dwpsn	"Motor.c",498,3
        MOVL      ACC,@_g_lm+16         ; |498| 
        CMPL      ACC,@_g_lm+12         ; |498| 
        BF        L18,LT                ; |498| 
        ; branchcc occurs ; |498| 
;*** 498	-----------------------    goto g20;
        BF        L19,UNC               ; |498| 
...
L17:    
;***	-----------------------g18:
;*** 491	-----------------------    g_lm.q17next_vel += __IQxmpy(536870L, g_rm.int32accel<<15, 4);
;*** 492	-----------------------    if ( g_lm.q17user_vel >= g_lm.q17next_vel ) goto g20;
	.dwpsn	"Motor.c",491,3
        MOVW      DP,#_g_rm+4
        MOVL      XAR4,#536870          ; |491| 
        MOVL      ACC,@_g_rm+4          ; |491| 
        MOVL      XT,XAR4               ; |491| 
        LSL       ACC,15                ; |491| 
        IMPYL     P,XT,ACC              ; |491| 
        MOVW      DP,#_g_lm+16
        ...
        LSL64     ACC:P,#4              ; |491| 
        ADDL      @_g_lm+16,ACC         ; |491| 
	.dwpsn	"Motor.c",492,3
        MOVL      ACC,@_g_lm+16         ; |492| 
        CMPL      ACC,@_g_lm+12         ; |492| 
        BF        L19,LEQ               ; |492| 
        ; branchcc occurs ; |492| 
L18:    
;***	-----------------------g19:
;*** 493	-----------------------    g_lm.q17next_vel = g_lm.q17user_vel;
	.dwpsn	"Motor.c",493,4
        MOVL      ACC,@_g_lm+12         ; |493| 
        MOVL      @_g_lm+16,ACC         ; |493| 
L19:    
;***	-----------------------g20:
;*** 506	-----------------------    C$12 = &g_rm;
;*** 506	-----------------------    C$12[18] = C$12[17];
;*** 507	-----------------------    *(&g_rm+34L) = C$12[16];
;*** 508	-----------------------    *(&g_rm+32L) = C$12[15];
;*** 509	-----------------------    *(&g_rm+30L) = __IQmpy(g_rm.q17next_vel, g_q17right_handle, 17)-g_rm.q17cur_vel_avr;
;*** 511	-----------------------    g_rm.q17err_vel_sum += *(&g_rm+30L);
;*** 513	-----------------------    g_rm.q17proportional = __IQxmpy(g_rm.q28kp, *(&g_rm+30L), 4);
;*** 514	-----------------------    g_rm.q17derivative = __IQxmpy(g_rm.q28kd, *(&g_rm+30L)-*(&g_rm+36L)+__IQmpy(*(&g_rm+32L)-*(&g_rm+34L), 393216L, 17), 4);
;*** 518	-----------------------    g_rm.q17pid_out += g_rm.q17proportional+g_rm.q17derivative;
;*** 521	-----------------------    C$11 = &g_lm;
;*** 521	-----------------------    C$11[18] = C$11[17];
;*** 522	-----------------------    *(&g_lm+34L) = C$11[16];
;*** 523	-----------------------    *(&g_lm+32L) = C$11[15];
;*** 524	-----------------------    *(&g_lm+30L) = __IQmpy(g_lm.q17next_vel, g_q17left_handle, 17)-g_lm.q17cur_vel_avr;
;*** 526	-----------------------    g_lm.q17err_vel_sum += *(&g_lm+30L);
;*** 529	-----------------------    g_lm.q17proportional = __IQxmpy(g_lm.q28kp, *(&g_lm+30L), 4);
;*** 530	-----------------------    g_lm.q17derivative = __IQxmpy(g_lm.q28kd, *(&g_lm+30L)-*(&g_lm+36L)+__IQmpy(*(&g_lm+32L)-*(&g_lm+34L), 393216L, 17), 4);
;*** 534	-----------------------    g_lm.q17pid_out += g_lm.q17proportional+g_lm.q17derivative;
;*** 538	-----------------------    if ( !(*&g_Flag&1u) ) goto g35;
	.dwpsn	"Motor.c",506,2
        MOVB      XAR0,#34              ; |506| 
        MOVL      XAR4,#_g_rm           ; |506| 
	...
	.dwpsn	"Motor.c",507,2
        ...
        MOVL      @_g_rm+34,ACC         ; |507| 
	.dwpsn	"Motor.c",508,2
        MOVB      XAR0,#30              ; |508| 
        MOVL      ACC,*+XAR4[AR0]       ; |508| 
        MOVL      @_g_rm+32,ACC         ; |508| 
	.dwpsn	"Motor.c",509,2
        MOVL      XT,@_g_rm+16          ; |509| 
        MOVW      DP,#_g_q17right_handle
        IMPYL     P,XT,@_g_q17right_handle ; |509| 
        QMPYL     ACC,XT,@_g_q17right_handle ; |509| 
        MOVW      DP,#_g_rm+28
        LSL64     ACC:P,#15             ; |509| 
        SUBL      ACC,@_g_rm+28         ; |509| 
        MOVL      @_g_rm+30,ACC         ; |509| 
	.dwpsn	"Motor.c",511,2
        MOVL      ACC,@_g_rm+30         ; |511| 
        ADDL      @_g_rm+38,ACC         ; |511| 
	.dwpsn	"Motor.c",513,2
        MOVW      DP,#_g_rm+68
        MOVL      XT,@_g_rm+68          ; |513| 
        MOVW      DP,#_g_rm+30
        IMPYL     P,XT,@_g_rm+30        ; |513| 
        QMPYL     ACC,XT,@_g_rm+30      ; |513| 
        LSL64     ACC:P,#4              ; |513| 
        MOVL      @_g_rm+40,ACC         ; |513| 
	.dwpsn	"Motor.c",514,2
        MOVL      ACC,@_g_rm+32         ; |514| 
        SUBL      ACC,@_g_rm+34         ; |514| 
        MOVL      XAR4,#393216          ; |514| 
        MOVL      XT,ACC                ; |514| 
        IMPYL     P,XT,XAR4             ; |514| 
        MOVL      XT,ACC                ; |514| 
        QMPYL     ACC,XT,XAR4           ; |514| 
        LSL64     ACC:P,#15             ; |514| 
        MOVL      XAR6,ACC              ; |514| 
        MOVL      ACC,@_g_rm+30         ; |514| 
        SUBL      ACC,@_g_rm+36         ; |514| 
        ADDL      XAR6,ACC
        MOVW      DP,#_g_rm+72
        MOVL      XT,@_g_rm+72          ; |514| 
        IMPYL     P,XT,XAR6             ; |514| 
        QMPYL     ACC,XT,XAR6           ; |514| 
        MOVW      DP,#_g_rm+44
        LSL64     ACC:P,#4              ; |514| 
        MOVL      @_g_rm+44,ACC         ; |514| 
	.dwpsn	"Motor.c",518,2
        MOVL      ACC,@_g_rm+40         ; |518| 
        ADDL      ACC,@_g_rm+10         ; |518| 
        ADDL      ACC,@_g_rm+44         ; |518| 
        MOVL      @_g_rm+10,ACC         ; |518| 
	.dwpsn	"Motor.c",521,2
        MOVB      XAR0,#34              ; |521| 
        MOVL      XAR4,#_g_lm           ; |521| 
	...
	.dwpsn	"Motor.c",522,2
        MOVB      XAR0,#32              ; |522| 
        MOVW      DP,#_g_lm+34
        MOVL      ACC,*+XAR4[AR0]       ; |522| 
        MOVL      @_g_lm+34,ACC         ; |522| 
	.dwpsn	"Motor.c",523,2
        MOVB      XAR0,#30              ; |523| 
        MOVL      ACC,*+XAR4[AR0]       ; |523| 
        MOVL      @_g_lm+32,ACC         ; |523| 
	.dwpsn	"Motor.c",524,2
        MOVL      XT,@_g_lm+16          ; |524| 
        MOVW      DP,#_g_q17left_handle
        IMPYL     P,XT,@_g_q17left_handle ; |524| 
        QMPYL     ACC,XT,@_g_q17left_handle ; |524| 
        MOVW      DP,#_g_lm+28
        LSL64     ACC:P,#15             ; |524| 
        SUBL      ACC,@_g_lm+28         ; |524| 
        MOVL      @_g_lm+30,ACC         ; |524| 
	.dwpsn	"Motor.c",526,2
        MOVL      ACC,@_g_lm+30         ; |526| 
        ADDL      @_g_lm+38,ACC         ; |526| 
	.dwpsn	"Motor.c",529,2
        MOVW      DP,#_g_lm+68
        MOVL      XT,@_g_lm+68          ; |529| 
        MOVW      DP,#_g_lm+30
        IMPYL     P,XT,@_g_lm+30        ; |529| 
        QMPYL     ACC,XT,@_g_lm+30      ; |529| 
        LSL64     ACC:P,#4              ; |529| 
        MOVL      @_g_lm+40,ACC         ; |529| 
	.dwpsn	"Motor.c",530,2
        MOVL      ACC,@_g_lm+32         ; |530| 
        SUBL      ACC,@_g_lm+34         ; |530| 
        MOVL      XAR4,#393216          ; |530| 
        MOVL      XT,ACC                ; |530| 
        IMPYL     P,XT,XAR4             ; |530| 
        MOVL      XT,ACC                ; |530| 
        QMPYL     ACC,XT,XAR4           ; |530| 
        LSL64     ACC:P,#15             ; |530| 
        MOVL      XAR6,ACC              ; |530| 
        MOVL      ACC,@_g_lm+30         ; |530| 
        SUBL      ACC,@_g_lm+36         ; |530| 
        ADDL      XAR6,ACC
        MOVW      DP,#_g_lm+72
        MOVL      XT,@_g_lm+72          ; |530| 
        IMPYL     P,XT,XAR6             ; |530| 
        QMPYL     ACC,XT,XAR6           ; |530| 
        MOVW      DP,#_g_lm+44
        LSL64     ACC:P,#4              ; |530| 
        MOVL      @_g_lm+44,ACC         ; |530| 
	.dwpsn	"Motor.c",534,2
        MOVL      ACC,@_g_lm+40         ; |534| 
        ADDL      ACC,@_g_lm+10         ; |534| 
        ADDL      ACC,@_g_lm+44         ; |534| 
        MOVL      @_g_lm+10,ACC         ; |534| 
	.dwpsn	"Motor.c",538,2
        MOVW      DP,#_g_Flag
        TBIT      @_g_Flag,#0           ; |538| 
        BF        L27,NTC               ; |538| 
        ; branchcc occurs ; |538| 
;*** 542	-----------------------    if ( g_rm.q17pid_out > 0L ) goto g25;
	.dwpsn	"Motor.c",542,3
        MOVW      DP,#_g_rm+10
        MOVL      ACC,@_g_rm+10         ; |542| 
        BF        L21,GT                ; |542| 
        ; branchcc occurs ; |542| 
;*** 555	-----------------------    if ( g_rm.q17pid_out >= (-1009254400L) ) goto g24;
	.dwpsn	"Motor.c",555,4
        MOV       ACC,#-30800 << 15
...
L20:    
;***	-----------------------g24:
;*** 558	-----------------------    C$10 = &GpioDataRegs;
;*** 558	-----------------------    ((volatile unsigned *)C$10)[4];
;*** 558	-----------------------    *(&GpioDataRegs+4L) = *(&GpioDataRegs+4L)|2u;
;*** 558	-----------------------    *(&GpioDataRegs+2L) = ((volatile unsigned *)C$10)[2]|0x10u;
;*** 561	-----------------------    g_rm.q17pid_result = __IQmpy(__IQxmpy(g_rm.q17pid_out, 278893984L, 2), (-131072L), 17);
;*** 562	-----------------------    RightPwmRegs.CMPA.half.CMPA = g_rm.q17pid_result>>17;
;*** 562	-----------------------    goto g28;
	.dwpsn	"Motor.c",558,13
        MOVL      XAR4,#_GpioDataRegs   ; |558| 
        MOVW      DP,#_GpioDataRegs+4
        MOV       AL,*+XAR4[4]          ; |558| 
        OR        @_GpioDataRegs+4,#0x0002 ; |558| 
        MOV       AL,*+XAR4[2]          ; |558| 
        ORB       AL,#0x10              ; |558| 
        MOV       @_GpioDataRegs+2,AL   ; |558| 
	.dwpsn	"Motor.c",561,4
        MOVW      DP,#_g_rm+10
        MOV       AH,#4255
        MOV       AL,#38304
...
L21:    
;***	-----------------------g25:
;*** 544	-----------------------    if ( g_rm.q17pid_out <= 1009254400L ) goto g27;
	.dwpsn	"Motor.c",544,4
        MOV       ACC,#30800 << 15
        CMPL      ACC,@_g_rm+10         ; |544| 
        BF        L22,GEQ               ; |544| 
        ; branchcc occurs ; |544| 
;*** 545	-----------------------    g_rm.q17pid_out = 1009254400L;
	.dwpsn	"Motor.c",545,5
        MOV       PH,#15400
        MOV       PL,#0
        MOVL      @_g_rm+10,P           ; |545| 
L22:    
;***	-----------------------g27:
;*** 548	-----------------------    C$9 = &GpioDataRegs;
;*** 548	-----------------------    ((volatile unsigned *)C$9)[4];
;*** 548	-----------------------    *(&GpioDataRegs+4L) = *(&GpioDataRegs+4L)|0x10u;
;*** 548	-----------------------    *(&GpioDataRegs+2L) = ((volatile unsigned *)C$9)[2]|2u;
;*** 550	-----------------------    g_rm.q17pid_result = __IQxmpy(g_rm.q17pid_out, 278893984L, 2);
;*** 551	-----------------------    RightPwmRegs.CMPA.half.CMPA = g_rm.q17pid_result>>17;
	.dwpsn	"Motor.c",548,13
        MOVL      XAR4,#_GpioDataRegs   ; |548| 
        MOVW      DP,#_GpioDataRegs+4
        MOV       AL,*+XAR4[4]          ; |548| 
        OR        @_GpioDataRegs+4,#0x0010 ; |548| 
        MOV       AL,*+XAR4[2]          ; |548| 
        ORB       AL,#0x02              ; |548| 
	...
	.dwpsn	"Motor.c",550,4
        ...
        MOV       AH,#4255
        MOV       AL,#38304
        MOVL      XT,@_g_rm+10          ; |550| 
        IMPYL     P,XT,ACC              ; |550| 
        QMPYL     ACC,XT,ACC            ; |550| 
        LSL64     ACC:P,#2              ; |550| 
        MOVL      @_g_rm+58,ACC         ; |550| 
	.dwpsn	"Motor.c",551,4
        MOVL      ACC,@_g_rm+58         ; |551| 
        MOV       T,#17                 ; |551| 
        MOVW      DP,#_RightPwmRegs+9
        ASRL      ACC,T                 ; |551| 
        MOV       @_RightPwmRegs+9,AL   ; |551| 
L23:    
;***	-----------------------g28:
;*** 552	-----------------------    if ( g_lm.q17pid_out > 0L ) goto g32;
	.dwpsn	"Motor.c",552,3
        MOVW      DP,#_g_lm+10
        MOVL      ACC,@_g_lm+10         ; |552| 
        BF        L25,GT                ; |552| 
        ; branchcc occurs ; |552| 
;*** 580	-----------------------    if ( g_lm.q17pid_out >= (-1009254400L) ) goto g31;
	.dwpsn	"Motor.c",580,4
        MOV       ACC,#-30800 << 15
        CMPL      ACC,@_g_lm+10         ; |580| 
        BF        L24,LEQ               ; |580| 
        ; branchcc occurs ; |580| 
;*** 581	-----------------------    g_lm.q17pid_out = (-1009254400L);
	.dwpsn	"Motor.c",581,5
        MOV       PH,#50136
        MOV       PL,#0
        MOVL      @_g_lm+10,P           ; |581| 
L24:    
;***	-----------------------g31:
;*** 583	-----------------------    C$8 = &GpioDataRegs;
;*** 583	-----------------------    ((volatile unsigned *)C$8)[4];
;*** 583	-----------------------    *(&GpioDataRegs+4L) = *(&GpioDataRegs+4L)|0x20u;
;*** 583	-----------------------    *(&GpioDataRegs+2L) = ((volatile unsigned *)C$8)[2]|0x8u;
;*** 586	-----------------------    g_lm.q17pid_result = __IQmpy(__IQxmpy(g_lm.q17pid_out, 278893984L, 2), (-131072L), 17);
;*** 587	-----------------------    LeftPwmRegs.CMPA.half.CMPA = g_lm.q17pid_result>>17;
;*** 587	-----------------------    goto g35;
	.dwpsn	"Motor.c",583,4
        MOVL      XAR4,#_GpioDataRegs   ; |583| 
        MOVW      DP,#_GpioDataRegs+4
        MOV       AL,*+XAR4[4]          ; |583| 
        OR        @_GpioDataRegs+4,#0x0020 ; |583| 
        MOV       AL,*+XAR4[2]          ; |583| 
        ORB       AL,#0x08              ; |583| 
        MOV       @_GpioDataRegs+2,AL   ; |583| 
	.dwpsn	"Motor.c",586,4
        MOVW      DP,#_g_lm+10
        MOV       AH,#4255
        MOV       AL,#38304
        MOVL      XT,@_g_lm+10          ; |586| 
        IMPYL     P,XT,ACC              ; |586| 
        ...
        QMPYL     ACC,XT,ACC            ; |586| 
        LSL64     ACC:P,#15             ; |586| 
        MOVL      @_g_lm+58,ACC         ; |586| 
	.dwpsn	"Motor.c",587,4
        MOVL      ACC,@_g_lm+58         ; |587| 
        MOV       T,#17                 ; |587| 
        MOVW      DP,#_LeftPwmRegs+9
        ASRL      ACC,T                 ; |587| 
        MOV       @_LeftPwmRegs+9,AL    ; |587| 
        BF        L27,UNC               ; |587| 
        ; branch occurs ; |587| 
L25:    
;***	-----------------------g32:
;*** 568	-----------------------    if ( g_lm.q17pid_out <= 1009254400L ) goto g34;
	.dwpsn	"Motor.c",568,4
        MOV       ACC,#30800 << 15
        CMPL      ACC,@_g_lm+10         ; |568| 
        BF        L26,GEQ               ; |568| 
        ; branchcc occurs ; |568| 
;*** 569	-----------------------    g_lm.q17pid_out = 1009254400L;
	.dwpsn	"Motor.c",569,5
        MOV       PH,#15400
        MOV       PL,#0
        MOVL      @_g_lm+10,P           ; |569| 
L26:    
;***	-----------------------g34:
;*** 571	-----------------------    C$7 = &GpioDataRegs;
;*** 571	-----------------------    ((volatile unsigned *)C$7)[4];
;*** 571	-----------------------    *(&GpioDataRegs+4L) = *(&GpioDataRegs+4L)|0x8u;
;*** 571	-----------------------    *(&GpioDataRegs+2L) = ((volatile unsigned *)C$7)[2]|0x20u;
;*** 575	-----------------------    g_lm.q17pid_result = __IQxmpy(g_lm.q17pid_out, 278893984L, 2);
;*** 576	-----------------------    LeftPwmRegs.CMPA.half.CMPA = g_lm.q17pid_result>>17;
	.dwpsn	"Motor.c",571,13
        MOVL      XAR4,#_GpioDataRegs   ; |571| 
        MOVW      DP,#_GpioDataRegs+4
        MOV       AL,*+XAR4[4]          ; |571| 
        OR        @_GpioDataRegs+4,#0x0008 ; |571| 
        MOV       AL,*+XAR4[2]          ; |571| 
        ORB       AL,#0x20              ; |571| 
        MOV       @_GpioDataRegs+2,AL   ; |571| 
	.dwpsn	"Motor.c",575,4
        MOVW      DP,#_g_lm+10
        MOV       AH,#4255
        MOV       AL,#38304
        MOVL      XT,@_g_lm+10          ; |575| 
        IMPYL     P,XT,ACC              ; |575| 
        QMPYL     ACC,XT,ACC            ; |575| 
        LSL64     ACC:P,#2              ; |575| 
        MOVL      @_g_lm+58,ACC         ; |575| 
	.dwpsn	"Motor.c",576,4
        MOVL      ACC,@_g_lm+58         ; |576| 
        MOV       T,#17                 ; |576| 
        MOVW      DP,#_LeftPwmRegs+9
        ASRL      ACC,T                 ; |576| 
        MOV       @_LeftPwmRegs+9,AL    ; |576| 
L27:    
;***	-----------------------g35:
;*** 593	-----------------------    if ( !(*&g_Flag&0x8u) ) goto g37;
	.dwpsn	"Motor.c",593,2
        MOVW      DP,#_g_Flag
        TBIT      @_g_Flag,#3           ; |593| 
        BF        L28,NTC               ; |593| 
        ; branchcc occurs ; |593| 
;*** 593	-----------------------    ++g_int32timer_cnt;
	.dwpsn	"Motor.c",593,27
        MOVB      ACC,#1
        MOVW      DP,#_g_int32timer_cnt
        ADDL      @_g_int32timer_cnt,ACC ; |593| 
L28:    
;***	-----------------------g37:
;*** 595	-----------------------    *(&CpuTimer0Regs+4L) &= 0xffefu;
;*** 595	-----------------------    return;
	.dwpsn	"Motor.c",595,2
        MOVW      DP,#_CpuTimer0Regs+4
        AND       @_CpuTimer0Regs+4,#0xffef ; |595| 
	.dwpsn	"Motor.c",597,1
	.dwcfa	0x1d, -14
        MOVL      XT,*--SP
	.dwcfa	0x1d, -12
	...
	.dwattr DW$110, DW_AT_end_line(0x255)
...
DW$121	.dwtag  DW_TAG_subprogram, DW_AT_name("max_vel_compute"), DW_AT_symbol_name("_max_vel_compute")
	.dwattr DW$121, DW_AT_low_pc(_max_vel_compute)
	.dwattr DW$121, DW_AT_high_pc(0x00)
	.dwattr DW$121, DW_AT_begin_file("Motor.c")
	.dwattr DW$121, DW_AT_begin_line(0x8a)
...
;*** 158	-----------------------    if ( *max_vel > g_q17fast_vel_limit ) goto g4;
	...
	.dwcfa	0x1d, -14
;* AL    assigned to _dist
DW$122	.dwtag  DW_TAG_formal_parameter, DW_AT_name("dist"), DW_AT_symbol_name("_dist")
	.dwattr DW$122, DW_AT_type(*DW$T$139)
	.dwattr DW$122, DW_AT_location[DW_OP_reg0]
DW$123	.dwtag  DW_TAG_formal_parameter, DW_AT_name("minus_dist"), DW_AT_symbol_name("_minus_dist")
	.dwattr DW$123, DW_AT_type(*DW$T$139)
	.dwattr DW$123, DW_AT_location[DW_OP_breg20 -16]
DW$124	.dwtag  DW_TAG_formal_parameter, DW_AT_name("cur_vel"), DW_AT_symbol_name("_cur_vel")
	.dwattr DW$124, DW_AT_type(*DW$T$139)
	.dwattr DW$124, DW_AT_location[DW_OP_breg20 -18]
DW$125	.dwtag  DW_TAG_formal_parameter, DW_AT_name("acc"), DW_AT_symbol_name("_acc")
	.dwattr DW$125, DW_AT_type(*DW$T$139)
	.dwattr DW$125, DW_AT_location[DW_OP_breg20 -20]
;* AR4   assigned to _max_vel
DW$126	.dwtag  DW_TAG_formal_parameter, DW_AT_name("max_vel"), DW_AT_symbol_name("_max_vel")
...
DW$128	.dwtag  DW_TAG_variable, DW_AT_name("cur_vel"), DW_AT_symbol_name("_cur_vel")
	.dwattr DW$128, DW_AT_type(*DW$T$154)
	.dwattr DW$128, DW_AT_location[DW_OP_reg16]
;* PL    assigned to _minus_dist
DW$129	.dwtag  DW_TAG_variable, DW_AT_name("minus_dist"), DW_AT_symbol_name("_minus_dist")
...
DW$131	.dwtag  DW_TAG_variable, DW_AT_name("accdist"), DW_AT_symbol_name("_accdist")
	.dwattr DW$131, DW_AT_type(*DW$T$27)
	.dwattr DW$131, DW_AT_location[DW_OP_reg0]
;* AR6   assigned to _curvel_2
DW$132	.dwtag  DW_TAG_variable, DW_AT_name("curvel_2"), DW_AT_symbol_name("_curvel_2")
	.dwattr DW$132, DW_AT_type(*DW$T$27)
	.dwattr DW$132, DW_AT_location[DW_OP_reg16]
;* AR1   assigned to _max_vel
DW$133	.dwtag  DW_TAG_variable, DW_AT_name("max_vel"), DW_AT_symbol_name("_max_vel")
...
DW$135	.dwtag  DW_TAG_variable, DW_AT_name("minus_dist"), DW_AT_symbol_name("_minus_dist")
	.dwattr DW$135, DW_AT_type(*DW$T$139)
	.dwattr DW$135, DW_AT_location[DW_OP_breg20 -6]
DW$136	.dwtag  DW_TAG_variable, DW_AT_name("cur_vel"), DW_AT_symbol_name("_cur_vel")
...
L30:    
	...
	.dwattr DW$121, DW_AT_end_line(0xa1)
...
DW$138	.dwtag  DW_TAG_subprogram, DW_AT_name("handle_ad_make"), DW_AT_symbol_name("_handle_ad_make")
	.dwattr DW$138, DW_AT_low_pc(_handle_ad_make)
	.dwattr DW$138, DW_AT_high_pc(0x00)
	.dwattr DW$138, DW_AT_begin_file("Motor.c")
	.dwattr DW$138, DW_AT_begin_line(0x6d)
...
DW$139	.dwtag  DW_TAG_formal_parameter, DW_AT_name("acc_rate"), DW_AT_symbol_name("_acc_rate")
	.dwattr DW$139, DW_AT_type(*DW$T$144)
	.dwattr DW$139, DW_AT_location[DW_OP_reg0]
DW$140	.dwtag  DW_TAG_formal_parameter, DW_AT_name("dec_rate"), DW_AT_symbol_name("_dec_rate")
	.dwattr DW$140, DW_AT_type(*DW$T$144)
	.dwattr DW$140, DW_AT_location[DW_OP_breg20 -10]
;* AL    assigned to _acc_rate
DW$141	.dwtag  DW_TAG_variable, DW_AT_name("acc_rate"), DW_AT_symbol_name("_acc_rate")
	.dwattr DW$141, DW_AT_type(*DW$T$155)
	.dwattr DW$141, DW_AT_location[DW_OP_reg0]
;* AR6   assigned to _dec_rate
DW$142	.dwtag  DW_TAG_variable, DW_AT_name("dec_rate"), DW_AT_symbol_name("_dec_rate")
	.dwattr DW$142, DW_AT_type(*DW$T$155)
	.dwattr DW$142, DW_AT_location[DW_OP_reg16]
DW$143	.dwtag  DW_TAG_variable, DW_AT_name("acc_rate"), DW_AT_symbol_name("_acc_rate")
	.dwattr DW$143, DW_AT_type(*DW$T$144)
	.dwattr DW$143, DW_AT_location[DW_OP_breg20 -4]
DW$144	.dwtag  DW_TAG_variable, DW_AT_name("dec_rate"), DW_AT_symbol_name("_dec_rate")
	...
	.dwattr DW$138, DW_AT_end_line(0x75)
...
DW$145	.dwtag  DW_TAG_subprogram, DW_AT_name("decel_dist_compute"), DW_AT_symbol_name("_decel_dist_compute")
	.dwattr DW$145, DW_AT_low_pc(_decel_dist_compute)
	.dwattr DW$145, DW_AT_high_pc(0x00)
	.dwattr DW$145, DW_AT_begin_file("Motor.c")
	.dwattr DW$145, DW_AT_begin_line(0x79)
...
;*** 131	-----------------------    return;
	...
	.dwcfa	0x1d, -12
;* AL    assigned to _cur_vel
DW$146	.dwtag  DW_TAG_formal_parameter, DW_AT_name("cur_vel"), DW_AT_symbol_name("_cur_vel")
	.dwattr DW$146, DW_AT_type(*DW$T$139)
	.dwattr DW$146, DW_AT_location[DW_OP_reg0]
DW$147	.dwtag  DW_TAG_formal_parameter, DW_AT_name("tar_vel"), DW_AT_symbol_name("_tar_vel")
	.dwattr DW$147, DW_AT_type(*DW$T$139)
	.dwattr DW$147, DW_AT_location[DW_OP_breg20 -14]
DW$148	.dwtag  DW_TAG_formal_parameter, DW_AT_name("acc"), DW_AT_symbol_name("_acc")
	.dwattr DW$148, DW_AT_type(*DW$T$139)
	.dwattr DW$148, DW_AT_location[DW_OP_breg20 -16]
;* AR4   assigned to _decel_dist
DW$149	.dwtag  DW_TAG_formal_parameter, DW_AT_name("decel_dist"), DW_AT_symbol_name("_decel_dist")
	.dwattr DW$149, DW_AT_type(*DW$T$140)
	.dwattr DW$149, DW_AT_location[DW_OP_reg12]
;* AR1   assigned to _decel_dist
DW$150	.dwtag  DW_TAG_variable, DW_AT_name("decel_dist"), DW_AT_symbol_name("_decel_dist")
	.dwattr DW$150, DW_AT_type(*DW$T$153)
	.dwattr DW$150, DW_AT_location[DW_OP_reg6]
;* AL    assigned to _cur_vel
DW$151	.dwtag  DW_TAG_variable, DW_AT_name("cur_vel"), DW_AT_symbol_name("_cur_vel")
	.dwattr DW$151, DW_AT_type(*DW$T$154)
	.dwattr DW$151, DW_AT_location[DW_OP_reg0]
;* AR7   assigned to _tar_vel
DW$152	.dwtag  DW_TAG_variable, DW_AT_name("tar_vel"), DW_AT_symbol_name("_tar_vel")
	.dwattr DW$152, DW_AT_type(*DW$T$154)
	.dwattr DW$152, DW_AT_location[DW_OP_reg18]
;* AR6   assigned to _acc
DW$153	.dwtag  DW_TAG_variable, DW_AT_name("acc"), DW_AT_symbol_name("_acc")
	.dwattr DW$153, DW_AT_type(*DW$T$154)
	.dwattr DW$153, DW_AT_location[DW_OP_reg16]
DW$154	.dwtag  DW_TAG_variable, DW_AT_name("cur_vel"), DW_AT_symbol_name("_cur_vel")
	.dwattr DW$154, DW_AT_type(*DW$T$139)
	.dwattr DW$154, DW_AT_location[DW_OP_breg20 -4]
DW$155	.dwtag  DW_TAG_variable, DW_AT_name("tar_vel"), DW_AT_symbol_name("_tar_vel")
	.dwattr DW$155, DW_AT_type(*DW$T$139)
	.dwattr DW$155, DW_AT_location[DW_OP_breg20 -6]
DW$156	.dwtag  DW_TAG_variable, DW_AT_name("acc"), DW_AT_symbol_name("_acc")
	...
	.dwattr DW$145, DW_AT_end_line(0x85)
...
DW$157	.dwtag  DW_TAG_subprogram, DW_AT_name("Dist_to_minvel_cpt"), DW_AT_symbol_name("_Dist_to_minvel_cpt")
	.dwattr DW$157, DW_AT_low_pc(_Dist_to_minvel_cpt)
	.dwattr DW$157, DW_AT_high_pc(0x00)
	.dwattr DW$157, DW_AT_begin_file("Motor.c")
	.dwattr DW$157, DW_AT_begin_line(0xa3)
...
;*** 174	-----------------------    if ( *min_vel >= 0L ) goto g3;
	...
	.dwcfa	0x1d, -22
;* AL    assigned to _dist
DW$158	.dwtag  DW_TAG_formal_parameter, DW_AT_name("dist"), DW_AT_symbol_name("_dist")
	.dwattr DW$158, DW_AT_type(*DW$T$139)
	.dwattr DW$158, DW_AT_location[DW_OP_reg0]
DW$159	.dwtag  DW_TAG_formal_parameter, DW_AT_name("cur_vel"), DW_AT_symbol_name("_cur_vel")
	.dwattr DW$159, DW_AT_type(*DW$T$139)
	.dwattr DW$159, DW_AT_location[DW_OP_breg20 -24]
DW$160	.dwtag  DW_TAG_formal_parameter, DW_AT_name("acc"), DW_AT_symbol_name("_acc")
	.dwattr DW$160, DW_AT_type(*DW$T$139)
	.dwattr DW$160, DW_AT_location[DW_OP_breg20 -26]
;* AR4   assigned to _min_vel
DW$161	.dwtag  DW_TAG_formal_parameter, DW_AT_name("min_vel"), DW_AT_symbol_name("_min_vel")
	.dwattr DW$161, DW_AT_type(*DW$T$140)
...
DW$163	.dwtag  DW_TAG_variable, DW_AT_name("cur_vel"), DW_AT_symbol_name("_cur_vel")
	.dwattr DW$163, DW_AT_type(*DW$T$154)
	.dwattr DW$163, DW_AT_location[DW_OP_reg18]
;* AL    assigned to _dist
DW$164	.dwtag  DW_TAG_variable, DW_AT_name("dist"), DW_AT_symbol_name("_dist")
	.dwattr DW$164, DW_AT_type(*DW$T$154)
	.dwattr DW$164, DW_AT_location[DW_OP_reg0]
;* AR2   assigned to _iq17acc
DW$165	.dwtag  DW_TAG_variable, DW_AT_name("iq17acc"), DW_AT_symbol_name("_iq17acc")
	.dwattr DW$165, DW_AT_type(*DW$T$27)
	.dwattr DW$165, DW_AT_location[DW_OP_reg8]
;* AR1   assigned to _min_vel
DW$166	.dwtag  DW_TAG_variable, DW_AT_name("min_vel"), DW_AT_symbol_name("_min_vel")
	.dwattr DW$166, DW_AT_type(*DW$T$153)
	.dwattr DW$166, DW_AT_location[DW_OP_reg6]
DW$167	.dwtag  DW_TAG_variable, DW_AT_name("dist"), DW_AT_symbol_name("_dist")
	.dwattr DW$167, DW_AT_type(*DW$T$139)
	.dwattr DW$167, DW_AT_location[DW_OP_breg20 -4]
DW$168	.dwtag  DW_TAG_variable, DW_AT_name("cur_vel"), DW_AT_symbol_name("_cur_vel")
	.dwattr DW$168, DW_AT_type(*DW$T$139)
	.dwattr DW$168, DW_AT_location[DW_OP_breg20 -6]
...
L31:    
	...
	.dwattr DW$157, DW_AT_end_line(0xb0)
...
DW$172	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$119)
	.dwendtag DW$T$120


DW$T$125	.dwtag  DW_TAG_subroutine_type
	.dwattr DW$T$125, DW_AT_language(DW_LANG_C)
DW$173	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$124)
...
DW$175	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$32)
DW$176	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$131)
DW$177	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$21)
DW$178	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$132)
	.dwendtag DW$T$133


DW$T$138	.dwtag  DW_TAG_subroutine_type
	.dwattr DW$T$138, DW_AT_language(DW_LANG_C)
DW$179	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$137)
	.dwendtag DW$T$138
...
DW$183	.dwtag  DW_TAG_formal_parameter, DW_AT_type(*DW$T$140)
	.dwendtag DW$T$141
...
DW$199	.dwtag  DW_TAG_far_type
	.dwattr DW$199, DW_AT_type(*DW$T$21)
DW$T$132	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$132, DW_AT_type(*DW$199)
...
DW$200	.dwtag  DW_TAG_far_type
	.dwattr DW$200, DW_AT_type(*DW$T$27)
DW$T$139	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$139, DW_AT_type(*DW$200)
...
DW$T$155	.dwtag  DW_TAG_const_type
	.dwattr DW$T$155, DW_AT_type(*DW$204)
...
DW$211	.dwtag  DW_TAG_far_type
	.dwattr DW$211, DW_AT_type(*DW$T$137)
DW$T$169	.dwtag  DW_TAG_const_type
	.dwattr DW$T$169, DW_AT_type(*DW$211)
...
DW$212	.dwtag  DW_TAG_far_type
	.dwattr DW$212, DW_AT_type(*DW$T$37)
DW$T$174	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$174, DW_AT_type(*DW$212)
DW$213	.dwtag  DW_TAG_far_type
	.dwattr DW$213, DW_AT_type(*DW$T$48)
DW$T$178	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$178, DW_AT_type(*DW$213)
DW$214	.dwtag  DW_TAG_far_type
	.dwattr DW$214, DW_AT_type(*DW$T$93)
...
DW$T$191	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$191, DW_AT_type(*DW$215)
...
DW$231	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$39)
	.dwattr DW$231, DW_AT_name("TIM"), DW_AT_symbol_name("_TIM")
	.dwattr DW$231, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$231, DW_AT_accessibility(DW_ACCESS_public)
DW$232	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$41)
	.dwattr DW$232, DW_AT_name("PRD"), DW_AT_symbol_name("_PRD")
	.dwattr DW$232, DW_AT_data_member_location[DW_OP_plus_uconst 0x2]
	.dwattr DW$232, DW_AT_accessibility(DW_ACCESS_public)
DW$233	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$43)
	.dwattr DW$233, DW_AT_name("TCR"), DW_AT_symbol_name("_TCR")
...
DW$235	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$45)
	.dwattr DW$235, DW_AT_name("TPR"), DW_AT_symbol_name("_TPR")
	.dwattr DW$235, DW_AT_data_member_location[DW_OP_plus_uconst 0x6]
	.dwattr DW$235, DW_AT_accessibility(DW_ACCESS_public)
DW$236	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$47)
	.dwattr DW$236, DW_AT_name("TPRH"), DW_AT_symbol_name("_TPRH")
...
DW$243	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$56)
	.dwattr DW$243, DW_AT_name("CMPCTL"), DW_AT_symbol_name("_CMPCTL")
	.dwattr DW$243, DW_AT_data_member_location[DW_OP_plus_uconst 0x7]
	.dwattr DW$243, DW_AT_accessibility(DW_ACCESS_public)
DW$244	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$58)
	.dwattr DW$244, DW_AT_name("CMPA"), DW_AT_symbol_name("_CMPA")
	.dwattr DW$244, DW_AT_data_member_location[DW_OP_plus_uconst 0x8]
	.dwattr DW$244, DW_AT_accessibility(DW_ACCESS_public)
DW$245	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$245, DW_AT_name("CMPB"), DW_AT_symbol_name("_CMPB")
	.dwattr DW$245, DW_AT_data_member_location[DW_OP_plus_uconst 0xa]
	.dwattr DW$245, DW_AT_accessibility(DW_ACCESS_public)
DW$246	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$60)
	.dwattr DW$246, DW_AT_name("AQCTLA"), DW_AT_symbol_name("_AQCTLA")
	.dwattr DW$246, DW_AT_data_member_location[DW_OP_plus_uconst 0xb]
	.dwattr DW$246, DW_AT_accessibility(DW_ACCESS_public)
DW$247	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$60)
	.dwattr DW$247, DW_AT_name("AQCTLB"), DW_AT_symbol_name("_AQCTLB")
	.dwattr DW$247, DW_AT_data_member_location[DW_OP_plus_uconst 0xc]
	.dwattr DW$247, DW_AT_accessibility(DW_ACCESS_public)
DW$248	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$62)
	.dwattr DW$248, DW_AT_name("AQSFRC"), DW_AT_symbol_name("_AQSFRC")
	.dwattr DW$248, DW_AT_data_member_location[DW_OP_plus_uconst 0xd]
	.dwattr DW$248, DW_AT_accessibility(DW_ACCESS_public)
DW$249	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$64)
	.dwattr DW$249, DW_AT_name("AQCSFRC"), DW_AT_symbol_name("_AQCSFRC")
	.dwattr DW$249, DW_AT_data_member_location[DW_OP_plus_uconst 0xe]
	.dwattr DW$249, DW_AT_accessibility(DW_ACCESS_public)
DW$250	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$66)
	.dwattr DW$250, DW_AT_name("DBCTL"), DW_AT_symbol_name("_DBCTL")
	.dwattr DW$250, DW_AT_data_member_location[DW_OP_plus_uconst 0xf]
	.dwattr DW$250, DW_AT_accessibility(DW_ACCESS_public)
DW$251	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$251, DW_AT_name("DBRED"), DW_AT_symbol_name("_DBRED")
	.dwattr DW$251, DW_AT_data_member_location[DW_OP_plus_uconst 0x10]
	.dwattr DW$251, DW_AT_accessibility(DW_ACCESS_public)
DW$252	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$252, DW_AT_name("DBFED"), DW_AT_symbol_name("_DBFED")
	.dwattr DW$252, DW_AT_data_member_location[DW_OP_plus_uconst 0x11]
	.dwattr DW$252, DW_AT_accessibility(DW_ACCESS_public)
DW$253	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$68)
	.dwattr DW$253, DW_AT_name("TZSEL"), DW_AT_symbol_name("_TZSEL")
...
DW$254	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$254, DW_AT_data_member_location[DW_OP_plus_uconst 0x13]
	.dwattr DW$254, DW_AT_accessibility(DW_ACCESS_public)
DW$255	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$70)
	.dwattr DW$255, DW_AT_name("TZCTL"), DW_AT_symbol_name("_TZCTL")
	.dwattr DW$255, DW_AT_data_member_location[DW_OP_plus_uconst 0x14]
	.dwattr DW$255, DW_AT_accessibility(DW_ACCESS_public)
DW$256	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$72)
	.dwattr DW$256, DW_AT_name("TZEINT"), DW_AT_symbol_name("_TZEINT")
	.dwattr DW$256, DW_AT_data_member_location[DW_OP_plus_uconst 0x15]
	.dwattr DW$256, DW_AT_accessibility(DW_ACCESS_public)
DW$257	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$74)
	.dwattr DW$257, DW_AT_name("TZFLG"), DW_AT_symbol_name("_TZFLG")
	.dwattr DW$257, DW_AT_data_member_location[DW_OP_plus_uconst 0x16]
	.dwattr DW$257, DW_AT_accessibility(DW_ACCESS_public)
DW$258	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$76)
	.dwattr DW$258, DW_AT_name("TZCLR"), DW_AT_symbol_name("_TZCLR")
	.dwattr DW$258, DW_AT_data_member_location[DW_OP_plus_uconst 0x17]
	.dwattr DW$258, DW_AT_accessibility(DW_ACCESS_public)
DW$259	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$78)
	.dwattr DW$259, DW_AT_name("TZFRC"), DW_AT_symbol_name("_TZFRC")
	.dwattr DW$259, DW_AT_data_member_location[DW_OP_plus_uconst 0x18]
	.dwattr DW$259, DW_AT_accessibility(DW_ACCESS_public)
DW$260	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$80)
	.dwattr DW$260, DW_AT_name("ETSEL"), DW_AT_symbol_name("_ETSEL")
	.dwattr DW$260, DW_AT_data_member_location[DW_OP_plus_uconst 0x19]
	.dwattr DW$260, DW_AT_accessibility(DW_ACCESS_public)
DW$261	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$82)
	.dwattr DW$261, DW_AT_name("ETPS"), DW_AT_symbol_name("_ETPS")
	.dwattr DW$261, DW_AT_data_member_location[DW_OP_plus_uconst 0x1a]
	.dwattr DW$261, DW_AT_accessibility(DW_ACCESS_public)
DW$262	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$84)
	.dwattr DW$262, DW_AT_name("ETFLG"), DW_AT_symbol_name("_ETFLG")
	.dwattr DW$262, DW_AT_data_member_location[DW_OP_plus_uconst 0x1b]
	.dwattr DW$262, DW_AT_accessibility(DW_ACCESS_public)
DW$263	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$86)
	.dwattr DW$263, DW_AT_name("ETCLR"), DW_AT_symbol_name("_ETCLR")
	.dwattr DW$263, DW_AT_data_member_location[DW_OP_plus_uconst 0x1c]
	.dwattr DW$263, DW_AT_accessibility(DW_ACCESS_public)
DW$264	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$88)
	.dwattr DW$264, DW_AT_name("ETFRC"), DW_AT_symbol_name("_ETFRC")
	.dwattr DW$264, DW_AT_data_member_location[DW_OP_plus_uconst 0x1d]
	.dwattr DW$264, DW_AT_accessibility(DW_ACCESS_public)
DW$265	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$90)
	.dwattr DW$265, DW_AT_name("PCCTL"), DW_AT_symbol_name("_PCCTL")
...
DW$266	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$266, DW_AT_data_member_location[DW_OP_plus_uconst 0x1f]
	.dwattr DW$266, DW_AT_accessibility(DW_ACCESS_public)
DW$267	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$92)
	.dwattr DW$267, DW_AT_name("HRCNFG"), DW_AT_symbol_name("_HRCNFG")
...
DW$296	.dwtag  DW_TAG_far_type
	.dwattr DW$296, DW_AT_type(*DW$T$118)
DW$T$203	.dwtag  DW_TAG_volatile_type
	.dwattr DW$T$203, DW_AT_type(*DW$296)
...
DW$318	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$318, DW_AT_name("u16qep_sample"), DW_AT_symbol_name("_u16qep_sample")
	.dwattr DW$318, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$318, DW_AT_accessibility(DW_ACCESS_public)
DW$319	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$319, DW_AT_name("u16decel_flag"), DW_AT_symbol_name("_u16decel_flag")
	.dwattr DW$319, DW_AT_data_member_location[DW_OP_plus_uconst 0x1]
	.dwattr DW$319, DW_AT_accessibility(DW_ACCESS_public)
DW$320	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$24)
	.dwattr DW$320, DW_AT_name("int16qep_val"), DW_AT_symbol_name("_int16qep_val")
...
DW$322	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$25)
	.dwattr DW$322, DW_AT_name("int32decel"), DW_AT_symbol_name("_int32decel")
	.dwattr DW$322, DW_AT_data_member_location[DW_OP_plus_uconst 0x6]
	.dwattr DW$322, DW_AT_accessibility(DW_ACCESS_public)
DW$323	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$26)
	.dwattr DW$323, DW_AT_name("q27tick_dist"), DW_AT_symbol_name("_q27tick_dist")
	.dwattr DW$323, DW_AT_data_member_location[DW_OP_plus_uconst 0x8]
	.dwattr DW$323, DW_AT_accessibility(DW_ACCESS_public)
DW$324	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$324, DW_AT_name("q17pid_out"), DW_AT_symbol_name("_q17pid_out")
	.dwattr DW$324, DW_AT_data_member_location[DW_OP_plus_uconst 0xa]
	.dwattr DW$324, DW_AT_accessibility(DW_ACCESS_public)
DW$325	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$325, DW_AT_name("q17user_vel"), DW_AT_symbol_name("_q17user_vel")
	.dwattr DW$325, DW_AT_data_member_location[DW_OP_plus_uconst 0xc]
	.dwattr DW$325, DW_AT_accessibility(DW_ACCESS_public)
DW$326	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$326, DW_AT_name("q17decel_vel"), DW_AT_symbol_name("_q17decel_vel")
	.dwattr DW$326, DW_AT_data_member_location[DW_OP_plus_uconst 0xe]
	.dwattr DW$326, DW_AT_accessibility(DW_ACCESS_public)
DW$327	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$327, DW_AT_name("q17next_vel"), DW_AT_symbol_name("_q17next_vel")
	.dwattr DW$327, DW_AT_data_member_location[DW_OP_plus_uconst 0x10]
	.dwattr DW$327, DW_AT_accessibility(DW_ACCESS_public)
DW$328	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$328, DW_AT_name("q17next_acc"), DW_AT_symbol_name("_q17next_acc")
	.dwattr DW$328, DW_AT_data_member_location[DW_OP_plus_uconst 0x12]
	.dwattr DW$328, DW_AT_accessibility(DW_ACCESS_public)
DW$329	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$28)
	.dwattr DW$329, DW_AT_name("q17cur_vel"), DW_AT_symbol_name("_q17cur_vel")
	.dwattr DW$329, DW_AT_data_member_location[DW_OP_plus_uconst 0x14]
	.dwattr DW$329, DW_AT_accessibility(DW_ACCESS_public)
DW$330	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$330, DW_AT_name("q17cur_vel_avr"), DW_AT_symbol_name("_q17cur_vel_avr")
	.dwattr DW$330, DW_AT_data_member_location[DW_OP_plus_uconst 0x1c]
	.dwattr DW$330, DW_AT_accessibility(DW_ACCESS_public)
DW$331	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$28)
	.dwattr DW$331, DW_AT_name("q17err_vel"), DW_AT_symbol_name("_q17err_vel")
	.dwattr DW$331, DW_AT_data_member_location[DW_OP_plus_uconst 0x1e]
	.dwattr DW$331, DW_AT_accessibility(DW_ACCESS_public)
DW$332	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$332, DW_AT_name("q17err_vel_sum"), DW_AT_symbol_name("_q17err_vel_sum")
	.dwattr DW$332, DW_AT_data_member_location[DW_OP_plus_uconst 0x26]
	.dwattr DW$332, DW_AT_accessibility(DW_ACCESS_public)
DW$333	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$333, DW_AT_name("q17proportional"), DW_AT_symbol_name("_q17proportional")
	.dwattr DW$333, DW_AT_data_member_location[DW_OP_plus_uconst 0x28]
	.dwattr DW$333, DW_AT_accessibility(DW_ACCESS_public)
DW$334	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$334, DW_AT_name("q17integral"), DW_AT_symbol_name("_q17integral")
	.dwattr DW$334, DW_AT_data_member_location[DW_OP_plus_uconst 0x2a]
	.dwattr DW$334, DW_AT_accessibility(DW_ACCESS_public)
DW$335	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$335, DW_AT_name("q17derivative"), DW_AT_symbol_name("_q17derivative")
	.dwattr DW$335, DW_AT_data_member_location[DW_OP_plus_uconst 0x2c]
	.dwattr DW$335, DW_AT_accessibility(DW_ACCESS_public)
DW$336	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$336, DW_AT_name("q17err_dist"), DW_AT_symbol_name("_q17err_dist")
	.dwattr DW$336, DW_AT_data_member_location[DW_OP_plus_uconst 0x2e]
	.dwattr DW$336, DW_AT_accessibility(DW_ACCESS_public)
DW$337	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$337, DW_AT_name("q17total_dist"), DW_AT_symbol_name("_q17total_dist")
	.dwattr DW$337, DW_AT_data_member_location[DW_OP_plus_uconst 0x30]
	.dwattr DW$337, DW_AT_accessibility(DW_ACCESS_public)
DW$338	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$338, DW_AT_name("q17user_dist"), DW_AT_symbol_name("_q17user_dist")
	.dwattr DW$338, DW_AT_data_member_location[DW_OP_plus_uconst 0x32]
	.dwattr DW$338, DW_AT_accessibility(DW_ACCESS_public)
DW$339	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$339, DW_AT_name("q17decel_dist"), DW_AT_symbol_name("_q17decel_dist")
	.dwattr DW$339, DW_AT_data_member_location[DW_OP_plus_uconst 0x34]
	.dwattr DW$339, DW_AT_accessibility(DW_ACCESS_public)
DW$340	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$340, DW_AT_name("q17start_dist"), DW_AT_symbol_name("_q17start_dist")
	.dwattr DW$340, DW_AT_data_member_location[DW_OP_plus_uconst 0x36]
	.dwattr DW$340, DW_AT_accessibility(DW_ACCESS_public)
DW$341	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$341, DW_AT_name("q17start_dist_total"), DW_AT_symbol_name("_q17start_dist_total")
	.dwattr DW$341, DW_AT_data_member_location[DW_OP_plus_uconst 0x38]
	.dwattr DW$341, DW_AT_accessibility(DW_ACCESS_public)
DW$342	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$342, DW_AT_name("q17pid_result"), DW_AT_symbol_name("_q17pid_result")
	.dwattr DW$342, DW_AT_data_member_location[DW_OP_plus_uconst 0x3a]
	.dwattr DW$342, DW_AT_accessibility(DW_ACCESS_public)
DW$343	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$343, DW_AT_name("q17gone_distance"), DW_AT_symbol_name("_q17gone_distance")
	.dwattr DW$343, DW_AT_data_member_location[DW_OP_plus_uconst 0x3c]
	.dwattr DW$343, DW_AT_accessibility(DW_ACCESS_public)
DW$344	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$344, DW_AT_name("q17end_gone_distance"), DW_AT_symbol_name("_q17end_gone_distance")
	.dwattr DW$344, DW_AT_data_member_location[DW_OP_plus_uconst 0x3e]
	.dwattr DW$344, DW_AT_accessibility(DW_ACCESS_public)
DW$345	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$345, DW_AT_name("q17dist_sum"), DW_AT_symbol_name("_q17dist_sum")
	.dwattr DW$345, DW_AT_data_member_location[DW_OP_plus_uconst 0x40]
	.dwattr DW$345, DW_AT_accessibility(DW_ACCESS_public)
DW$346	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$346, DW_AT_name("q17get_dist"), DW_AT_symbol_name("_q17get_dist")
	.dwattr DW$346, DW_AT_data_member_location[DW_OP_plus_uconst 0x42]
	.dwattr DW$346, DW_AT_accessibility(DW_ACCESS_public)
DW$347	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$29)
	.dwattr DW$347, DW_AT_name("q28kp"), DW_AT_symbol_name("_q28kp")
	.dwattr DW$347, DW_AT_data_member_location[DW_OP_plus_uconst 0x44]
	.dwattr DW$347, DW_AT_accessibility(DW_ACCESS_public)
DW$348	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$29)
	.dwattr DW$348, DW_AT_name("q28ki"), DW_AT_symbol_name("_q28ki")
	.dwattr DW$348, DW_AT_data_member_location[DW_OP_plus_uconst 0x46]
	.dwattr DW$348, DW_AT_accessibility(DW_ACCESS_public)
DW$349	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$29)
	.dwattr DW$349, DW_AT_name("q28kd"), DW_AT_symbol_name("_q28kd")
	.dwattr DW$349, DW_AT_data_member_location[DW_OP_plus_uconst 0x48]
...
DW$382	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$32)
...
DW$385	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$34)
...
DW$389	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$40)
	.dwattr DW$389, DW_AT_name("half"), DW_AT_symbol_name("_half")
...
DW$391	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$42)
...
DW$393	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$44)
...
DW$395	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$46)
...
DW$397	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$49)
...
DW$401	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$53)
...
DW$403	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$55)
...
DW$405	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$57)
	.dwattr DW$405, DW_AT_name("half"), DW_AT_symbol_name("_half")
...
DW$407	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$59)
...
DW$409	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$61)
...
DW$411	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$63)
...
DW$413	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$65)
...
DW$415	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$67)
...
DW$417	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$69)
...
DW$419	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$71)
...
DW$421	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$73)
...
DW$425	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$77)
...
DW$427	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$79)
...
DW$429	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$81)
...
DW$431	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$83)
...
DW$435	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$87)
...
DW$437	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$89)
...
DW$439	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$91)
...
DW$441	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$94)
...
DW$443	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$96)
...
DW$447	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$100)
...
DW$449	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$102)
...
DW$453	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$106)
...
DW$455	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$108)
...
DW$456	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$456, DW_AT_name("motor_start"), DW_AT_symbol_name("_motor_start")
...
DW$473	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$473, DW_AT_name("B45_flag"), DW_AT_symbol_name("_B45_flag")
...
DW$474	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$474, DW_AT_name("B90_flag"), DW_AT_symbol_name("_B90_flag")
...
DW$475	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$475, DW_AT_name("B180_flag"), DW_AT_symbol_name("_B180_flag")
...
DW$476	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$476, DW_AT_name("BLTURN_flag"), DW_AT_symbol_name("_BLTURN_flag")
...
DW$477	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$477, DW_AT_name("BALL_flag"), DW_AT_symbol_name("_BALL_flag")
...
DW$513	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$115)
...
DW$514	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$115)
...
DW$516	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$116)
...
DW$517	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$117)
...
DW$529	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$529, DW_AT_name("LSW"), DW_AT_symbol_name("_LSW")
	.dwattr DW$529, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$529, DW_AT_accessibility(DW_ACCESS_public)
DW$530	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$530, DW_AT_name("MSW"), DW_AT_symbol_name("_MSW")
...
DW$531	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$531, DW_AT_name("LSW"), DW_AT_symbol_name("_LSW")
	.dwattr DW$531, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$531, DW_AT_accessibility(DW_ACCESS_public)
DW$532	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$532, DW_AT_name("MSW"), DW_AT_symbol_name("_MSW")
...
DW$534	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$534, DW_AT_name("TSS"), DW_AT_symbol_name("_TSS")
	.dwattr DW$534, DW_AT_bit_offset(0x0b), DW_AT_bit_size(0x01)
	.dwattr DW$534, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$534, DW_AT_accessibility(DW_ACCESS_public)
DW$535	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$535, DW_AT_name("TRB"), DW_AT_symbol_name("_TRB")
...
DW$536	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$536, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x04)
	.dwattr DW$536, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$536, DW_AT_accessibility(DW_ACCESS_public)
DW$537	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$537, DW_AT_name("SOFT"), DW_AT_symbol_name("_SOFT")
	.dwattr DW$537, DW_AT_bit_offset(0x05), DW_AT_bit_size(0x01)
	.dwattr DW$537, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$537, DW_AT_accessibility(DW_ACCESS_public)
DW$538	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$538, DW_AT_name("FREE"), DW_AT_symbol_name("_FREE")
...
DW$540	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$540, DW_AT_name("TIE"), DW_AT_symbol_name("_TIE")
	.dwattr DW$540, DW_AT_bit_offset(0x01), DW_AT_bit_size(0x01)
	.dwattr DW$540, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$540, DW_AT_accessibility(DW_ACCESS_public)
DW$541	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$541, DW_AT_name("TIF"), DW_AT_symbol_name("_TIF")
...
DW$542	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$542, DW_AT_name("TDDR"), DW_AT_symbol_name("_TDDR")
	.dwattr DW$542, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x08)
	.dwattr DW$542, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$542, DW_AT_accessibility(DW_ACCESS_public)
DW$543	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$543, DW_AT_name("PSC"), DW_AT_symbol_name("_PSC")
...
DW$544	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$544, DW_AT_name("TDDRH"), DW_AT_symbol_name("_TDDRH")
	.dwattr DW$544, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x08)
	.dwattr DW$544, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$544, DW_AT_accessibility(DW_ACCESS_public)
DW$545	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$545, DW_AT_name("PSCH"), DW_AT_symbol_name("_PSCH")
...
DW$546	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$546, DW_AT_name("CTRMODE"), DW_AT_symbol_name("_CTRMODE")
	.dwattr DW$546, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
	.dwattr DW$546, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$546, DW_AT_accessibility(DW_ACCESS_public)
DW$547	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$547, DW_AT_name("PHSEN"), DW_AT_symbol_name("_PHSEN")
	.dwattr DW$547, DW_AT_bit_offset(0x0d), DW_AT_bit_size(0x01)
	.dwattr DW$547, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$547, DW_AT_accessibility(DW_ACCESS_public)
DW$548	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$548, DW_AT_name("PRDLD"), DW_AT_symbol_name("_PRDLD")
	.dwattr DW$548, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x01)
	.dwattr DW$548, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$548, DW_AT_accessibility(DW_ACCESS_public)
DW$549	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$549, DW_AT_name("SYNCOSEL"), DW_AT_symbol_name("_SYNCOSEL")
	.dwattr DW$549, DW_AT_bit_offset(0x0a), DW_AT_bit_size(0x02)
	.dwattr DW$549, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$549, DW_AT_accessibility(DW_ACCESS_public)
DW$550	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$550, DW_AT_name("SWFSYNC"), DW_AT_symbol_name("_SWFSYNC")
	.dwattr DW$550, DW_AT_bit_offset(0x09), DW_AT_bit_size(0x01)
	.dwattr DW$550, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$550, DW_AT_accessibility(DW_ACCESS_public)
DW$551	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$551, DW_AT_name("HSPCLKDIV"), DW_AT_symbol_name("_HSPCLKDIV")
	.dwattr DW$551, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x03)
	.dwattr DW$551, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$551, DW_AT_accessibility(DW_ACCESS_public)
DW$552	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$552, DW_AT_name("CLKDIV"), DW_AT_symbol_name("_CLKDIV")
	.dwattr DW$552, DW_AT_bit_offset(0x03), DW_AT_bit_size(0x03)
	.dwattr DW$552, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$552, DW_AT_accessibility(DW_ACCESS_public)
DW$553	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$553, DW_AT_name("PHSDIR"), DW_AT_symbol_name("_PHSDIR")
...
DW$559	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$559, DW_AT_name("TBPHSHR"), DW_AT_symbol_name("_TBPHSHR")
	.dwattr DW$559, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$559, DW_AT_accessibility(DW_ACCESS_public)
DW$560	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$560, DW_AT_name("TBPHS"), DW_AT_symbol_name("_TBPHS")
...
DW$561	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$561, DW_AT_name("LOADAMODE"), DW_AT_symbol_name("_LOADAMODE")
	.dwattr DW$561, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
	.dwattr DW$561, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$561, DW_AT_accessibility(DW_ACCESS_public)
DW$562	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$562, DW_AT_name("LOADBMODE"), DW_AT_symbol_name("_LOADBMODE")
	.dwattr DW$562, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x02)
	.dwattr DW$562, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$562, DW_AT_accessibility(DW_ACCESS_public)
DW$563	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$563, DW_AT_name("SHDWAMODE"), DW_AT_symbol_name("_SHDWAMODE")
...
DW$565	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$565, DW_AT_name("SHDWBMODE"), DW_AT_symbol_name("_SHDWBMODE")
...
DW$567	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$567, DW_AT_name("SHDWAFULL"), DW_AT_symbol_name("_SHDWAFULL")
	.dwattr DW$567, DW_AT_bit_offset(0x07), DW_AT_bit_size(0x01)
	.dwattr DW$567, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$567, DW_AT_accessibility(DW_ACCESS_public)
DW$568	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$568, DW_AT_name("SHDWBFULL"), DW_AT_symbol_name("_SHDWBFULL")
...
DW$569	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$569, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x06)
...
DW$570	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$570, DW_AT_name("CMPAHR"), DW_AT_symbol_name("_CMPAHR")
	.dwattr DW$570, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$570, DW_AT_accessibility(DW_ACCESS_public)
DW$571	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$571, DW_AT_name("CMPA"), DW_AT_symbol_name("_CMPA")
...
DW$572	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$572, DW_AT_name("ZRO"), DW_AT_symbol_name("_ZRO")
	.dwattr DW$572, DW_AT_bit_offset(0x0e), DW_AT_bit_size(0x02)
	.dwattr DW$572, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$572, DW_AT_accessibility(DW_ACCESS_public)
DW$573	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$573, DW_AT_name("PRD"), DW_AT_symbol_name("_PRD")
	.dwattr DW$573, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x02)
	.dwattr DW$573, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$573, DW_AT_accessibility(DW_ACCESS_public)
DW$574	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$574, DW_AT_name("CAU"), DW_AT_symbol_name("_CAU")
	.dwattr DW$574, DW_AT_bit_offset(0x0a), DW_AT_bit_size(0x02)
	.dwattr DW$574, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$574, DW_AT_accessibility(DW_ACCESS_public)
DW$575	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$575, DW_AT_name("CAD"), DW_AT_symbol_name("_CAD")
...
DW$576	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$576, DW_AT_name("CBU"), DW_AT_symbol_name("_CBU")
	.dwattr DW$576, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x02)
	.dwattr DW$576, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$576, DW_AT_accessibility(DW_ACCESS_public)
DW$577	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$577, DW_AT_name("CBD"), DW_AT_symbol_name("_CBD")
	.dwattr DW$577, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x02)
...
DW$579	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$579, DW_AT_name("ACTSFA"), DW_AT_symbol_name("_ACTSFA")
...
DW$580	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$580, DW_AT_name("OTSFA"), DW_AT_symbol_name("_OTSFA")
...
DW$581	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$581, DW_AT_name("ACTSFB"), DW_AT_symbol_name("_ACTSFB")
	.dwattr DW$581, DW_AT_bit_offset(0x0b), DW_AT_bit_size(0x02)
	.dwattr DW$581, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$581, DW_AT_accessibility(DW_ACCESS_public)
DW$582	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$582, DW_AT_name("OTSFB"), DW_AT_symbol_name("_OTSFB")
...
DW$583	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$583, DW_AT_name("RLDCSF"), DW_AT_symbol_name("_RLDCSF")
	.dwattr DW$583, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x02)
...
DW$585	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$585, DW_AT_name("CSFA"), DW_AT_symbol_name("_CSFA")
...
DW$586	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$586, DW_AT_name("CSFB"), DW_AT_symbol_name("_CSFB")
...
DW$588	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$588, DW_AT_name("OUT_MODE"), DW_AT_symbol_name("_OUT_MODE")
...
DW$589	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$589, DW_AT_name("POLSEL"), DW_AT_symbol_name("_POLSEL")
...
DW$590	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$590, DW_AT_name("IN_MODE"), DW_AT_symbol_name("_IN_MODE")
...
DW$591	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$591, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x0a)
...
DW$592	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$592, DW_AT_name("CBC1"), DW_AT_symbol_name("_CBC1")
...
DW$593	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$593, DW_AT_name("CBC2"), DW_AT_symbol_name("_CBC2")
...
DW$594	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$594, DW_AT_name("CBC3"), DW_AT_symbol_name("_CBC3")
...
DW$595	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$595, DW_AT_name("CBC4"), DW_AT_symbol_name("_CBC4")
...
DW$596	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$596, DW_AT_name("CBC5"), DW_AT_symbol_name("_CBC5")
...
DW$597	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$597, DW_AT_name("CBC6"), DW_AT_symbol_name("_CBC6")
...
DW$599	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$599, DW_AT_name("OSHT1"), DW_AT_symbol_name("_OSHT1")
	.dwattr DW$599, DW_AT_bit_offset(0x07), DW_AT_bit_size(0x01)
	.dwattr DW$599, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$599, DW_AT_accessibility(DW_ACCESS_public)
DW$600	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$600, DW_AT_name("OSHT2"), DW_AT_symbol_name("_OSHT2")
	.dwattr DW$600, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x01)
	.dwattr DW$600, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$600, DW_AT_accessibility(DW_ACCESS_public)
DW$601	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$601, DW_AT_name("OSHT3"), DW_AT_symbol_name("_OSHT3")
...
DW$602	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$602, DW_AT_name("OSHT4"), DW_AT_symbol_name("_OSHT4")
...
DW$603	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$603, DW_AT_name("OSHT5"), DW_AT_symbol_name("_OSHT5")
	.dwattr DW$603, DW_AT_bit_offset(0x03), DW_AT_bit_size(0x01)
	.dwattr DW$603, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$603, DW_AT_accessibility(DW_ACCESS_public)
DW$604	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$604, DW_AT_name("OSHT6"), DW_AT_symbol_name("_OSHT6")
	.dwattr DW$604, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x01)
...
DW$605	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$605, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x02)
...
DW$606	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$606, DW_AT_name("TZA"), DW_AT_symbol_name("_TZA")
...
DW$607	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$607, DW_AT_name("TZB"), DW_AT_symbol_name("_TZB")
	.dwattr DW$607, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x02)
	.dwattr DW$607, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$607, DW_AT_accessibility(DW_ACCESS_public)
DW$608	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$608, DW_AT_name("rsvd"), DW_AT_symbol_name("_rsvd")
...
DW$617	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$617, DW_AT_name("INT"), DW_AT_symbol_name("_INT")
...
DW$618	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$618, DW_AT_name("CBC"), DW_AT_symbol_name("_CBC")
...
DW$619	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$619, DW_AT_name("OST"), DW_AT_symbol_name("_OST")
...
DW$620	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$620, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x0d)
...
DW$622	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$622, DW_AT_name("CBC"), DW_AT_symbol_name("_CBC")
...
DW$623	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$623, DW_AT_name("OST"), DW_AT_symbol_name("_OST")
...
DW$625	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$625, DW_AT_name("INTSEL"), DW_AT_symbol_name("_INTSEL")
	.dwattr DW$625, DW_AT_bit_offset(0x0d), DW_AT_bit_size(0x03)
	.dwattr DW$625, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$625, DW_AT_accessibility(DW_ACCESS_public)
DW$626	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$626, DW_AT_name("INTEN"), DW_AT_symbol_name("_INTEN")
...
DW$628	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$628, DW_AT_name("SOCASEL"), DW_AT_symbol_name("_SOCASEL")
	.dwattr DW$628, DW_AT_bit_offset(0x05), DW_AT_bit_size(0x03)
...
DW$629	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$629, DW_AT_name("SOCAEN"), DW_AT_symbol_name("_SOCAEN")
	.dwattr DW$629, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x01)
...
DW$630	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$630, DW_AT_name("SOCBSEL"), DW_AT_symbol_name("_SOCBSEL")
	.dwattr DW$630, DW_AT_bit_offset(0x01), DW_AT_bit_size(0x03)
...
DW$631	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$631, DW_AT_name("SOCBEN"), DW_AT_symbol_name("_SOCBEN")
...
DW$632	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$632, DW_AT_name("INTPRD"), DW_AT_symbol_name("_INTPRD")
...
DW$633	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$633, DW_AT_name("INTCNT"), DW_AT_symbol_name("_INTCNT")
...
DW$634	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$634, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x04)
...
DW$635	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$635, DW_AT_name("SOCAPRD"), DW_AT_symbol_name("_SOCAPRD")
	.dwattr DW$635, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x02)
...
DW$636	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$636, DW_AT_name("SOCACNT"), DW_AT_symbol_name("_SOCACNT")
	.dwattr DW$636, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x02)
...
DW$637	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$637, DW_AT_name("SOCBPRD"), DW_AT_symbol_name("_SOCBPRD")
	.dwattr DW$637, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x02)
...
DW$638	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$638, DW_AT_name("SOCBCNT"), DW_AT_symbol_name("_SOCBCNT")
	.dwattr DW$638, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x02)
...
DW$654	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$654, DW_AT_name("CHPEN"), DW_AT_symbol_name("_CHPEN")
...
DW$655	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$655, DW_AT_name("OSHTWTH"), DW_AT_symbol_name("_OSHTWTH")
	.dwattr DW$655, DW_AT_bit_offset(0x0b), DW_AT_bit_size(0x04)
...
DW$656	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$656, DW_AT_name("CHPFREQ"), DW_AT_symbol_name("_CHPFREQ")
	.dwattr DW$656, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x03)
...
DW$657	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$657, DW_AT_name("CHPDUTY"), DW_AT_symbol_name("_CHPDUTY")
	.dwattr DW$657, DW_AT_bit_offset(0x05), DW_AT_bit_size(0x03)
...
DW$658	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$658, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x05)
...
DW$659	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$659, DW_AT_name("EDGMODE"), DW_AT_symbol_name("_EDGMODE")
...
DW$660	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$660, DW_AT_name("CTLMODE"), DW_AT_symbol_name("_CTLMODE")
...
DW$661	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$661, DW_AT_name("HRLOAD"), DW_AT_symbol_name("_HRLOAD")
...
DW$663	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$663, DW_AT_bit_offset(0x0b), DW_AT_bit_size(0x05)
...
DW$664	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$664, DW_AT_name("QSP"), DW_AT_symbol_name("_QSP")
...
DW$665	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$665, DW_AT_name("QIP"), DW_AT_symbol_name("_QIP")
	.dwattr DW$665, DW_AT_bit_offset(0x09), DW_AT_bit_size(0x01)
...
DW$666	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$666, DW_AT_name("QBP"), DW_AT_symbol_name("_QBP")
	.dwattr DW$666, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x01)
...
DW$667	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$667, DW_AT_name("QAP"), DW_AT_symbol_name("_QAP")
	.dwattr DW$667, DW_AT_bit_offset(0x07), DW_AT_bit_size(0x01)
...
DW$668	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$668, DW_AT_name("IGATE"), DW_AT_symbol_name("_IGATE")
	.dwattr DW$668, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x01)
...
DW$669	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$669, DW_AT_name("SWAP"), DW_AT_symbol_name("_SWAP")
	.dwattr DW$669, DW_AT_bit_offset(0x05), DW_AT_bit_size(0x01)
...
DW$670	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$670, DW_AT_name("XCR"), DW_AT_symbol_name("_XCR")
	.dwattr DW$670, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x01)
...
DW$671	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$671, DW_AT_name("SPSEL"), DW_AT_symbol_name("_SPSEL")
	.dwattr DW$671, DW_AT_bit_offset(0x03), DW_AT_bit_size(0x01)
...
DW$672	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$672, DW_AT_name("SOEN"), DW_AT_symbol_name("_SOEN")
	.dwattr DW$672, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x01)
...
DW$673	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$673, DW_AT_name("QSRC"), DW_AT_symbol_name("_QSRC")
	.dwattr DW$673, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x02)
...
DW$674	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$674, DW_AT_name("WDE"), DW_AT_symbol_name("_WDE")
...
DW$675	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$675, DW_AT_name("UTE"), DW_AT_symbol_name("_UTE")
...
DW$676	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$676, DW_AT_name("QCLM"), DW_AT_symbol_name("_QCLM")
...
DW$677	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$677, DW_AT_name("QPEN"), DW_AT_symbol_name("_QPEN")
...
DW$678	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$678, DW_AT_name("IEL"), DW_AT_symbol_name("_IEL")
	.dwattr DW$678, DW_AT_bit_offset(0x0a), DW_AT_bit_size(0x02)
...
DW$679	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$679, DW_AT_name("SEL"), DW_AT_symbol_name("_SEL")
	.dwattr DW$679, DW_AT_bit_offset(0x09), DW_AT_bit_size(0x01)
...
DW$680	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$680, DW_AT_name("SWI"), DW_AT_symbol_name("_SWI")
	.dwattr DW$680, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x01)
...
DW$681	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$681, DW_AT_name("IEI"), DW_AT_symbol_name("_IEI")
	.dwattr DW$681, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x02)
...
DW$682	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$682, DW_AT_name("SEI"), DW_AT_symbol_name("_SEI")
	.dwattr DW$682, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x02)
...
DW$683	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$683, DW_AT_name("PCRM"), DW_AT_symbol_name("_PCRM")
	.dwattr DW$683, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x02)
...
DW$684	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$684, DW_AT_name("FREE_SOFT"), DW_AT_symbol_name("_FREE_SOFT")
	.dwattr DW$684, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x02)
...
DW$685	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$685, DW_AT_name("UPPS"), DW_AT_symbol_name("_UPPS")
	.dwattr DW$685, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x04)
...
DW$686	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$686, DW_AT_name("CCPS"), DW_AT_symbol_name("_CCPS")
	.dwattr DW$686, DW_AT_bit_offset(0x09), DW_AT_bit_size(0x03)
...
DW$687	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$687, DW_AT_bit_offset(0x01), DW_AT_bit_size(0x08)
...
DW$688	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$688, DW_AT_name("CEN"), DW_AT_symbol_name("_CEN")
...
DW$689	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$689, DW_AT_name("PCSPW"), DW_AT_symbol_name("_PCSPW")
	.dwattr DW$689, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x0c)
...
DW$690	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$690, DW_AT_bit_offset(0x03), DW_AT_bit_size(0x01)
...
DW$691	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$691, DW_AT_name("PCPOL"), DW_AT_symbol_name("_PCPOL")
	.dwattr DW$691, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x01)
...
DW$692	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$692, DW_AT_name("PCLOAD"), DW_AT_symbol_name("_PCLOAD")
	.dwattr DW$692, DW_AT_bit_offset(0x01), DW_AT_bit_size(0x01)
...
DW$693	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$693, DW_AT_name("PCSHDW"), DW_AT_symbol_name("_PCSHDW")
	.dwattr DW$693, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x01)
...
DW$695	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$695, DW_AT_name("PCE"), DW_AT_symbol_name("_PCE")
...
DW$696	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$696, DW_AT_name("QPE"), DW_AT_symbol_name("_QPE")
...
DW$697	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$697, DW_AT_name("QDC"), DW_AT_symbol_name("_QDC")
...
DW$698	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$698, DW_AT_name("WTO"), DW_AT_symbol_name("_WTO")
...
DW$699	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$699, DW_AT_name("PCU"), DW_AT_symbol_name("_PCU")
...
DW$700	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$700, DW_AT_name("PCO"), DW_AT_symbol_name("_PCO")
	.dwattr DW$700, DW_AT_bit_offset(0x09), DW_AT_bit_size(0x01)
...
DW$701	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$701, DW_AT_name("PCR"), DW_AT_symbol_name("_PCR")
	.dwattr DW$701, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x01)
...
DW$702	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$702, DW_AT_name("PCM"), DW_AT_symbol_name("_PCM")
	.dwattr DW$702, DW_AT_bit_offset(0x07), DW_AT_bit_size(0x01)
...
DW$703	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$703, DW_AT_name("SEL"), DW_AT_symbol_name("_SEL")
	.dwattr DW$703, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x01)
...
DW$704	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$704, DW_AT_name("IEL"), DW_AT_symbol_name("_IEL")
	.dwattr DW$704, DW_AT_bit_offset(0x05), DW_AT_bit_size(0x01)
...
DW$705	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$705, DW_AT_name("UTO"), DW_AT_symbol_name("_UTO")
	.dwattr DW$705, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x01)
...
DW$706	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	...
	.dwattr DW$706, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x04)
...
DW$709	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$709, DW_AT_name("PHE"), DW_AT_symbol_name("_PHE")
...
DW$720	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$720, DW_AT_name("reserved"), DW_AT_symbol_name("_reserved")
...
DW$733	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$733, DW_AT_name("PCEF"), DW_AT_symbol_name("_PCEF")
...
DW$734	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$734, DW_AT_name("FIMF"), DW_AT_symbol_name("_FIMF")
...
DW$735	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$735, DW_AT_name("CDEF"), DW_AT_symbol_name("_CDEF")
...
DW$736	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$736, DW_AT_name("COEF"), DW_AT_symbol_name("_COEF")
...
DW$737	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$737, DW_AT_name("QDLF"), DW_AT_symbol_name("_QDLF")
...
DW$738	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$738, DW_AT_name("QDF"), DW_AT_symbol_name("_QDF")
...
DW$739	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$739, DW_AT_name("FIDF"), DW_AT_symbol_name("_FIDF")
...
DW$740	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$740, DW_AT_name("UPEVNT"), DW_AT_symbol_name("_UPEVNT")
