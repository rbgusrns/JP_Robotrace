...
;* Date/Time created: Thu Jan 08 17:15:44 2026                 *
;***************************************************************
...
;*** 462	-----------------------    if ( (g_fast_info[g_int32mark_cnt]).u16turn_dir&1u ) goto g11;
        ...
        MOVL      XAR4,#_g_fast_info+40 ; |462| 
        MOVL      XT,ACC                ; |462| 
        IMPYL     ACC,XT,@_g_int32mark_cnt ; |462| 
        ADDL      XAR4,ACC
        TBIT      *+XAR4[0],#0          ; |462| 
        BF        L5,TC                 ; |462| 
        ; branchcc occurs ; |462| 
...
;*** 444	-----------------------    if ( (g_fast_info[g_int32mark_cnt]).u16turn_dir&1u ) goto g21;
        MOVB      ACC,#42
        MOVW      DP,#_g_int32mark_cnt
        MOVL      XAR4,#_g_fast_info+40 ; |444| 
        MOVL      XT,ACC                ; |444| 
        IMPYL     ACC,XT,@_g_int32mark_cnt ; |444| 
        ADDL      XAR4,ACC
        TBIT      *+XAR4[0],#0          ; |444| 
        BF        L11,TC                ; |444| 
        ; branchcc occurs ; |444| 
...
DW$109	.dwtag  DW_TAG_loop
	.dwattr DW$109, DW_AT_name("C:\project\JP_Robotrace\main\sensor.asm:L29:1:1767860144")
...
DW$111	.dwtag  DW_TAG_loop
	.dwattr DW$111, DW_AT_name("C:\project\JP_Robotrace\main\sensor.asm:L24:1:1767860144")
...
DW$123	.dwtag  DW_TAG_loop
	.dwattr DW$123, DW_AT_name("C:\project\JP_Robotrace\main\sensor.asm:L25:2:1767860144")
...
DW$125	.dwtag  DW_TAG_loop
	.dwattr DW$125, DW_AT_name("C:\project\JP_Robotrace\main\sensor.asm:L21:2:1767860144")
...
DW$127	.dwtag  DW_TAG_loop
	.dwattr DW$127, DW_AT_name("C:\project\JP_Robotrace\main\sensor.asm:L19:1:1767860144")
...
DW$137	.dwtag  DW_TAG_variable, DW_AT_name("v$1"), DW_AT_symbol_name("v$1")
	...
	.dwpsn	"sensor.c",694,2
        ...
        BF        L34,NEQ               ; |694| 
        ; branchcc occurs ; |694| 
;*** 753	-----------------------    if ( !((*p_mark).u16mark_enable&g_pos.u16state) ) goto g11;
	.dwpsn	"sensor.c",753,2
        ...
        BF        L33,EQ                ; |753| 
        ; branchcc occurs ; |753| 
;*** 755	-----------------------    if ( !(*p_mark).u16turn_flag ) goto g10;
	.dwpsn	"sensor.c",755,3
        MOVB      XAR0,#9               ; |755| 
        MOV       AL,*+XAR4[AR0]        ; |755| 
        BF        L32,EQ                ; |755| 
        ; branchcc occurs ; |755| 
;*** 760	-----------------------    if ( (*p_mark).q7turn_dis < (*p_mark).q7dist_limit ) goto g29;
	.dwpsn	"sensor.c",760,8
        MOVL      ACC,*+XAR4[4]         ; |760| 
        CMPL      ACC,*+XAR4[0]         ; |760| 
        BF        L41,GT                ; |760| 
        ; branchcc occurs ; |760| 
;*** 762	-----------------------    (*p_mark).q7dist_limit = (*p_mark).q7turn_dis+(g_q17turnmark_dist>>10);
;*** 763	-----------------------    (*p_mark).u16single_flag = 1u;
;*** 765	-----------------------    C$1 = &g_Flag;
;*** 765	-----------------------    if ( *C$1&0x10u ) goto g29;
	.dwpsn	"sensor.c",762,4
        MOVW      DP,#_g_q17turnmark_dist
        SETC      SXM
        MOVL      ACC,@_g_q17turnmark_dist ; |762| 
        SFR       ACC,10                ; |762| 
        ADDL      ACC,*+XAR4[0]         ; |762| 
        MOVL      *+XAR4[4],ACC         ; |762| 
	.dwpsn	"sensor.c",763,4
        MOV       *+XAR4[7],#1          ; |763| 
	.dwpsn	"sensor.c",765,4
        MOVL      XAR5,#_g_Flag         ; |765| 
        TBIT      *+XAR5[0],#4          ; |765| 
        BF        L41,TC                ; |765| 
        ; branchcc occurs ; |765| 
;*** 767	-----------------------    C$2 = g_ptr;
;*** 767	-----------------------    if ( p_mark == (*C$2).g_lmark ) goto g9;
	.dwpsn	"sensor.c",767,5
        MOVW      DP,#_g_ptr
        MOVL      XAR6,@_g_ptr          ; |767| 
        MOVL      ACC,*+XAR6[0]         ; |767| 
        CMPL      ACC,XAR4              ; |767| 
        BF        L31,EQ                ; |767| 
        ; branchcc occurs ; |767| 
;*** 773	-----------------------    if ( p_mark != (*C$2).g_rmark ) goto g29;
	.dwpsn	"sensor.c",773,10
        MOVL      ACC,*+XAR6[2]         ; |773| 
        CMPL      ACC,XAR4              ; |773| 
        BF        L41,NEQ               ; |773| 
        ; branchcc occurs ; |773| 
;*** 775	-----------------------    *(&GpioDataRegs+3L) |= 0x800u;
;*** 776	-----------------------    C$1[1] |= 1u;
;*** 776	-----------------------    goto g29;
	.dwpsn	"sensor.c",775,21
        MOVW      DP,#_GpioDataRegs+3
        OR        @_GpioDataRegs+3,#0x0800 ; |775| 
	.dwpsn	"sensor.c",776,21
        OR        *+XAR5[1],#0x0001     ; |776| 
        BF        L41,UNC               ; |776| 
        ; branch occurs ; |776| 
L31:    
;***	-----------------------g9:
;*** 770	-----------------------    *(&GpioDataRegs+3L) |= 0x800u;
;*** 771	-----------------------    *&g_Flag |= 0x8000u;
;*** 772	-----------------------    goto g29;
	.dwpsn	"sensor.c",770,21
        MOVW      DP,#_GpioDataRegs+3
        OR        @_GpioDataRegs+3,#0x0800 ; |770| 
	.dwpsn	"sensor.c",771,21
        MOVW      DP,#_g_Flag
        OR        @_g_Flag,#0x8000      ; |771| 
	.dwpsn	"sensor.c",772,5
        BF        L41,UNC               ; |772| 
        ; branch occurs ; |772| 
L32:    
;***	-----------------------g10:
;*** 757	-----------------------    (*p_mark).q7dist_limit = (*p_mark).q7turn_dis+turn_step;
;*** 758	-----------------------    (*p_mark).u16turn_flag = 1u;
;*** 759	-----------------------    goto g29;
	.dwpsn	"sensor.c",757,4
        MOVW      DP,#_turn_step
        MOVL      ACC,@_turn_step       ; |757| 
        ADDL      ACC,*+XAR4[0]         ; |757| 
        MOVL      *+XAR4[4],ACC         ; |757| 
...
L33:    
;***	-----------------------g11:
;*** 786	-----------------------    (*p_mark).u16turn_flag = 0u;
;*** 787	-----------------------    (*p_mark).q7turn_dis = 0L;
;*** 787	-----------------------    goto g29;
	.dwpsn	"sensor.c",786,3
        MOVB      XAR0,#9               ; |786| 
        MOV       *+XAR4[AR0],#0        ; |786| 
...
;*** 696	-----------------------    if ( (*p_mark).q7turn_dis > (*p_mark).q7dist_limit ) goto g15;
	.dwpsn	"sensor.c",696,3
        ...
        BF        L35,LT                ; |696| 
        ; branchcc occurs ; |696| 
;*** 744	-----------------------    if ( !(*p_remark).u16single_flag ) goto g29;
	.dwpsn	"sensor.c",744,8
        MOV       AL,*+XAR5[7]          ; |744| 
        BF        L41,EQ                ; |744| 
        ; branchcc occurs ; |744| 
;*** 744	-----------------------    (*p_mark).u16cross_flag = 1u;
;*** 744	-----------------------    goto g29;
	.dwpsn	"sensor.c",744,39
        MOVB      XAR0,#8               ; |744| 
        MOV       *+XAR4[AR0],#1        ; |744| 
        BF        L41,UNC               ; |744| 
        ; branch occurs ; |744| 
...
;*** 702	-----------------------    if ( (*p_remark).u16single_flag ) goto g29;
...
;*** 715	-----------------------    if ( (*p_mark).u16cross_flag ) goto g26;
	...
	.dwpsn	"sensor.c",715,4
        ...
        BF        L40,NEQ               ; |715| 
        ; branchcc occurs ; |715| 
;*** 731	-----------------------    if ( !(*&g_Flag&4u) ) goto g29;
	.dwpsn	"sensor.c",731,5
        MOVW      DP,#_g_Flag
        TBIT      @_g_Flag,#2           ; |731| 
        BF        L41,NTC               ; |731| 
        ; branchcc occurs ; |731| 
;*** 733	-----------------------    if ( p_mark != (*v$1).g_lmark ) goto g25;
	.dwpsn	"sensor.c",733,17
        MOVL      ACC,*+XAR6[0]         ; |733| 
        CMPL      ACC,XAR4              ; |733| 
        BF        L39,NEQ               ; |733| 
        ; branchcc occurs ; |733| 
;*** 735	-----------------------    if ( *&g_Flag&0x800u ) goto g24;
	.dwpsn	"sensor.c",735,9
        TBIT      @_g_Flag,#11          ; |735| 
        BF        L38,TC                ; |735| 
        ; branchcc occurs ; |735| 
;*** 735	-----------------------    line_info(p_mark);
;*** 735	-----------------------    goto g29;
	.dwpsn	"sensor.c",735,32
        LCR       #_line_info           ; |735| 
        ; call occurs [#_line_info] ; |735| 
        BF        L41,UNC               ; |735| 
        ; branch occurs ; |735| 
L38:    
;***	-----------------------g24:
;*** 736	-----------------------    second_infor((*v$1).pfastinfo, (*v$1).perr);
;*** 736	-----------------------    goto g29;
	.dwpsn	"sensor.c",736,19
        MOVL      XAR4,*+XAR6[4]        ; |736| 
        MOVL      XAR5,*+XAR6[6]        ; |736| 
        LCR       #_second_infor        ; |736| 
        ; call occurs [#_second_infor] ; |736| 
        BF        L41,UNC               ; |736| 
        ; branch occurs ; |736| 
L39:    
;***	-----------------------g25:
;*** 739	-----------------------    start_end_check();
;*** 739	-----------------------    goto g29;
	.dwpsn	"sensor.c",739,46
        LCR       #_start_end_check     ; |739| 
        ; call occurs [#_start_end_check] ; |739| 
        BF        L41,UNC               ; |739| 
        ; branch occurs ; |739| 
L40:    
;***	-----------------------g26:
;*** 717	-----------------------    (*p_mark).u16cross_flag = 0u;
;*** 718	-----------------------    if ( p_mark != (*v$1).g_rmark ) goto g29;
...
L41:    
	...
	.dwattr DW$130, DW_AT_end_line(0x316)
...
;*** 543	-----------------------    if ( (*U$39).q17str_cross ) goto g18;
	.dwpsn	"sensor.c",543,5
        ...
        MOVL      XT,ACC                ; |543| 
        IMPYL     ACC,XT,@_g_int32mark_cnt ; |543| 
        ADDL      XAR4,ACC
        MOVB      XAR0,#32              ; |543| 
...
DW$152	.dwtag  DW_TAG_subprogram, DW_AT_name("print_pos"), DW_AT_symbol_name("_print_pos")
	...
	.dwattr DW$152, DW_AT_begin_line(0x3a4)
...
_print_pos:
;*** 934	-----------------------    VFDPrintf("        ");
;*** 935	-----------------------    handle_ad_make(g_q16out_corner_fast_limit, g_q16in_corner_fast_limit);
;***  	-----------------------    #pragma LOOP_FLAGS(5120u)
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
	...
	.dwpsn	"sensor.c",934,2
        ...
        MOVL      *-SP[2],XAR4          ; |934| 
        LCR       #_VFDPrintf           ; |934| 
        ; call occurs [#_VFDPrintf] ; |934| 
	.dwpsn	"sensor.c",935,2
        MOVW      DP,#_g_q16in_corner_fast_limit
        MOVL      ACC,@_g_q16in_corner_fast_limit ; |935| 
        MOVW      DP,#_g_q16out_corner_fast_limit
        MOVL      *-SP[2],ACC           ; |935| 
        MOVL      ACC,@_g_q16out_corner_fast_limit ; |935| 
        LCR       #_handle_ad_make      ; |935| 
        ; call occurs [#_handle_ad_make] ; |935| 
L65:    
DW$L$_print_pos$2$B:
;***	-----------------------g2:
;*** 938	-----------------------    make_position();
;*** 939	-----------------------    TxPrintf("position : %5ld|pos_pid_out : %.6f| left_handle : %.6f| right_handle : %.6f| pos_cnt: %d|  %#x|\n", g_pos.iq7temp_pos>>7, _IQ7toF(g_pos.iq7pid_out), _IQ17toF(g_q17left_handle), _IQ17toF(g_q17right_handle), g_u16pos_cnt, g_u16sen_enable);
;*** 940	-----------------------    VFDPrintf("P:%6ld", g_pos.iq7temp_pos>>7);
;*** 942	-----------------------    if ( *(&GpioDataRegs+8L)&4u ) goto g2;
	.dwpsn	"sensor.c",938,3
        LCR       #_make_position       ; |938| 
        ; call occurs [#_make_position] ; |938| 
	.dwpsn	"sensor.c",939,3
        MOVW      DP,#_g_pos+30
        MOVL      ACC,@_g_pos+30        ; |939| 
        LCR       #__IQ7toF             ; |939| 
        ; call occurs [#__IQ7toF] ; |939| 
        MOVW      DP,#_g_q17left_handle
        MOVL      XAR2,ACC              ; |939| 
        MOVL      ACC,@_g_q17left_handle ; |939| 
        LCR       #__IQ17toF            ; |939| 
        ; call occurs [#__IQ17toF] ; |939| 
        MOVW      DP,#_g_q17right_handle
        MOVL      XAR1,ACC              ; |939| 
        MOVL      ACC,@_g_q17right_handle ; |939| 
        LCR       #__IQ17toF            ; |939| 
        ; call occurs [#__IQ17toF] ; |939| 
        MOVW      DP,#_g_pos+10
        MOVL      XAR6,ACC              ; |939| 
        ...
        MOVW      DP,#_g_u16pos_cnt
        MOVL      *-SP[8],XAR1          ; |939| 
        MOV       AL,@_g_u16pos_cnt     ; |939| 
        MOVL      *-SP[10],XAR6         ; |939| 
        MOVW      DP,#_g_u16sen_enable
        MOV       *-SP[11],AL           ; |939| 
        MOV       AL,@_g_u16sen_enable  ; |939| 
        MOV       *-SP[12],AL           ; |939| 
        LCR       #_TxPrintf            ; |939| 
        ; call occurs [#_TxPrintf] ; |939| 
	.dwpsn	"sensor.c",940,3
        MOVW      DP,#_g_pos+10
        MOVL      XAR4,#FSL7            ; |940| 
        SETC      SXM
        MOVL      ACC,@_g_pos+10        ; |940| 
        MOVL      *-SP[2],XAR4          ; |940| 
        SFR       ACC,7                 ; |940| 
        MOVL      *-SP[4],ACC           ; |940| 
        LCR       #_VFDPrintf           ; |940| 
        ; call occurs [#_VFDPrintf] ; |940| 
	.dwpsn	"sensor.c",942,3
        MOVW      DP,#_GpioDataRegs+8
        TBIT      @_GpioDataRegs+8,#2   ; |942| 
        BF        L65,TC                ; |942| 
        ; branchcc occurs ; |942| 
DW$L$_print_pos$2$E:
...
DW$153	.dwtag  DW_TAG_loop
	.dwattr DW$153, DW_AT_name("C:\project\JP_Robotrace\main\sensor.asm:L65:1:1767860144")
	.dwattr DW$153, DW_AT_begin_file("sensor.c")
	.dwattr DW$153, DW_AT_begin_line(0x3a8)
	.dwattr DW$153, DW_AT_end_line(0x3b3)
DW$154	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$152, DW_AT_end_line(0x3b4)
...
DW$155	.dwtag  DW_TAG_subprogram, DW_AT_name("print_maxmin"), DW_AT_symbol_name("_print_maxmin")
	...
	.dwattr DW$155, DW_AT_begin_line(0x3b6)
	.dwattr DW$155, DW_AT_begin_column(0x06)
	.dwpsn	"sensor.c",951,1
...
;***  	-----------------------    return;
	.dwpsn	"sensor.c",955,4
        ...
        MOVL      *-SP[8],ACC           ; |955| 
        LCR       #_TxPrintf            ; |955| 
        ; call occurs [#_TxPrintf] ; |955| 
	.dwpsn	"sensor.c",953,23
        MOVB      XAR4,#18              ; |953| 
        MOVL      ACC,XAR2              ; |953| 
        ADDU      ACC,AR4               ; |953| 
        MOVL      XAR2,ACC              ; |953| 
...
DW$158	.dwtag  DW_TAG_loop
	.dwattr DW$158, DW_AT_name("C:\project\JP_Robotrace\main\sensor.asm:L66:1:1767860144")
	.dwattr DW$158, DW_AT_begin_file("sensor.c")
	.dwattr DW$158, DW_AT_begin_line(0x3b9)
	.dwattr DW$158, DW_AT_end_line(0x3bc)
DW$159	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$155, DW_AT_end_line(0x3bd)
...
DW$168	.dwtag  DW_TAG_subprogram, DW_AT_name("Set_Max_Min"), DW_AT_symbol_name("_Set_Max_Min")
	...
	.dwattr DW$168, DW_AT_begin_line(0x31b)
...
_Set_Max_Min:
;*** 800	-----------------------    sen_vari_init();
;*** 801	-----------------------    VFDPrintf("LOADING_");
;*** 802	-----------------------    DSP28x_usDelay(1999998uL);
;*** 803	-----------------------    VFDPrintf("SET_MAX_");
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
;***  	-----------------------    K$8 = &g_sen[0];
;*** 798	-----------------------    sensor_channel = 0;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
        MOVL      *SP++,XAR2
...
DW$177	.dwtag  DW_TAG_variable, DW_AT_name("sensor_channel"), DW_AT_symbol_name("_sensor_channel")
	...
	.dwpsn	"sensor.c",800,2
        LCR       #_sen_vari_init       ; |800| 
        ; call occurs [#_sen_vari_init] ; |800| 
	...
	.dwpsn	"sensor.c",803,2
        ...
        MOVL      XAR3,#_g_sen
	.dwpsn	"sensor.c",798,8
        MOVB      XAR6,#0
L74:    
DW$L$_Set_Max_Min$2$B:
;***	-----------------------g2:
;*** 807	-----------------------    C$2 = &K$8[(long)sensor_channel];
;*** 807	-----------------------    if ( (*C$2).iq17result <= (*C$2).iq17max_value ) goto g4;
...
;*** 807	-----------------------    (*C$2).iq17max_value = (*C$2).iq17result;
	.dwpsn	"sensor.c",807,85
        MOVL      ACC,*+XAR4[0]         ; |807| 
        MOVL      *+XAR4[4],ACC         ; |807| 
...
;***	-----------------------g4:
;*** 809	-----------------------    if ( (++sensor_channel) < 16 ) goto g6;
...
;*** 811	-----------------------    sensor_channel = 0;
	.dwpsn	"sensor.c",811,36
        MOVB      XAR6,#0
DW$L$_Set_Max_Min$5$E:
L76:    
DW$L$_Set_Max_Min$6$B:
;***	-----------------------g6:
;*** 814	-----------------------    if ( *(&GpioDataRegs+8L)&4u ) goto g2;
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
	.dwpsn	"sensor.c",814,3
        MOVW      DP,#_GpioDataRegs+8
        TBIT      @_GpioDataRegs+8,#2   ; |814| 
        BF        L74,TC                ; |814| 
        ; branchcc occurs ; |814| 
...
;***	-----------------------g8:
;*** 816	-----------------------    if ( !(*(&GpioDataRegs+8L)&4u) ) goto g8;
	.dwpsn	"sensor.c",816,4
        TBIT      @_GpioDataRegs+8,#2   ; |816| 
        BF        L77,NTC               ; |816| 
        ; branchcc occurs ; |816| 
DW$L$_Set_Max_Min$7$E:
;*** 817	-----------------------    Delay(50000uL);
;*** 822	-----------------------    VFDPrintf("LOADING_");
;*** 823	-----------------------    DSP28x_usDelay(1999998uL);
;*** 824	-----------------------    VFDPrintf("SET_MIN_");
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
;*** 818	-----------------------    sensor_channel = 0;
	.dwpsn	"sensor.c",817,4
        MOV       ACC,#3125 << 4
        LCR       #_Delay               ; |817| 
        ; call occurs [#_Delay] ; |817| 
	.dwpsn	"sensor.c",822,5
        MOVL      XAR4,#FSL9            ; |822| 
        MOVL      *-SP[2],XAR4          ; |822| 
        LCR       #_VFDPrintf           ; |822| 
        ; call occurs [#_VFDPrintf] ; |822| 
	.dwpsn	"sensor.c",823,2
        MOV       AL,#33918
        MOV       AH,#30
	...
	.dwpsn	"sensor.c",824,2
        ...
        MOVL      *-SP[2],XAR4          ; |824| 
        LCR       #_VFDPrintf           ; |824| 
        ; call occurs [#_VFDPrintf] ; |824| 
	.dwpsn	"sensor.c",818,4
        MOVB      XAR6,#0
L78:    
DW$L$_Set_Max_Min$9$B:
;***	-----------------------g10:
;*** 828	-----------------------    C$1 = &K$8[(long)sensor_channel];
;*** 828	-----------------------    if ( (*C$1).iq17result <= (*C$1).iq17min_value ) goto g12;
...
;*** 828	-----------------------    (*C$1).iq17min_value = (*C$1).iq17result;
	.dwpsn	"sensor.c",828,86
        MOVL      ACC,*+XAR4[0]         ; |828| 
        MOVL      *+XAR4[2],ACC         ; |828| 
...
;***	-----------------------g12:
;*** 831	-----------------------    if ( (++sensor_channel) < 16 ) goto g14;
...
;*** 833	-----------------------    sensor_channel = 0;
	.dwpsn	"sensor.c",833,36
        MOVB      XAR6,#0
DW$L$_Set_Max_Min$12$E:
L80:    
DW$L$_Set_Max_Min$13$B:
;***	-----------------------g14:
;*** 835	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g10;
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
	.dwpsn	"sensor.c",835,3
        MOVW      DP,#_GpioDataRegs+1
        TBIT      @_GpioDataRegs+1,#15  ; |835| 
        BF        L78,TC                ; |835| 
        ; branchcc occurs ; |835| 
...
;***	-----------------------g16:
;*** 837	-----------------------    if ( !(*(&GpioDataRegs+1)&0x8000u) ) goto g16;
	.dwpsn	"sensor.c",837,4
        TBIT      @_GpioDataRegs+1,#15  ; |837| 
        BF        L81,NTC               ; |837| 
        ; branchcc occurs ; |837| 
...
;***  	-----------------------    L$1 = 15;
	.dwpsn	"sensor.c",838,4
        MOV       ACC,#3125 << 4
        LCR       #_Delay               ; |838| 
        ; call occurs [#_Delay] ; |838| 
        MOVB      XAR6,#15
        MOVL      XAR4,XAR3
L82:    
DW$L$_Set_Max_Min$16$B:
;***	-----------------------g18:
;*** 846	-----------------------    (*U$9).iq17max_value -= __IQmpy((*U$9).iq17max_value, 39321L, 17);
;*** 847	-----------------------    (*U$9).iq17min_value += __IQmpy((*U$9).iq17min_value, 26214L, 17);
;*** 843	-----------------------    U$9 += 18;
;*** 843	-----------------------    if ( (--L$1) != (-1) ) goto g18;
	.dwpsn	"sensor.c",846,3
        MOVL      XAR5,#39321           ; |846| 
        MOVL      XT,*+XAR4[4]          ; |846| 
        IMPYL     P,XT,XAR5             ; |846| 
        QMPYL     ACC,XT,XAR5           ; |846| 
        LSL64     ACC:P,#15             ; |846| 
        SUBL      *+XAR4[4],ACC         ; |846| 
	.dwpsn	"sensor.c",847,3
        ...
        MOVL      XT,*+XAR4[2]          ; |847| 
        IMPYL     P,XT,XAR5             ; |847| 
        QMPYL     ACC,XT,XAR5           ; |847| 
        LSL64     ACC:P,#15             ; |847| 
        ADDL      *+XAR4[2],ACC         ; |847| 
	.dwpsn	"sensor.c",843,54
        MOVB      XAR5,#18              ; |843| 
        MOVL      ACC,XAR4              ; |843| 
        ADDU      ACC,AR5               ; |843| 
        MOVL      XAR4,ACC              ; |843| 
	.dwpsn	"sensor.c",843,27
        BANZ      L82,AR6--             ; |843| 
        ; branchcc occurs ; |843| 
...
;***	-----------------------g20:
;*** 853	-----------------------    (*U$29).iq17sub_value_inverse = _IQ17div(131072L, (*U$29).iq17max_value-(*U$29).iq17min_value);
;*** 855	-----------------------    (*U$29).iq17sub_value_inverse_127mpy = __IQmpy((*U$29).iq17sub_value_inverse, 16646144L, 17);
;*** 851	-----------------------    U$29 += 18;
;*** 851	-----------------------    if ( (--L$2) != (-1) ) goto g20;
	.dwpsn	"sensor.c",853,9
        ...
        MOV       AH,#2
        LCR       #__IQ17div            ; |853| 
        ; call occurs [#__IQ17div] ; |853| 
        MOVB      XAR0,#8               ; |853| 
        MOVL      *+XAR3[AR0],ACC       ; |853| 
	.dwpsn	"sensor.c",855,9
        MOV       AH,#254
        MOV       AL,#0
        MOVL      XT,*+XAR3[AR0]        ; |855| 
        IMPYL     P,XT,ACC              ; |855| 
        QMPYL     ACC,XT,ACC            ; |855| 
        MOVB      XAR0,#10              ; |855| 
        LSL64     ACC:P,#15             ; |855| 
        MOVL      *+XAR3[AR0],ACC       ; |855| 
	.dwpsn	"sensor.c",851,29
        MOVB      XAR4,#18              ; |851| 
        MOVL      ACC,XAR3              ; |851| 
        ADDU      ACC,AR4               ; |851| 
        MOVL      XAR3,ACC              ; |851| 
	.dwpsn	"sensor.c",851,19
        BANZ      L83,AR2--             ; |851| 
        ; branchcc occurs ; |851| 
DW$L$_Set_Max_Min$18$E:
;*** 857	-----------------------    print_maxmin();
;*** 858	-----------------------    maxmin_write_rom();
;*** 858	-----------------------    return;
	.dwpsn	"sensor.c",857,2
        LCR       #_print_maxmin        ; |857| 
        ; call occurs [#_print_maxmin] ; |857| 
	.dwpsn	"sensor.c",858,2
        LCR       #_maxmin_write_rom    ; |858| 
        ; call occurs [#_maxmin_write_rom] ; |858| 
...
DW$178	.dwtag  DW_TAG_loop
	.dwattr DW$178, DW_AT_name("C:\project\JP_Robotrace\main\sensor.asm:L83:1:1767860144")
	.dwattr DW$178, DW_AT_begin_file("sensor.c")
	.dwattr DW$178, DW_AT_begin_line(0x353)
	.dwattr DW$178, DW_AT_end_line(0x358)
...
DW$180	.dwtag  DW_TAG_loop
	.dwattr DW$180, DW_AT_name("C:\project\JP_Robotrace\main\sensor.asm:L82:1:1767860144")
	.dwattr DW$180, DW_AT_begin_file("sensor.c")
	.dwattr DW$180, DW_AT_begin_line(0x34b)
	.dwattr DW$180, DW_AT_end_line(0x352)
...
DW$182	.dwtag  DW_TAG_loop
	.dwattr DW$182, DW_AT_name("C:\project\JP_Robotrace\main\sensor.asm:L81:1:1767860144")
	.dwattr DW$182, DW_AT_begin_file("sensor.c")
	.dwattr DW$182, DW_AT_begin_line(0x345)
	.dwattr DW$182, DW_AT_end_line(0x345)
...
DW$184	.dwtag  DW_TAG_loop
	.dwattr DW$184, DW_AT_name("C:\project\JP_Robotrace\main\sensor.asm:L78:1:1767860144")
	.dwattr DW$184, DW_AT_begin_file("sensor.c")
	.dwattr DW$184, DW_AT_begin_line(0x33a)
	.dwattr DW$184, DW_AT_end_line(0x349)
...
DW$190	.dwtag  DW_TAG_loop
	.dwattr DW$190, DW_AT_name("C:\project\JP_Robotrace\main\sensor.asm:L77:1:1767860144")
	.dwattr DW$190, DW_AT_begin_file("sensor.c")
	.dwattr DW$190, DW_AT_begin_line(0x330)
	.dwattr DW$190, DW_AT_end_line(0x330)
...
DW$192	.dwtag  DW_TAG_loop
	.dwattr DW$192, DW_AT_name("C:\project\JP_Robotrace\main\sensor.asm:L74:1:1767860144")
	.dwattr DW$192, DW_AT_begin_file("sensor.c")
	.dwattr DW$192, DW_AT_begin_line(0x325)
	.dwattr DW$192, DW_AT_end_line(0x334)
...
DW$197	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$168, DW_AT_end_line(0x35c)
...
DW$200	.dwtag  DW_TAG_subprogram, DW_AT_name("F_4095"), DW_AT_symbol_name("_F_4095")
	...
	.dwattr DW$200, DW_AT_begin_line(0x360)
...
DW$202	.dwtag  DW_TAG_variable, DW_AT_name("K$23"), DW_AT_symbol_name("K$23")
	...
	.dwpsn	"sensor.c",867,2
        MOVL      XAR4,#FSL12           ; |867| 
        MOVL      *-SP[2],XAR4          ; |867| 
        LCR       #_TxPrintf            ; |867| 
        ; call occurs [#_TxPrintf] ; |867| 
	.dwpsn	"sensor.c",868,5
        LCR       #_print_maxmin        ; |868| 
        ; call occurs [#_print_maxmin] ; |868| 
	.dwpsn	"sensor.c",869,2
        ...
        MOVL      XAR3,#_g_sen
	.dwpsn	"sensor.c",866,6
        MOVB      XAR1,#0
L84:    
DW$L$_F_4095$2$B:
;***	-----------------------g2:
;*** 873	-----------------------    if ( !(*(&GpioDataRegs+8L)&4u) ) goto g5;
	.dwpsn	"sensor.c",873,3
        MOVW      DP,#_GpioDataRegs+8
        TBIT      @_GpioDataRegs+8,#2   ; |873| 
        BF        L85,NTC               ; |873| 
        ; branchcc occurs ; |873| 
DW$L$_F_4095$2$E:
DW$L$_F_4095$3$B:
;*** 877	-----------------------    if ( *(&GpioDataRegs+8L)&2u ) goto g6;
	.dwpsn	"sensor.c",877,8
        TBIT      @_GpioDataRegs+8,#1   ; |877| 
        BF        L86,TC                ; |877| 
        ; branchcc occurs ; |877| 
DW$L$_F_4095$3$E:
DW$L$_F_4095$4$B:
;*** 878	-----------------------    DSP28x_usDelay(2499998uL);
;*** 879	-----------------------    if ( (--Sen_Num) < 0 ) goto g8;
	.dwpsn	"sensor.c",878,4
        MOV       AL,#9630
        MOV       AH,#38
        LCR       #_DSP28x_usDelay      ; |878| 
        ; call occurs [#_DSP28x_usDelay] ; |878| 
	.dwpsn	"sensor.c",879,4
        MOV       AL,AR1
        ADDB      AL,#-1
        MOVZ      AR1,AL                ; |879| 
        BF        L87,LT                ; |879| 
...
;***	-----------------------g9:
;*** 883	-----------------------    Sen_Num = 15;
	.dwpsn	"sensor.c",883,18
        MOVB      XAR1,#15              ; |883| 
DW$L$_F_4095$10$E:
L89:    
DW$L$_F_4095$11$B:
;***	-----------------------g10:
;*** 887	-----------------------    VFDPrintf("S%2d:%4.0f", Sen_Num, _IQ17toF((K$23[(long)Sen_Num]).iq17result));
;*** 889	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g2;
	.dwpsn	"sensor.c",887,3
        ...
        MOVL      ACC,*+XAR4[0]         ; |887| 
        LCR       #__IQ17toF            ; |887| 
        ; call occurs [#__IQ17toF] ; |887| 
        MOVL      XAR4,#FSL13           ; |887| 
        MOVL      *-SP[2],XAR4          ; |887| 
        MOV       *-SP[3],AR1           ; |887| 
        MOVL      *-SP[6],ACC           ; |887| 
        LCR       #_VFDPrintf           ; |887| 
        ; call occurs [#_VFDPrintf] ; |887| 
	.dwpsn	"sensor.c",889,3
        MOVW      DP,#_GpioDataRegs+1
...
DW$203	.dwtag  DW_TAG_loop
	.dwattr DW$203, DW_AT_name("C:\project\JP_Robotrace\main\sensor.asm:L84:1:1767860144")
	.dwattr DW$203, DW_AT_begin_file("sensor.c")
	.dwattr DW$203, DW_AT_begin_line(0x366)
	.dwattr DW$203, DW_AT_end_line(0x37e)
...
DW$213	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$200, DW_AT_end_line(0x37f)
...
DW$214	.dwtag  DW_TAG_subprogram, DW_AT_name("F_127"), DW_AT_symbol_name("_F_127")
	...
	.dwattr DW$214, DW_AT_begin_line(0x381)
	.dwattr DW$214, DW_AT_begin_column(0x06)
	.dwpsn	"sensor.c",898,1
...
DW$L$_F_127$2$B:
;***	-----------------------g2:
;*** 907	-----------------------    if ( !(*(&GpioDataRegs+1)&0x4000u) ) goto g5;
...
DW$L$_F_127$2$E:
DW$L$_F_127$3$B:
;*** 911	-----------------------    if ( *(&GpioDataRegs+1)&0x8000u ) goto g6;
	.dwpsn	"sensor.c",911,8
        TBIT      @_GpioDataRegs+1,#15  ; |911| 
        BF        L92,TC                ; |911| 
        ; branchcc occurs ; |911| 
DW$L$_F_127$3$E:
DW$L$_F_127$4$B:
...
;***	-----------------------g9:
;*** 917	-----------------------    i = 15;
	.dwpsn	"sensor.c",917,12
        MOVB      XAR1,#15              ; |917| 
DW$L$_F_127$10$E:
L95:    
DW$L$_F_127$11$B:
;***	-----------------------g10:
;*** 920	-----------------------    VFDPrintf("S%2d:%4ld", i, (K$22[(long)i]).iq17data>>17);
;*** 922	-----------------------    if ( *(&GpioDataRegs+8L)&4u ) goto g2;
	.dwpsn	"sensor.c",920,3
        ...
        MOVL      *-SP[6],ACC           ; |920| 
        LCR       #_VFDPrintf           ; |920| 
        ; call occurs [#_VFDPrintf] ; |920| 
	.dwpsn	"sensor.c",922,3
        MOVW      DP,#_GpioDataRegs+8
        TBIT      @_GpioDataRegs+8,#2   ; |922| 
        BF        L90,TC                ; |922| 
        ; branchcc occurs ; |922| 
DW$L$_F_127$11$E:
...
;*** 929	-----------------------    return;
	...
	.dwpsn	"sensor.c",924,4
        LCR       #_print_pos           ; |924| 
        ; call occurs [#_print_pos] ; |924| 
	.dwpsn	"sensor.c",929,2
...
DW$217	.dwtag  DW_TAG_loop
	.dwattr DW$217, DW_AT_name("C:\project\JP_Robotrace\main\sensor.asm:L90:1:1767860144")
	.dwattr DW$217, DW_AT_begin_file("sensor.c")
	.dwattr DW$217, DW_AT_begin_line(0x386)
	.dwattr DW$217, DW_AT_end_line(0x39f)
...
DW$227	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$214, DW_AT_end_line(0x3a3)
...
DW$437	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$437, DW_AT_name("EPWM_SOCB_SEQ2"), DW_AT_symbol_name("_EPWM_SOCB_SEQ2")
...
DW$439	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$439, DW_AT_name("INT_MOD_SEQ2"), DW_AT_symbol_name("_INT_MOD_SEQ2")
...
DW$440	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$440, DW_AT_name("INT_ENA_SEQ2"), DW_AT_symbol_name("_INT_ENA_SEQ2")
...
DW$442	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$442, DW_AT_name("SOC_SEQ2"), DW_AT_symbol_name("_SOC_SEQ2")
...
DW$443	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$443, DW_AT_name("RST_SEQ2"), DW_AT_symbol_name("_RST_SEQ2")
...
DW$444	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$444, DW_AT_name("EXT_SOC_SEQ1"), DW_AT_symbol_name("_EXT_SOC_SEQ1")
...
DW$445	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$445, DW_AT_name("EPWM_SOCA_SEQ1"), DW_AT_symbol_name("_EPWM_SOCA_SEQ1")
...
DW$447	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$447, DW_AT_name("INT_MOD_SEQ1"), DW_AT_symbol_name("_INT_MOD_SEQ1")
...
DW$448	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$448, DW_AT_name("INT_ENA_SEQ1"), DW_AT_symbol_name("_INT_ENA_SEQ1")
...
DW$449	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$449, DW_AT_name("rsvd4"), DW_AT_symbol_name("_rsvd4")
...
DW$450	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$450, DW_AT_name("SOC_SEQ1"), DW_AT_symbol_name("_SOC_SEQ1")
...
DW$451	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$451, DW_AT_name("RST_SEQ1"), DW_AT_symbol_name("_RST_SEQ1")
...
DW$452	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$452, DW_AT_name("EPWM_SOCB_SEQ"), DW_AT_symbol_name("_EPWM_SOCB_SEQ")
...
DW$454	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$38)
...
DW$458	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$42)
...
DW$460	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$44)
...
DW$462	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$46)
...
DW$464	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$48)
...
DW$466	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$50)
...
DW$468	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$52)
...
DW$472	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$56)
...
DW$474	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$59)
...
DW$476	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$63)
...
DW$478	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$65)
...
DW$480	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$67)
...
DW$484	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$71)
...
DW$486	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$74)
...
DW$488	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$76)
...
DW$490	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$78)
...
DW$492	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$80)
...
DW$493	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$493, DW_AT_name("motor_start"), DW_AT_symbol_name("_motor_start")
...
DW$494	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$494, DW_AT_name("motor_ISR_flag"), DW_AT_symbol_name("_motor_ISR_flag")
...
DW$495	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$495, DW_AT_name("move_state"), DW_AT_symbol_name("_move_state")
...
DW$496	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$496, DW_AT_name("start_flag"), DW_AT_symbol_name("_start_flag")
...
DW$497	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$497, DW_AT_name("cross_flag"), DW_AT_symbol_name("_cross_flag")
...
DW$498	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$498, DW_AT_name("debug_flag"), DW_AT_symbol_name("_debug_flag")
...
DW$499	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$499, DW_AT_name("lineout_flag"), DW_AT_symbol_name("_lineout_flag")
...
DW$500	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$500, DW_AT_name("err"), DW_AT_symbol_name("_err")
...
DW$501	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$501, DW_AT_name("speed_up_start"), DW_AT_symbol_name("_speed_up_start")
...
DW$502	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$502, DW_AT_name("speed_up"), DW_AT_symbol_name("_speed_up")
...
DW$503	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$503, DW_AT_name("straight_run"), DW_AT_symbol_name("_straight_run")
...
DW$504	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$504, DW_AT_name("fast_flag"), DW_AT_symbol_name("_fast_flag")
...
DW$505	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$505, DW_AT_name("xrun_flag"), DW_AT_symbol_name("_xrun_flag")
...
DW$506	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$506, DW_AT_name("brun_flag"), DW_AT_symbol_name("_brun_flag")
...
DW$507	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$507, DW_AT_name("cross_shift"), DW_AT_symbol_name("_cross_shift")
...
DW$508	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$508, DW_AT_name("lmark_flag"), DW_AT_symbol_name("_lmark_flag")
...
DW$509	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$509, DW_AT_name("rmark_flag"), DW_AT_symbol_name("_rmark_flag")
...
DW$510	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$510, DW_AT_name("B45_flag"), DW_AT_symbol_name("_B45_flag")
...
DW$511	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$511, DW_AT_name("B90_flag"), DW_AT_symbol_name("_B90_flag")
...
DW$512	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$512, DW_AT_name("B180_flag"), DW_AT_symbol_name("_B180_flag")
...
DW$513	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$513, DW_AT_name("BLTURN_flag"), DW_AT_symbol_name("_BLTURN_flag")
...
DW$514	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$514, DW_AT_name("BALL_flag"), DW_AT_symbol_name("_BALL_flag")
...
DW$515	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$515, DW_AT_name("iq17result"), DW_AT_symbol_name("_iq17result")
	.dwattr DW$515, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$515, DW_AT_accessibility(DW_ACCESS_public)
DW$516	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$516, DW_AT_name("iq17min_value"), DW_AT_symbol_name("_iq17min_value")
	.dwattr DW$516, DW_AT_data_member_location[DW_OP_plus_uconst 0x2]
	.dwattr DW$516, DW_AT_accessibility(DW_ACCESS_public)
DW$517	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$517, DW_AT_name("iq17max_value"), DW_AT_symbol_name("_iq17max_value")
	.dwattr DW$517, DW_AT_data_member_location[DW_OP_plus_uconst 0x4]
	.dwattr DW$517, DW_AT_accessibility(DW_ACCESS_public)
DW$518	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$518, DW_AT_name("iq17data"), DW_AT_symbol_name("_iq17data")
	.dwattr DW$518, DW_AT_data_member_location[DW_OP_plus_uconst 0x6]
	.dwattr DW$518, DW_AT_accessibility(DW_ACCESS_public)
DW$519	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$519, DW_AT_name("iq17sub_value_inverse"), DW_AT_symbol_name("_iq17sub_value_inverse")
	.dwattr DW$519, DW_AT_data_member_location[DW_OP_plus_uconst 0x8]
	.dwattr DW$519, DW_AT_accessibility(DW_ACCESS_public)
DW$520	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$520, DW_AT_name("iq17sub_value_inverse_127mpy"), DW_AT_symbol_name("_iq17sub_value_inverse_127mpy")
	.dwattr DW$520, DW_AT_data_member_location[DW_OP_plus_uconst 0xa]
	.dwattr DW$520, DW_AT_accessibility(DW_ACCESS_public)
DW$521	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$19)
	.dwattr DW$521, DW_AT_name("iq7weight"), DW_AT_symbol_name("_iq7weight")
	.dwattr DW$521, DW_AT_data_member_location[DW_OP_plus_uconst 0xc]
	.dwattr DW$521, DW_AT_accessibility(DW_ACCESS_public)
DW$522	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$522, DW_AT_name("u16active_arr"), DW_AT_symbol_name("_u16active_arr")
	.dwattr DW$522, DW_AT_data_member_location[DW_OP_plus_uconst 0xe]
	.dwattr DW$522, DW_AT_accessibility(DW_ACCESS_public)
DW$523	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$523, DW_AT_name("u16passive_arr"), DW_AT_symbol_name("_u16passive_arr")
	.dwattr DW$523, DW_AT_data_member_location[DW_OP_plus_uconst 0xf]
	.dwattr DW$523, DW_AT_accessibility(DW_ACCESS_public)
DW$524	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$524, DW_AT_name("u16sensor"), DW_AT_symbol_name("_u16sensor")
...
DW$525	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$525, DW_AT_name("u16state"), DW_AT_symbol_name("_u16state")
	.dwattr DW$525, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$525, DW_AT_accessibility(DW_ACCESS_public)
DW$526	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$526, DW_AT_name("u16enable"), DW_AT_symbol_name("_u16enable")
	.dwattr DW$526, DW_AT_data_member_location[DW_OP_plus_uconst 0x1]
	.dwattr DW$526, DW_AT_accessibility(DW_ACCESS_public)
DW$527	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$85)
	.dwattr DW$527, DW_AT_name("iq17sum"), DW_AT_symbol_name("_iq17sum")
...
DW$532	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$86)
...
DW$543	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$543, DW_AT_name("u16cross_total_cnt"), DW_AT_symbol_name("_u16cross_total_cnt")
	.dwattr DW$543, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$543, DW_AT_accessibility(DW_ACCESS_public)
DW$544	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$544, DW_AT_name("u16cross_final_cnt"), DW_AT_symbol_name("_u16cross_final_cnt")
	.dwattr DW$544, DW_AT_data_member_location[DW_OP_plus_uconst 0x1]
	.dwattr DW$544, DW_AT_accessibility(DW_ACCESS_public)
DW$545	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$88)
	.dwattr DW$545, DW_AT_name("u16err_dist"), DW_AT_symbol_name("_u16err_dist")
...
DW$546	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$546, DW_AT_name("u16qep_sample"), DW_AT_symbol_name("_u16qep_sample")
	.dwattr DW$546, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$546, DW_AT_accessibility(DW_ACCESS_public)
DW$547	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$547, DW_AT_name("u16decel_flag"), DW_AT_symbol_name("_u16decel_flag")
	.dwattr DW$547, DW_AT_data_member_location[DW_OP_plus_uconst 0x1]
	.dwattr DW$547, DW_AT_accessibility(DW_ACCESS_public)
DW$548	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$58)
	.dwattr DW$548, DW_AT_name("int16qep_val"), DW_AT_symbol_name("_int16qep_val")
	.dwattr DW$548, DW_AT_data_member_location[DW_OP_plus_uconst 0x2]
	.dwattr DW$548, DW_AT_accessibility(DW_ACCESS_public)
DW$549	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$25)
	.dwattr DW$549, DW_AT_name("int32accel"), DW_AT_symbol_name("_int32accel")
	.dwattr DW$549, DW_AT_data_member_location[DW_OP_plus_uconst 0x4]
	.dwattr DW$549, DW_AT_accessibility(DW_ACCESS_public)
DW$550	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$25)
	.dwattr DW$550, DW_AT_name("int32decel"), DW_AT_symbol_name("_int32decel")
	.dwattr DW$550, DW_AT_data_member_location[DW_OP_plus_uconst 0x6]
	.dwattr DW$550, DW_AT_accessibility(DW_ACCESS_public)
DW$551	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$90)
	.dwattr DW$551, DW_AT_name("q27tick_dist"), DW_AT_symbol_name("_q27tick_dist")
	.dwattr DW$551, DW_AT_data_member_location[DW_OP_plus_uconst 0x8]
	.dwattr DW$551, DW_AT_accessibility(DW_ACCESS_public)
DW$552	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$552, DW_AT_name("q17pid_out"), DW_AT_symbol_name("_q17pid_out")
	.dwattr DW$552, DW_AT_data_member_location[DW_OP_plus_uconst 0xa]
	.dwattr DW$552, DW_AT_accessibility(DW_ACCESS_public)
DW$553	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$553, DW_AT_name("q17user_vel"), DW_AT_symbol_name("_q17user_vel")
	.dwattr DW$553, DW_AT_data_member_location[DW_OP_plus_uconst 0xc]
	.dwattr DW$553, DW_AT_accessibility(DW_ACCESS_public)
DW$554	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$554, DW_AT_name("q17decel_vel"), DW_AT_symbol_name("_q17decel_vel")
	.dwattr DW$554, DW_AT_data_member_location[DW_OP_plus_uconst 0xe]
	.dwattr DW$554, DW_AT_accessibility(DW_ACCESS_public)
DW$555	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$555, DW_AT_name("q17next_vel"), DW_AT_symbol_name("_q17next_vel")
	.dwattr DW$555, DW_AT_data_member_location[DW_OP_plus_uconst 0x10]
	.dwattr DW$555, DW_AT_accessibility(DW_ACCESS_public)
DW$556	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$556, DW_AT_name("q17next_acc"), DW_AT_symbol_name("_q17next_acc")
	.dwattr DW$556, DW_AT_data_member_location[DW_OP_plus_uconst 0x12]
	.dwattr DW$556, DW_AT_accessibility(DW_ACCESS_public)
DW$557	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$91)
	.dwattr DW$557, DW_AT_name("q17cur_vel"), DW_AT_symbol_name("_q17cur_vel")
	.dwattr DW$557, DW_AT_data_member_location[DW_OP_plus_uconst 0x14]
	.dwattr DW$557, DW_AT_accessibility(DW_ACCESS_public)
DW$558	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$558, DW_AT_name("q17cur_vel_avr"), DW_AT_symbol_name("_q17cur_vel_avr")
	.dwattr DW$558, DW_AT_data_member_location[DW_OP_plus_uconst 0x1c]
	.dwattr DW$558, DW_AT_accessibility(DW_ACCESS_public)
DW$559	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$91)
	.dwattr DW$559, DW_AT_name("q17err_vel"), DW_AT_symbol_name("_q17err_vel")
	.dwattr DW$559, DW_AT_data_member_location[DW_OP_plus_uconst 0x1e]
	.dwattr DW$559, DW_AT_accessibility(DW_ACCESS_public)
DW$560	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$560, DW_AT_name("q17err_vel_sum"), DW_AT_symbol_name("_q17err_vel_sum")
	.dwattr DW$560, DW_AT_data_member_location[DW_OP_plus_uconst 0x26]
	.dwattr DW$560, DW_AT_accessibility(DW_ACCESS_public)
DW$561	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$561, DW_AT_name("q17proportional"), DW_AT_symbol_name("_q17proportional")
	.dwattr DW$561, DW_AT_data_member_location[DW_OP_plus_uconst 0x28]
	.dwattr DW$561, DW_AT_accessibility(DW_ACCESS_public)
DW$562	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$562, DW_AT_name("q17integral"), DW_AT_symbol_name("_q17integral")
	.dwattr DW$562, DW_AT_data_member_location[DW_OP_plus_uconst 0x2a]
	.dwattr DW$562, DW_AT_accessibility(DW_ACCESS_public)
DW$563	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$563, DW_AT_name("q17derivative"), DW_AT_symbol_name("_q17derivative")
	.dwattr DW$563, DW_AT_data_member_location[DW_OP_plus_uconst 0x2c]
	.dwattr DW$563, DW_AT_accessibility(DW_ACCESS_public)
DW$564	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$564, DW_AT_name("q17err_dist"), DW_AT_symbol_name("_q17err_dist")
	.dwattr DW$564, DW_AT_data_member_location[DW_OP_plus_uconst 0x2e]
	.dwattr DW$564, DW_AT_accessibility(DW_ACCESS_public)
DW$565	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$565, DW_AT_name("q17total_dist"), DW_AT_symbol_name("_q17total_dist")
	.dwattr DW$565, DW_AT_data_member_location[DW_OP_plus_uconst 0x30]
	.dwattr DW$565, DW_AT_accessibility(DW_ACCESS_public)
DW$566	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$566, DW_AT_name("q17user_dist"), DW_AT_symbol_name("_q17user_dist")
	.dwattr DW$566, DW_AT_data_member_location[DW_OP_plus_uconst 0x32]
	.dwattr DW$566, DW_AT_accessibility(DW_ACCESS_public)
DW$567	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$567, DW_AT_name("q17decel_dist"), DW_AT_symbol_name("_q17decel_dist")
	.dwattr DW$567, DW_AT_data_member_location[DW_OP_plus_uconst 0x34]
	.dwattr DW$567, DW_AT_accessibility(DW_ACCESS_public)
DW$568	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$568, DW_AT_name("q17start_dist"), DW_AT_symbol_name("_q17start_dist")
	.dwattr DW$568, DW_AT_data_member_location[DW_OP_plus_uconst 0x36]
	.dwattr DW$568, DW_AT_accessibility(DW_ACCESS_public)
DW$569	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$569, DW_AT_name("q17start_dist_total"), DW_AT_symbol_name("_q17start_dist_total")
	.dwattr DW$569, DW_AT_data_member_location[DW_OP_plus_uconst 0x38]
	.dwattr DW$569, DW_AT_accessibility(DW_ACCESS_public)
DW$570	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$570, DW_AT_name("q17pid_result"), DW_AT_symbol_name("_q17pid_result")
	.dwattr DW$570, DW_AT_data_member_location[DW_OP_plus_uconst 0x3a]
	.dwattr DW$570, DW_AT_accessibility(DW_ACCESS_public)
DW$571	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$571, DW_AT_name("q17gone_distance"), DW_AT_symbol_name("_q17gone_distance")
	.dwattr DW$571, DW_AT_data_member_location[DW_OP_plus_uconst 0x3c]
	.dwattr DW$571, DW_AT_accessibility(DW_ACCESS_public)
DW$572	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$572, DW_AT_name("q17end_gone_distance"), DW_AT_symbol_name("_q17end_gone_distance")
	.dwattr DW$572, DW_AT_data_member_location[DW_OP_plus_uconst 0x3e]
	.dwattr DW$572, DW_AT_accessibility(DW_ACCESS_public)
DW$573	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$573, DW_AT_name("q17dist_sum"), DW_AT_symbol_name("_q17dist_sum")
	.dwattr DW$573, DW_AT_data_member_location[DW_OP_plus_uconst 0x40]
	.dwattr DW$573, DW_AT_accessibility(DW_ACCESS_public)
DW$574	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$574, DW_AT_name("q17get_dist"), DW_AT_symbol_name("_q17get_dist")
	.dwattr DW$574, DW_AT_data_member_location[DW_OP_plus_uconst 0x42]
	.dwattr DW$574, DW_AT_accessibility(DW_ACCESS_public)
DW$575	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$92)
	.dwattr DW$575, DW_AT_name("q28kp"), DW_AT_symbol_name("_q28kp")
	.dwattr DW$575, DW_AT_data_member_location[DW_OP_plus_uconst 0x44]
	.dwattr DW$575, DW_AT_accessibility(DW_ACCESS_public)
DW$576	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$92)
	.dwattr DW$576, DW_AT_name("q28ki"), DW_AT_symbol_name("_q28ki")
	.dwattr DW$576, DW_AT_data_member_location[DW_OP_plus_uconst 0x46]
	.dwattr DW$576, DW_AT_accessibility(DW_ACCESS_public)
DW$577	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$92)
	.dwattr DW$577, DW_AT_name("q28kd"), DW_AT_symbol_name("_q28kd")
	.dwattr DW$577, DW_AT_data_member_location[DW_OP_plus_uconst 0x48]
...
DW$578	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$96)
	.dwattr DW$578, DW_AT_name("g_lmark"), DW_AT_symbol_name("_g_lmark")
	.dwattr DW$578, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$578, DW_AT_accessibility(DW_ACCESS_public)
DW$579	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$96)
	.dwattr DW$579, DW_AT_name("g_rmark"), DW_AT_symbol_name("_g_rmark")
	.dwattr DW$579, DW_AT_data_member_location[DW_OP_plus_uconst 0x2]
	.dwattr DW$579, DW_AT_accessibility(DW_ACCESS_public)
DW$580	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$99)
	.dwattr DW$580, DW_AT_name("pfastinfo"), DW_AT_symbol_name("_pfastinfo")
	.dwattr DW$580, DW_AT_data_member_location[DW_OP_plus_uconst 0x4]
	.dwattr DW$580, DW_AT_accessibility(DW_ACCESS_public)
DW$581	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$102)
	.dwattr DW$581, DW_AT_name("perr"), DW_AT_symbol_name("_perr")
	.dwattr DW$581, DW_AT_data_member_location[DW_OP_plus_uconst 0x6]
	.dwattr DW$581, DW_AT_accessibility(DW_ACCESS_public)
DW$582	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$105)
	.dwattr DW$582, DW_AT_name("ppos"), DW_AT_symbol_name("_ppos")
	.dwattr DW$582, DW_AT_data_member_location[DW_OP_plus_uconst 0x8]
	.dwattr DW$582, DW_AT_accessibility(DW_ACCESS_public)
DW$583	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$108)
	.dwattr DW$583, DW_AT_name("psen"), DW_AT_symbol_name("_psen")
	.dwattr DW$583, DW_AT_data_member_location[DW_OP_plus_uconst 0xa]
...
DW$584	.dwtag  DW_TAG_subrange_type
	.dwattr DW$584, DW_AT_upper_bound(0xff)
	.dwendtag DW$T$88
...
DW$587	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$22)
	.dwattr DW$587, DW_AT_name("q17over_dist"), DW_AT_symbol_name("_q17over_dist")
	.dwattr DW$587, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$587, DW_AT_accessibility(DW_ACCESS_public)
DW$588	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$24)
	.dwattr DW$588, DW_AT_name("q17under_dist"), DW_AT_symbol_name("_q17under_dist")
	.dwattr DW$588, DW_AT_data_member_location[DW_OP_plus_uconst 0x2]
	.dwattr DW$588, DW_AT_accessibility(DW_ACCESS_public)
DW$589	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$24)
	.dwattr DW$589, DW_AT_name("q17err_dist"), DW_AT_symbol_name("_q17err_dist")
	.dwattr DW$589, DW_AT_data_member_location[DW_OP_plus_uconst 0x202]
	.dwattr DW$589, DW_AT_accessibility(DW_ACCESS_public)
DW$590	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$26)
	.dwattr DW$590, DW_AT_name("int32err_cnt"), DW_AT_symbol_name("_int32err_cnt")
	.dwattr DW$590, DW_AT_data_member_location[DW_OP_plus_uconst 0x402]
	.dwattr DW$590, DW_AT_accessibility(DW_ACCESS_public)
DW$591	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$26)
	.dwattr DW$591, DW_AT_name("int32load_err"), DW_AT_symbol_name("_int32load_err")
	.dwattr DW$591, DW_AT_data_member_location[DW_OP_plus_uconst 0x602]
	.dwattr DW$591, DW_AT_accessibility(DW_ACCESS_public)
DW$592	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$27)
	.dwattr DW$592, DW_AT_name("in32mark_val"), DW_AT_symbol_name("_in32mark_val")
	.dwattr DW$592, DW_AT_data_member_location[DW_OP_plus_uconst 0x802]
...
DW$593	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$593, DW_AT_name("GPIO32"), DW_AT_symbol_name("_GPIO32")
...
DW$594	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$594, DW_AT_name("GPIO33"), DW_AT_symbol_name("_GPIO33")
...
DW$595	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$595, DW_AT_name("GPIO34"), DW_AT_symbol_name("_GPIO34")
...
DW$598	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$598, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x10)
...
DW$600	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$600, DW_AT_name("SEQ_CASC"), DW_AT_symbol_name("_SEQ_CASC")
...
DW$601	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$601, DW_AT_name("SEQ_OVRD"), DW_AT_symbol_name("_SEQ_OVRD")
...
DW$602	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$602, DW_AT_name("CONT_RUN"), DW_AT_symbol_name("_CONT_RUN")
...
DW$603	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$603, DW_AT_name("CPS"), DW_AT_symbol_name("_CPS")
...
DW$604	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$604, DW_AT_name("ACQ_PS"), DW_AT_symbol_name("_ACQ_PS")
...
DW$605	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$605, DW_AT_name("SUSMOD"), DW_AT_symbol_name("_SUSMOD")
...
DW$606	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$606, DW_AT_name("RESET"), DW_AT_symbol_name("_RESET")
...
DW$608	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$608, DW_AT_name("MAX_CONV1"), DW_AT_symbol_name("_MAX_CONV1")
...
DW$609	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$609, DW_AT_name("MAX_CONV2"), DW_AT_symbol_name("_MAX_CONV2")
	.dwattr DW$609, DW_AT_bit_offset(0x09), DW_AT_bit_size(0x03)
...
DW$610	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$610, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x09)
...
DW$611	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$611, DW_AT_name("CONV00"), DW_AT_symbol_name("_CONV00")
...
DW$612	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$612, DW_AT_name("CONV01"), DW_AT_symbol_name("_CONV01")
...
DW$613	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$613, DW_AT_name("CONV02"), DW_AT_symbol_name("_CONV02")
...
DW$614	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$614, DW_AT_name("CONV03"), DW_AT_symbol_name("_CONV03")
...
DW$615	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$615, DW_AT_name("CONV04"), DW_AT_symbol_name("_CONV04")
...
DW$616	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$616, DW_AT_name("CONV05"), DW_AT_symbol_name("_CONV05")
	.dwattr DW$616, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x04)
	.dwattr DW$616, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$616, DW_AT_accessibility(DW_ACCESS_public)
DW$617	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$617, DW_AT_name("CONV06"), DW_AT_symbol_name("_CONV06")
...
DW$618	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$618, DW_AT_name("CONV07"), DW_AT_symbol_name("_CONV07")
...
DW$619	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$619, DW_AT_name("CONV08"), DW_AT_symbol_name("_CONV08")
...
DW$620	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$620, DW_AT_name("CONV09"), DW_AT_symbol_name("_CONV09")
...
DW$621	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$621, DW_AT_name("CONV10"), DW_AT_symbol_name("_CONV10")
	.dwattr DW$621, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x04)
	.dwattr DW$621, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$621, DW_AT_accessibility(DW_ACCESS_public)
DW$622	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$622, DW_AT_name("CONV11"), DW_AT_symbol_name("_CONV11")
...
DW$623	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$623, DW_AT_name("CONV12"), DW_AT_symbol_name("_CONV12")
	.dwattr DW$623, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x04)
	.dwattr DW$623, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$623, DW_AT_accessibility(DW_ACCESS_public)
DW$624	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$624, DW_AT_name("CONV13"), DW_AT_symbol_name("_CONV13")
...
DW$625	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$625, DW_AT_name("CONV14"), DW_AT_symbol_name("_CONV14")
...
DW$626	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$626, DW_AT_name("CONV15"), DW_AT_symbol_name("_CONV15")
...
DW$627	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$627, DW_AT_name("SEQ1_STATE"), DW_AT_symbol_name("_SEQ1_STATE")
	.dwattr DW$627, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x04)
	.dwattr DW$627, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr DW$627, DW_AT_accessibility(DW_ACCESS_public)
DW$628	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$628, DW_AT_name("SEQ2_STATE"), DW_AT_symbol_name("_SEQ2_STATE")
	.dwattr DW$628, DW_AT_bit_offset(0x09), DW_AT_bit_size(0x03)
...
DW$630	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$630, DW_AT_name("SEQ_CNTR"), DW_AT_symbol_name("_SEQ_CNTR")
	.dwattr DW$630, DW_AT_bit_offset(0x04), DW_AT_bit_size(0x04)
...
DW$632	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$632, DW_AT_name("SMODE_SEL"), DW_AT_symbol_name("_SMODE_SEL")
...
DW$633	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$633, DW_AT_name("ADCCLKPS"), DW_AT_symbol_name("_ADCCLKPS")
	.dwattr DW$633, DW_AT_bit_offset(0x0b), DW_AT_bit_size(0x04)
...
DW$634	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$634, DW_AT_name("ADCPWDN"), DW_AT_symbol_name("_ADCPWDN")
...
DW$635	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$635, DW_AT_name("ADCBGRFDN"), DW_AT_symbol_name("_ADCBGRFDN")
...
DW$637	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$637, DW_AT_name("INT_SEQ1"), DW_AT_symbol_name("_INT_SEQ1")
...
DW$638	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$638, DW_AT_name("INT_SEQ2"), DW_AT_symbol_name("_INT_SEQ2")
...
DW$639	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$639, DW_AT_name("SEQ1_BSY"), DW_AT_symbol_name("_SEQ1_BSY")
...
DW$640	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$640, DW_AT_name("SEQ2_BSY"), DW_AT_symbol_name("_SEQ2_BSY")
...
DW$641	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$641, DW_AT_name("INT_SEQ1_CLR"), DW_AT_symbol_name("_INT_SEQ1_CLR")
...
DW$642	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$642, DW_AT_name("INT_SEQ2_CLR"), DW_AT_symbol_name("_INT_SEQ2_CLR")
...
DW$643	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$643, DW_AT_name("EOS_BUF1"), DW_AT_symbol_name("_EOS_BUF1")
...
DW$644	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$644, DW_AT_name("EOS_BUF2"), DW_AT_symbol_name("_EOS_BUF2")
...
DW$646	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$646, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x0e)
...
DW$647	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$647, DW_AT_name("REF_SEL"), DW_AT_symbol_name("_REF_SEL")
	.dwattr DW$647, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x02)
...
DW$648	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$58)
	.dwattr DW$648, DW_AT_name("OFFSET_TRIM"), DW_AT_symbol_name("_OFFSET_TRIM")
	.dwattr DW$648, DW_AT_bit_offset(0x07), DW_AT_bit_size(0x09)
...
DW$649	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$649, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x07)
...
DW$650	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$650, DW_AT_name("LSW"), DW_AT_symbol_name("_LSW")
...
DW$651	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$651, DW_AT_name("MSW"), DW_AT_symbol_name("_MSW")
...
DW$654	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$654, DW_AT_bit_offset(0x0c), DW_AT_bit_size(0x04)
...
DW$655	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$655, DW_AT_name("TSS"), DW_AT_symbol_name("_TSS")
...
DW$656	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$656, DW_AT_name("TRB"), DW_AT_symbol_name("_TRB")
...
DW$657	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$657, DW_AT_bit_offset(0x06), DW_AT_bit_size(0x04)
...
DW$658	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$658, DW_AT_name("SOFT"), DW_AT_symbol_name("_SOFT")
...
DW$659	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$659, DW_AT_name("FREE"), DW_AT_symbol_name("_FREE")
...
DW$660	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$660, DW_AT_name("rsvd3"), DW_AT_symbol_name("_rsvd3")
	.dwattr DW$660, DW_AT_bit_offset(0x02), DW_AT_bit_size(0x02)
...
DW$661	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$661, DW_AT_name("TIE"), DW_AT_symbol_name("_TIE")
	.dwattr DW$661, DW_AT_bit_offset(0x01), DW_AT_bit_size(0x01)
...
DW$662	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$662, DW_AT_name("TIF"), DW_AT_symbol_name("_TIF")
	.dwattr DW$662, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x01)
...
DW$663	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$663, DW_AT_name("TDDR"), DW_AT_symbol_name("_TDDR")
	.dwattr DW$663, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x08)
...
DW$664	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$664, DW_AT_name("PSC"), DW_AT_symbol_name("_PSC")
	.dwattr DW$664, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x08)
...
DW$665	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$665, DW_AT_name("TDDRH"), DW_AT_symbol_name("_TDDRH")
...
DW$666	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$666, DW_AT_name("PSCH"), DW_AT_symbol_name("_PSCH")
...
DW$667	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$667, DW_AT_name("ENPIE"), DW_AT_symbol_name("_ENPIE")
...
DW$668	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$668, DW_AT_name("PIEVECT"), DW_AT_symbol_name("_PIEVECT")
	.dwattr DW$668, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x0f)
...
DW$669	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$669, DW_AT_name("ACK1"), DW_AT_symbol_name("_ACK1")
...
DW$670	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$670, DW_AT_name("ACK2"), DW_AT_symbol_name("_ACK2")
...
DW$671	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$671, DW_AT_name("ACK3"), DW_AT_symbol_name("_ACK3")
...
DW$672	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$672, DW_AT_name("ACK4"), DW_AT_symbol_name("_ACK4")
...
DW$673	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$673, DW_AT_name("ACK5"), DW_AT_symbol_name("_ACK5")
...
DW$674	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$674, DW_AT_name("ACK6"), DW_AT_symbol_name("_ACK6")
...
DW$675	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$675, DW_AT_name("ACK7"), DW_AT_symbol_name("_ACK7")
...
DW$676	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$676, DW_AT_name("ACK8"), DW_AT_symbol_name("_ACK8")
...
DW$677	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$677, DW_AT_name("ACK9"), DW_AT_symbol_name("_ACK9")
...
DW$678	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$678, DW_AT_name("ACK10"), DW_AT_symbol_name("_ACK10")
...
DW$679	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$679, DW_AT_name("ACK11"), DW_AT_symbol_name("_ACK11")
...
DW$680	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$680, DW_AT_name("ACK12"), DW_AT_symbol_name("_ACK12")
...
DW$681	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$681, DW_AT_name("rsvd"), DW_AT_symbol_name("_rsvd")
	.dwattr DW$681, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x04)
...
DW$682	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$682, DW_AT_name("INTx1"), DW_AT_symbol_name("_INTx1")
...
DW$683	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$683, DW_AT_name("INTx2"), DW_AT_symbol_name("_INTx2")
...
DW$684	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$684, DW_AT_name("INTx3"), DW_AT_symbol_name("_INTx3")
...
DW$685	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$685, DW_AT_name("INTx4"), DW_AT_symbol_name("_INTx4")
...
DW$686	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$686, DW_AT_name("INTx5"), DW_AT_symbol_name("_INTx5")
	.dwattr DW$686, DW_AT_bit_offset(0x0b), DW_AT_bit_size(0x01)
...
DW$687	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$687, DW_AT_name("INTx6"), DW_AT_symbol_name("_INTx6")
	.dwattr DW$687, DW_AT_bit_offset(0x0a), DW_AT_bit_size(0x01)
...
DW$688	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$688, DW_AT_name("INTx7"), DW_AT_symbol_name("_INTx7")
	.dwattr DW$688, DW_AT_bit_offset(0x09), DW_AT_bit_size(0x01)
...
DW$689	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$689, DW_AT_name("INTx8"), DW_AT_symbol_name("_INTx8")
	.dwattr DW$689, DW_AT_bit_offset(0x08), DW_AT_bit_size(0x01)
...
DW$690	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	...
	.dwattr DW$690, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x08)
...
DW$691	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$691, DW_AT_name("INTx1"), DW_AT_symbol_name("_INTx1")
...
DW$692	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$692, DW_AT_name("INTx2"), DW_AT_symbol_name("_INTx2")
...
DW$693	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$693, DW_AT_name("INTx3"), DW_AT_symbol_name("_INTx3")
...
DW$694	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$694, DW_AT_name("INTx4"), DW_AT_symbol_name("_INTx4")
...
DW$695	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$695, DW_AT_name("INTx5"), DW_AT_symbol_name("_INTx5")
...
DW$696	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$696, DW_AT_name("INTx6"), DW_AT_symbol_name("_INTx6")
...
DW$697	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$697, DW_AT_name("INTx7"), DW_AT_symbol_name("_INTx7")
...
DW$698	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$698, DW_AT_name("INTx8"), DW_AT_symbol_name("_INTx8")
...
DW$699	.dwtag  DW_TAG_member, DW_AT_type(*DW$T$20)
	.dwattr DW$699, DW_AT_name("rsvd"), DW_AT_symbol_name("_rsvd")
	.dwattr DW$699, DW_AT_bit_offset(0x00), DW_AT_bit_size(0x08)
...
DW$702	.dwtag  DW_TAG_subrange_type
	.dwattr DW$702, DW_AT_upper_bound(0x13)
	.dwendtag DW$T$27
...
DW$703	.dwtag  DW_TAG_assign_register, DW_AT_name("AL")
	.dwattr DW$703, DW_AT_location[DW_OP_reg0]
DW$704	.dwtag  DW_TAG_assign_register, DW_AT_name("AH")
	.dwattr DW$704, DW_AT_location[DW_OP_reg1]
DW$705	.dwtag  DW_TAG_assign_register, DW_AT_name("PL")
	.dwattr DW$705, DW_AT_location[DW_OP_reg2]
DW$706	.dwtag  DW_TAG_assign_register, DW_AT_name("PH")
	.dwattr DW$706, DW_AT_location[DW_OP_reg3]
DW$707	.dwtag  DW_TAG_assign_register, DW_AT_name("AR0")
	.dwattr DW$707, DW_AT_location[DW_OP_reg4]
DW$708	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR0")
	.dwattr DW$708, DW_AT_location[DW_OP_reg5]
DW$709	.dwtag  DW_TAG_assign_register, DW_AT_name("AR1")
	.dwattr DW$709, DW_AT_location[DW_OP_reg6]
DW$710	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR1")
	.dwattr DW$710, DW_AT_location[DW_OP_reg7]
DW$711	.dwtag  DW_TAG_assign_register, DW_AT_name("AR2")
	.dwattr DW$711, DW_AT_location[DW_OP_reg8]
DW$712	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR2")
	.dwattr DW$712, DW_AT_location[DW_OP_reg9]
DW$713	.dwtag  DW_TAG_assign_register, DW_AT_name("AR3")
	.dwattr DW$713, DW_AT_location[DW_OP_reg10]
DW$714	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR3")
	.dwattr DW$714, DW_AT_location[DW_OP_reg11]
DW$715	.dwtag  DW_TAG_assign_register, DW_AT_name("AR4")
	.dwattr DW$715, DW_AT_location[DW_OP_reg12]
DW$716	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR4")
	.dwattr DW$716, DW_AT_location[DW_OP_reg13]
DW$717	.dwtag  DW_TAG_assign_register, DW_AT_name("AR5")
	.dwattr DW$717, DW_AT_location[DW_OP_reg14]
DW$718	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR5")
	.dwattr DW$718, DW_AT_location[DW_OP_reg15]
DW$719	.dwtag  DW_TAG_assign_register, DW_AT_name("AR6")
	.dwattr DW$719, DW_AT_location[DW_OP_reg16]
DW$720	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR6")
	.dwattr DW$720, DW_AT_location[DW_OP_reg17]
DW$721	.dwtag  DW_TAG_assign_register, DW_AT_name("AR7")
	.dwattr DW$721, DW_AT_location[DW_OP_reg18]
DW$722	.dwtag  DW_TAG_assign_register, DW_AT_name("XAR7")
	.dwattr DW$722, DW_AT_location[DW_OP_reg19]
DW$723	.dwtag  DW_TAG_assign_register, DW_AT_name("SP")
	.dwattr DW$723, DW_AT_location[DW_OP_reg20]
DW$724	.dwtag  DW_TAG_assign_register, DW_AT_name("XT")
	.dwattr DW$724, DW_AT_location[DW_OP_reg21]
DW$725	.dwtag  DW_TAG_assign_register, DW_AT_name("T")
	.dwattr DW$725, DW_AT_location[DW_OP_reg22]
DW$726	.dwtag  DW_TAG_assign_register, DW_AT_name("ST0")
	.dwattr DW$726, DW_AT_location[DW_OP_reg23]
DW$727	.dwtag  DW_TAG_assign_register, DW_AT_name("ST1")
	.dwattr DW$727, DW_AT_location[DW_OP_reg24]
DW$728	.dwtag  DW_TAG_assign_register, DW_AT_name("PC")
	.dwattr DW$728, DW_AT_location[DW_OP_reg25]
DW$729	.dwtag  DW_TAG_assign_register, DW_AT_name("RPC")
	.dwattr DW$729, DW_AT_location[DW_OP_reg26]
DW$730	.dwtag  DW_TAG_assign_register, DW_AT_name("FP")
	.dwattr DW$730, DW_AT_location[DW_OP_reg27]
DW$731	.dwtag  DW_TAG_assign_register, DW_AT_name("DP")
	.dwattr DW$731, DW_AT_location[DW_OP_reg28]
DW$732	.dwtag  DW_TAG_assign_register, DW_AT_name("SXM")
	.dwattr DW$732, DW_AT_location[DW_OP_reg29]
DW$733	.dwtag  DW_TAG_assign_register, DW_AT_name("PM")
	.dwattr DW$733, DW_AT_location[DW_OP_reg30]
DW$734	.dwtag  DW_TAG_assign_register, DW_AT_name("OVM")
	.dwattr DW$734, DW_AT_location[DW_OP_reg31]
DW$735	.dwtag  DW_TAG_assign_register, DW_AT_name("PAGE0")
	.dwattr DW$735, DW_AT_location[DW_OP_regx 0x20]
DW$736	.dwtag  DW_TAG_assign_register, DW_AT_name("AMODE")
	.dwattr DW$736, DW_AT_location[DW_OP_regx 0x21]
DW$737	.dwtag  DW_TAG_assign_register, DW_AT_name("IFR")
	.dwattr DW$737, DW_AT_location[DW_OP_regx 0x22]
DW$738	.dwtag  DW_TAG_assign_register, DW_AT_name("IER")
	.dwattr DW$738, DW_AT_location[DW_OP_regx 0x23]
DW$739	.dwtag  DW_TAG_assign_register, DW_AT_name("IER")
	.dwattr DW$739, DW_AT_location[DW_OP_regx 0x24]
DW$740	.dwtag  DW_TAG_assign_register, DW_AT_name("PSEUDO")
	.dwattr DW$740, DW_AT_location[DW_OP_regx 0x25]
DW$741	.dwtag  DW_TAG_assign_register, DW_AT_name("PSEUDOH")
	.dwattr DW$741, DW_AT_location[DW_OP_regx 0x26]
DW$742	.dwtag  DW_TAG_assign_register, DW_AT_name("VOL")
	.dwattr DW$742, DW_AT_location[DW_OP_regx 0x27]
DW$743	.dwtag  DW_TAG_assign_register, DW_AT_name("CIE_RETA")
	.dwattr DW$743, DW_AT_location[DW_OP_regx 0x28]
	.dwendtag DW$CU
